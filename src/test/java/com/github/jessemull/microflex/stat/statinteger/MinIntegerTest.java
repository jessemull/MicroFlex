...
import com.github.jessemull.microflex.integerflex.stat.MinInteger;
import com.github.jessemull.microflex.util.RandomUtil;

/**
 * This class tests the methods in the min integer class.
 * @author Jesse L. Mull
...
public class MinIntegerTest {
	...
	private static MinInteger min = new MinInteger();
    ...
    public void testPlateIndices() {
    	...
    	for(PlateInteger plate : arrayIndices) {
    		...
    		Map<WellInteger, Double> resultMap = new TreeMap<WellInteger, Double>();
    		Map<WellInteger, Double> returnedMap = min.plate(plate, begin, end - begin);
    ...
    public void testAggregatedPlateCollection() {
    	...
    	Map<PlateInteger, Double> aggregatedReturnedMap = min.platesAggregated(collection);
    ...
    public void testAggregatedPlateArray() {
    	...
    	Map<PlateInteger, Double> aggregatedReturnedMap = min.platesAggregated(array);
    	Map<PlateInteger, Double> aggregatedResultMap = new TreeMap<PlateInteger, Double>();
    ...
    public void testAggregatedPlateCollectionIndices() {
    	...
    	Map<PlateInteger, Double> aggregatedReturnedMap = min.platesAggregated(collection, begin, end - begin);
    ...
    public void testAggregatedPlateArrayIndices() {
    	...
    	Map<PlateInteger, Double> aggregatedReturnedMap = min.platesAggregated(arrayIndices, begin, end - begin);
    	Map<PlateInteger, Double> aggregatedResultMap = new TreeMap<PlateInteger, Double>();
    ...
    public void testSetIndices() {
    	...
    	for(PlateInteger plate : arrayIndices) {
    		...
    		Map<WellInteger, Double> resultMap = new TreeMap<WellInteger, Double>();
    		Map<WellInteger, Double> returnedMap = min.set(plate.dataSet(), begin, end - begin);
    ...
    public void testAggregatedSetCollection() {
    	...
    	Map<WellSetInteger, Double> aggregatedReturnedMap = min.setsAggregated(collection);
    ...
    public void testAggregatedSetIndices() {
    	...
    	for(PlateInteger plate : arrayIndices) {
    		...
    		List<Double> resultList = new ArrayList<Double>();
    		double aggregatedReturned = Precision.round(min.setsAggregated(plate.dataSet(), begin, end - begin), precision);
    ...
    public void testAggregatedSetCollectionIndices() {
    	...
    	Map<WellSetInteger, Double> aggregatedReturnedMap = min.setsAggregated(collection, begin, end - begin);
    	Map<WellSetInteger, Double> aggregatedResultMap = new TreeMap<WellSetInteger, Double>();
    ...
    public void testAggregatedSetArrayIndices() {
    	...
    	Map<WellSetInteger, Double> aggregatedReturnedMap = min.setsAggregated(setArrayIndices, begin, end - begin);
    	Map<WellSetInteger, Double> aggregatedResultMap = new TreeMap<WellSetInteger, Double>();
    ...
    public void testWell() {
		...
		for(PlateInteger plate : array) {
			...
			for(WellInteger well : plate) {
				...
				DescriptiveStatistics stat = new DescriptiveStatistics(input);
				double result = Precision.round(stat.getMin(), precision);
				double returned = Precision.round(min.well(well), precision);					
    ...
    public void testWellIndices() {
    	...
    	for(PlateInteger plate : arrayIndices) {
			...
			for(WellInteger well : plate) {
				...
				DescriptiveStatistics stat = new DescriptiveStatistics(ArrayUtils.subarray(input, begin, end));
				double result = Precision.round(stat.getMin(), precision);
				double returned = Precision.round(min.well(well, begin, end - begin), precision);					
