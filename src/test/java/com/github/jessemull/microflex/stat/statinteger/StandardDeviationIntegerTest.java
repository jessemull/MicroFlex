...
import com.github.jessemull.microflex.integerflex.stat.SampleStandardDeviationInteger;
...
public class StandardDeviationIntegerTest {
	...
	private static SampleStandardDeviationInteger deviation = new SampleStandardDeviationInteger();
	...
	public void testConstructor() {
		SampleStandardDeviationInteger test = new SampleStandardDeviationInteger();
		assertNotNull(test);
	}
    ...
    public void testPlate() {
		...
		for(PlateInteger plate : array) {
    		...
    		Map<WellInteger, Double> returnedMap = deviation.plate(plate);
    ...
    public void testAggregatedPlateCollectionIndices() {
    	...
    	Map<PlateInteger, Double> aggregatedReturnedMap = deviation.platesAggregated(collection, begin, end - begin);
    ...
    public void testAggregatedPlateArrayIndices() {
    	...
    	Map<PlateInteger, Double> aggregatedReturnedMap = deviation.platesAggregated(arrayIndices, begin, end - begin);
    	Map<PlateInteger, Double> aggregatedResultMap = new TreeMap<PlateInteger, Double>();
    ...
    public void testSet() {
    	...
    	for(PlateInteger plate : array) {
    		...
    		Map<WellInteger, Double> resultMap = new TreeMap<WellInteger, Double>();
    		Map<WellInteger, Double> returnedMap = deviation.set(plate.dataSet());
    ...
    public void testSetIndices() {
    	...
    	for(PlateInteger plate : arrayIndices) {
    		...
    		Map<WellInteger, Double> resultMap = new TreeMap<WellInteger, Double>();
    		Map<WellInteger, Double> returnedMap = deviation.set(plate.dataSet(), begin, end - begin);
    ...
    public void testAggregatedSetCollection() {
    	...
    	Map<WellSetInteger, Double> aggregatedReturnedMap = deviation.setsAggregated(collection);
    ...
    public void testAggregatedSetArray() {
    	...
    	Map<WellSetInteger, Double> aggregatedReturnedMap = deviation.setsAggregated(setArray);
    	Map<WellSetInteger, Double> aggregatedResultMap = new TreeMap<WellSetInteger, Double>();
    ...
    public void testAggregatedSetCollectionIndices() {
    	...
    	Map<WellSetInteger, Double> aggregatedReturnedMap = deviation.setsAggregated(collection, begin, end - begin);
    	Map<WellSetInteger, Double> aggregatedResultMap = new TreeMap<WellSetInteger, Double>();
    ...
    public void testAggregatedSetArrayIndices() {
    	...
    	Map<WellSetInteger, Double> aggregatedReturnedMap = deviation.setsAggregated(setArrayIndices, begin, end - begin);
    	Map<WellSetInteger, Double> aggregatedResultMap = new TreeMap<WellSetInteger, Double>();
