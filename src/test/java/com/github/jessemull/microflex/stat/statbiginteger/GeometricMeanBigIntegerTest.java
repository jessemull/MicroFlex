...
import com.github.jessemull.microflex.bigintegerflex.stat.GeometricMeanBigInteger;
...
public class GeometricMeanBigIntegerTest {
	...
	private static BigInteger maxValue = new BigInteger(3 + "");     // Maximum big integer value for wells
	...
	private static GeometricMeanBigInteger mean = new GeometricMeanBigInteger();
	...
	public void testConstructor() {
		GeometricMeanBigInteger test = new GeometricMeanBigInteger();
		assertNotNull(test);
	}
    ...
    public void testPlate() {
		...
		for(PlateBigInteger plate : array) {
    		...
    		Map<WellBigInteger, BigDecimal> returnedMap = mean.plate(plate, mc);
    ...
    public void testAggregatedPlateCollectionIndices() {
    	...
    	Map<PlateBigInteger, BigDecimal> aggregatedReturnedMap = mean.platesAggregated(collection, begin, end - begin, mc);
    ...
    public void testAggregatedPlateArrayIndices() {
    	...
    	Map<PlateBigInteger, BigDecimal> aggregatedReturnedMap = mean.platesAggregated(arrayIndices, begin, end - begin, mc);
    ...
    public void testSet() {
    	...
    	for(PlateBigInteger plate : array) {
    		...
    		Map<WellBigInteger, BigDecimal> resultMap = new TreeMap<WellBigInteger, BigDecimal>();
    		Map<WellBigInteger, BigDecimal> returnedMap = mean.set(plate.dataSet(), mc);
    ...
    public void testAggregatedSetCollection() {
    	...
    	Map<WellSetBigInteger, BigDecimal> aggregatedReturnedMap = mean.setsAggregated(collection, mc);
    ...
    public void testAggregatedSetArray() {
    	...
    	Map<WellSetBigInteger, BigDecimal> aggregatedReturnedMap = mean.setsAggregated(setArray, mc);
    	Map<WellSetBigInteger, BigDecimal> aggregatedResultMap = new TreeMap<WellSetBigInteger, BigDecimal>();
    ...
    public void testAggregatedSetCollectionIndices() {
    	...
    	Map<WellSetBigInteger, BigDecimal> aggregatedReturnedMap = mean.setsAggregated(collection, begin, end - begin, mc);
    	Map<WellSetBigInteger, BigDecimal> aggregatedResultMap = new TreeMap<WellSetBigInteger, BigDecimal>();
    ...
    public void testAggregatedSetArrayIndices() {
    	...
    	Map<WellSetBigInteger, BigDecimal> aggregatedReturnedMap = mean.setsAggregated(array, begin, end - begin, mc);
    	Map<WellSetBigInteger, BigDecimal> aggregatedResultMap = new TreeMap<WellSetBigInteger, BigDecimal>();
