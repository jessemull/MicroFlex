...
/**
 * This class tests the methods in the sum squared integer class.
 * @author Jesse L. Mull
...
public class SumOfSquaresIntegerTest {
	...
	public void testConstructor() {
		SumOfSquaresInteger test = new SumOfSquaresInteger();
		assertNotNull(test);
	}
    ...
    public void testPlateIndices() {
    	...
    	for(PlateInteger plate : arrayIndices) {
    		...
    		Map<WellInteger, Double> resultMap = new TreeMap<WellInteger, Double>();
    		Map<WellInteger, Double> returnedMap = sum.plate(plate, begin, end - begin);
    ...
    public void testAggregatedPlateCollection() {
    	...
    	Map<PlateInteger, Double> aggregatedReturnedMap = sum.platesAggregated(collection);
    ...
    public void testAggregatedPlateArray() {
    	...
    	Map<PlateInteger, Double> aggregatedReturnedMap = sum.platesAggregated(array);
    	Map<PlateInteger, Double> aggregatedResultMap = new TreeMap<PlateInteger, Double>();
    ...
    public void testAggregatedPlateCollectionIndices() {
    	...
    	Map<PlateInteger, Double> aggregatedReturnedMap = sum.platesAggregated(collection, begin, end - begin);
    ...
    public void testAggregatedPlateArrayIndices() {
    	...
    	Map<PlateInteger, Double> aggregatedReturnedMap = sum.platesAggregated(arrayIndices, begin, end - begin);
    	Map<PlateInteger, Double> aggregatedResultMap = new TreeMap<PlateInteger, Double>();
    ...
    public void testSetIndices() {
    	...
    	for(PlateInteger plate : arrayIndices) {
    		...
    		Map<WellInteger, Double> resultMap = new TreeMap<WellInteger, Double>();
    		Map<WellInteger, Double> returnedMap = sum.set(plate.dataSet(), begin, end - begin);
    ...
    public void testAggregatedSetCollectionIndices() {
    	...
    	Map<WellSetInteger, Double> aggregatedReturnedMap = sum.setsAggregated(collection, begin, end - begin);
    	Map<WellSetInteger, Double> aggregatedResultMap = new TreeMap<WellSetInteger, Double>();
    ...
    public void testAggregatedSetArrayIndices() {
    	...
    	Map<WellSetInteger, Double> aggregatedReturnedMap = sum.setsAggregated(setArrayIndices, begin, end - begin);
    	Map<WellSetInteger, Double> aggregatedResultMap = new TreeMap<WellSetInteger, Double>();
