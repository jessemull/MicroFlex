...
/**
 * This class tests the methods in the geometric mean big integer class.
 * 
 * @author Jesse L. Mull
...
public class MeanBigIntegerTest {
	...
	public void testConstructor() {
		MeanBigInteger test = new MeanBigInteger();
		assertNotNull(test);
	}
    ...
    public void testAggregatedSetArrayIndices() {
    	...
    	Map<WellSetBigInteger, BigDecimal> aggregatedReturnedMap = mean.setsAggregated(setArrayIndices, begin, end - begin, mc);
    	Map<WellSetBigInteger, BigDecimal> aggregatedResultMap = new TreeMap<WellSetBigInteger, BigDecimal>();
