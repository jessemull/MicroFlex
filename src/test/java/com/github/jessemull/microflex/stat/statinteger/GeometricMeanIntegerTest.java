...
public class GeometricMeanIntegerTest {
	...
	public void testConstructor() {
		GeometricMeanInteger test = new GeometricMeanInteger();
		assertNotNull(test);
	}
    ...
    public void testAggregatedPlateIndices() {
    	...
    	for(PlateInteger plate : arrayIndices) {
    	    ...
    	    List<Double> resultList = new ArrayList<Double>();
    		double aggregatedReturned = Precision.round(mean.platesAggregated(plate, begin, end - begin), precision);
    ...
    public void testAggregatedPlateCollectionIndices() {
    	...
    	for(PlateInteger plate : collection) {
			...
			DescriptiveStatistics statAggregated = new DescriptiveStatistics(inputAggregated);
			double resultAggregated = statAggregated.getGeometricMean();
    ...
    public void testAggregatedSetArray() {
    	...
    	Map<WellSetInteger, Double> aggregatedReturnedMap = mean.setsAggregated(setArray);
    	Map<WellSetInteger, Double> aggregatedResultMap = new TreeMap<WellSetInteger, Double>();
    ...
    public void testAggregatedSetIndices() {
    	...
    	for(PlateInteger plate : arrayIndices) {
    		...
    		List<Double> resultList = new ArrayList<Double>();
    		double aggregatedReturned = Precision.round(mean.setsAggregated(plate.dataSet(), begin, end - begin), precision);
    ...
    public void testAggregatedSetArrayIndices() {
    	...
    	Map<WellSetInteger, Double> aggregatedReturnedMap = mean.setsAggregated(setArrayIndices, begin, end - begin);
    	Map<WellSetInteger, Double> aggregatedResultMap = new TreeMap<WellSetInteger, Double>();
