...
public class MeanBigIntegerWeightsTest {
    ...
    public void testPlate() {
		...
		for(PlateBigInteger plate : array) {
    		...
    		Map<WellBigInteger, BigDecimal> returnedMap = mean.plate(plate, weights, mc);
    ...
    public void testPlateIndices() {
    	...
    	for(PlateBigInteger plate : arrayIndices) {
    		...
    		Map<WellBigInteger, BigDecimal> resultMap = new TreeMap<WellBigInteger, BigDecimal>();
    		Map<WellBigInteger, BigDecimal> returnedMap = mean.plate(plate, ArrayUtils.subarray(weightsIndices, begin, end), begin, end - begin, mc);
    ...
    public void testAggregatedPlateCollection() {
    	...
    	Map<PlateBigInteger, BigDecimal> aggregatedReturnedMap = mean.platesAggregated(collection, weights, mc);
    ...
    public void testAggregatedPlateArray() {
    	...
    	Map<PlateBigInteger, BigDecimal> aggregatedReturnedMap = mean.platesAggregated(array, weights, mc);
    	Map<PlateBigInteger, BigDecimal> aggregatedResultMap = new TreeMap<PlateBigInteger, BigDecimal>();
    ...
    public void testAggregatedPlateCollectionIndices() {
    	...
    	Map<PlateBigInteger, BigDecimal> aggregatedReturnedMap = mean.platesAggregated(collection, weightsIndices, begin, end - begin, mc);
    ...
    public void testAggregatedPlateArrayIndices() {
    	...
    	Map<PlateBigInteger, BigDecimal> aggregatedReturnedMap = mean.platesAggregated(arrayIndices, weightsIndices, begin, end - begin, mc);
    	Map<PlateBigInteger, BigDecimal> aggregatedResultMap = new TreeMap<PlateBigInteger, BigDecimal>();
    ...
    public void testSetIndices() {
    	...
    	for(PlateBigInteger plate : arrayIndices) {
    		...
    		Map<WellBigInteger, BigDecimal> resultMap = new TreeMap<WellBigInteger, BigDecimal>();
    		Map<WellBigInteger, BigDecimal> returnedMap = mean.set(plate.dataSet(), ArrayUtils.subarray(weightsIndices, begin, end), begin, end - begin, mc);
    ...
    public void testAggregatedSetArray() {
    	...
    	Map<WellSetBigInteger, BigDecimal> aggregatedReturnedMap = mean.setsAggregated(setArray, weights, mc);
    	Map<WellSetBigInteger, BigDecimal> aggregatedResultMap = new TreeMap<WellSetBigInteger, BigDecimal>();
    ...
    public void testAggregatedSetCollectionIndices() {
    	...
    	Map<WellSetBigInteger, BigDecimal> aggregatedReturnedMap = mean.setsAggregated(collection, weightsIndices, begin, end - begin, mc);
    	Map<WellSetBigInteger, BigDecimal> aggregatedResultMap = new TreeMap<WellSetBigInteger, BigDecimal>();
    ...
    public void testAggregatedSetArrayIndices() {
    	...
    	Map<WellSetBigInteger, BigDecimal> aggregatedReturnedMap = mean.setsAggregated(setArrayIndices, weightsIndices, begin, end - begin, mc);
    	Map<WellSetBigInteger, BigDecimal> aggregatedResultMap = new TreeMap<WellSetBigInteger, BigDecimal>();
