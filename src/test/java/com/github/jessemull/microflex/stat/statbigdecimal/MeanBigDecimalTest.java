...
public class MeanBigDecimalTest {
	...
	public void testConstructor() {
		MeanBigDecimal test = new MeanBigDecimal();
		assertNotNull(test);
	}
    ...
    public void testAggregatedSetArrayIndices() {
    	...
    	Map<WellSetBigDecimal, BigDecimal> aggregatedReturnedMap = mean.setsAggregated(setArrayIndices, begin, end - begin, mc);
    	Map<WellSetBigDecimal, BigDecimal> aggregatedResultMap = new TreeMap<WellSetBigDecimal, BigDecimal>();
