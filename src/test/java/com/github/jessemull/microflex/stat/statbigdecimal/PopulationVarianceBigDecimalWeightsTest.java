...
public class PopulationVarianceBigDecimalWeightsTest {
	...
	private static PopulationVarianceBigDecimal variance = new PopulationVarianceBigDecimal();
    ...
    public void testPlateIndices() {
    	...
    	for(PlateBigDecimal plate : arrayIndices) {
    		...
    		Map<WellBigDecimal, BigDecimal> resultMap = new TreeMap<WellBigDecimal, BigDecimal>();
    		Map<WellBigDecimal, BigDecimal> returnedMap = variance.plate(plate, ArrayUtils.subarray(weightsIndices, begin, end), begin, end - begin, mc);
    ...
    public void testAggregatedPlateCollectionIndices() {
    	...
    	Map<PlateBigDecimal, BigDecimal> aggregatedReturnedMap = variance.platesAggregated(collection, weightsIndices, begin, end - begin, mc);
    ...
    public void testAggregatedPlateArrayIndices() {
    	...
    	Map<PlateBigDecimal, BigDecimal> aggregatedReturnedMap = variance.platesAggregated(arrayIndices, weightsIndices, begin, end - begin, mc);
    	Map<PlateBigDecimal, BigDecimal> aggregatedResultMap = new TreeMap<PlateBigDecimal, BigDecimal>();
    ...
    public void testSetIndices() {
    	...
    	for(PlateBigDecimal plate : arrayIndices) {
    		...
    		Map<WellBigDecimal, BigDecimal> resultMap = new TreeMap<WellBigDecimal, BigDecimal>();
    		Map<WellBigDecimal, BigDecimal> returnedMap = variance.set(plate.dataSet(), ArrayUtils.subarray(weightsIndices, begin, end), begin, end - begin, mc);
    ...
    public void testAggregatedSetCollection() {
    	...
    	Map<WellSetBigDecimal, BigDecimal> aggregatedReturnedMap = variance.setsAggregated(collection, weights, mc);
    ...
    public void testAggregatedSetArray() {
    	...
    	Map<WellSetBigDecimal, BigDecimal> aggregatedReturnedMap = variance.setsAggregated(setArray, weights, mc);
    	Map<WellSetBigDecimal, BigDecimal> aggregatedResultMap = new TreeMap<WellSetBigDecimal, BigDecimal>();
    ...
    public void testAggregatedSetCollectionIndices() {
    	...
    	Map<WellSetBigDecimal, BigDecimal> aggregatedReturnedMap = variance.setsAggregated(collection, weightsIndices, begin, end - begin, mc);
    	Map<WellSetBigDecimal, BigDecimal> aggregatedResultMap = new TreeMap<WellSetBigDecimal, BigDecimal>();
    ...
    public void testAggregatedSetArrayIndices() {
    	...
    	Map<WellSetBigDecimal, BigDecimal> aggregatedReturnedMap = variance.setsAggregated(setArrayIndices, weightsIndices, begin, end - begin, mc);
    	Map<WellSetBigDecimal, BigDecimal> aggregatedResultMap = new TreeMap<WellSetBigDecimal, BigDecimal>();
