...
import com.github.jessemull.microflex.bigdecimalflex.stat.SumBigDecimal;
...
public class SumBigIntegerTest {
	...
	public void testConstructor() {
		SumBigDecimal test = new SumBigDecimal();
		assertNotNull(test);
	}
    ...
    public void testAggregatedPlateCollection() {
    	...
    	Map<PlateBigInteger, BigDecimal> aggregatedReturnedMap = sum.platesAggregated(collection, mc);
    ...
    public void testAggregatedPlateArray() {
    	...
    	Map<PlateBigInteger, BigDecimal> aggregatedReturnedMap = sum.platesAggregated(array, mc);
    	Map<PlateBigInteger, BigDecimal> aggregatedResultMap = new TreeMap<PlateBigInteger, BigDecimal>();
    ...
    public void testAggregatedPlateCollectionIndices() {
    	...
    	Map<PlateBigInteger, BigDecimal> aggregatedReturnedMap = sum.platesAggregated(collection, begin, end - begin, mc);
    ...
    public void testAggregatedPlateArrayIndices() {
    	...
    	Map<PlateBigInteger, BigDecimal> aggregatedReturnedMap = sum.platesAggregated(arrayIndices, begin, end - begin, mc);
    	Map<PlateBigInteger, BigDecimal> aggregatedResultMap = new TreeMap<PlateBigInteger, BigDecimal>();
    ...
    public void testAggregatedSetCollection() {
    	...
    	Map<WellSetBigInteger, BigDecimal> aggregatedReturnedMap = sum.setsAggregated(collection, mc);
    ...
    public void testAggregatedSetArray() {
    	...
    	Map<WellSetBigInteger, BigDecimal> aggregatedReturnedMap = sum.setsAggregated(setArray, mc);
    	Map<WellSetBigInteger, BigDecimal> aggregatedResultMap = new TreeMap<WellSetBigInteger, BigDecimal>();
    ...
    public void testAggregatedSetCollectionIndices() {
    	...
    	Map<WellSetBigInteger, BigDecimal> aggregatedReturnedMap = sum.setsAggregated(collection, begin, end - begin, mc);
    	Map<WellSetBigInteger, BigDecimal> aggregatedResultMap = new TreeMap<WellSetBigInteger, BigDecimal>();
    ...
    public void testAggregatedSetArrayIndices() {
    	...
    	Map<WellSetBigInteger, BigDecimal> aggregatedReturnedMap = sum.setsAggregated(setArrayIndices, begin, end - begin, mc);
    	Map<WellSetBigInteger, BigDecimal> aggregatedResultMap = new TreeMap<WellSetBigInteger, BigDecimal>();
