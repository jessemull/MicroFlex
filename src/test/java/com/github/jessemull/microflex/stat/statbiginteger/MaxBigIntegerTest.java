...
import com.github.jessemull.microflex.bigdecimalflex.stat.MaxBigDecimal;
...
import com.github.jessemull.microflex.bigintegerflex.stat.MaxBigInteger;
...
public class MaxBigIntegerTest {
...
/* ---------------------------- Local Fields -----------------------------*/
	...
	private static MaxBigInteger max = new MaxBigInteger();
	...
	public void testConstructor() {
		MaxBigDecimal test = new MaxBigDecimal();
		assertNotNull(test);
	}
    ...
    public void testPlate() {
		...
		for(PlateBigInteger plate : array) {
    		...
    		Map<WellBigInteger, BigDecimal> returnedMap = max.plate(plate);
    ...
    public void testPlateIndices() {
    	...
    	for(PlateBigInteger plate : arrayIndices) {
    		...
    		Map<WellBigInteger, BigDecimal> resultMap = new TreeMap<WellBigInteger, BigDecimal>();
    		Map<WellBigInteger, BigDecimal> returnedMap = max.plate(plate, begin, end - begin);
    ...
    public void testAggregatedPlateCollection() {
    	...
    	Map<PlateBigInteger, BigDecimal> aggregatedReturnedMap = max.platesAggregated(collection);
    ...
    public void testAggregatedPlateArray() {
    	...
    	Map<PlateBigInteger, BigDecimal> aggregatedReturnedMap = max.platesAggregated(array);
    	Map<PlateBigInteger, BigDecimal> aggregatedResultMap = new TreeMap<PlateBigInteger, BigDecimal>();
    ...
    public void testAggregatedPlateCollectionIndices() {
    	...
    	Map<PlateBigInteger, BigDecimal> aggregatedReturnedMap = max.platesAggregated(collection, begin, end - begin);
    ...
    public void testAggregatedPlateArrayIndices() {
    	...
    	Map<PlateBigInteger, BigDecimal> aggregatedReturnedMap = max.platesAggregated(arrayIndices, begin, end - begin);
    	Map<PlateBigInteger, BigDecimal> aggregatedResultMap = new TreeMap<PlateBigInteger, BigDecimal>();
    ...
    public void testSet() {
    	...
    	for(PlateBigInteger plate : array) {
    		...
    		Map<WellBigInteger, BigDecimal> resultMap = new TreeMap<WellBigInteger, BigDecimal>();
    		Map<WellBigInteger, BigDecimal> returnedMap = max.set(plate.dataSet());
    ...
    public void testSetIndices() {
    	...
    	for(PlateBigInteger plate : arrayIndices) {
    		...
    		Map<WellBigInteger, BigDecimal> resultMap = new TreeMap<WellBigInteger, BigDecimal>();
    		Map<WellBigInteger, BigDecimal> returnedMap = max.set(plate.dataSet(), begin, end - begin);
    ...
    public void testAggregatedSetCollection() {
    	...
    	Map<WellSetBigInteger, BigDecimal> aggregatedReturnedMap = max.setsAggregated(collection);
    ...
    public void testAggregatedSetArray() {
    	...
    	Map<WellSetBigInteger, BigDecimal> aggregatedReturnedMap = max.setsAggregated(setArray);
    	Map<WellSetBigInteger, BigDecimal> aggregatedResultMap = new TreeMap<WellSetBigInteger, BigDecimal>();
    ...
    public void testAggregatedSetCollectionIndices() {
    	...
    	Map<WellSetBigInteger, BigDecimal> aggregatedReturnedMap = max.setsAggregated(collection, begin, end - begin);
    	Map<WellSetBigInteger, BigDecimal> aggregatedResultMap = new TreeMap<WellSetBigInteger, BigDecimal>();
    ...
    public void testAggregatedSetArrayIndices() {
    	...
    	Map<WellSetBigInteger, BigDecimal> aggregatedReturnedMap = max.setsAggregated(setArrayIndices, begin, end - begin);
    	Map<WellSetBigInteger, BigDecimal> aggregatedResultMap = new TreeMap<WellSetBigInteger, BigDecimal>();
    ...
    public void testWellIndices() {
    	...
    	for(PlateBigInteger plate : arrayIndices) {
			...
			for(WellBigInteger well : plate) {
				...
				BigDecimal returned = max.well(well, begin, end - begin);					
				BigDecimal result = new BigDecimal(resultDouble);
