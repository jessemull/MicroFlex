...
/**
 * This class tests the methods in the sum square big integer class.
 * @author Jesse L. Mull
...
public class SumOfSquaresBigIntegerTest {
...
/* ---------------------------- Local Fields -----------------------------*/
	...
	public void testConstructor() {
		SumOfSquaresBigDecimal test = new SumOfSquaresBigDecimal();
		assertNotNull(test);
	}
