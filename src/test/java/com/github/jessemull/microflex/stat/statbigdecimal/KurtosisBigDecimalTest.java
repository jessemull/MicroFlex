...
public class KurtosisBigDecimalTest {
	...
	private static KurtosisBigDecimal kurtosis = new KurtosisBigDecimal();
    ...
    public void testPlate() {
		...
		for(PlateBigDecimal plate : array) {
    		...
    		Map<WellBigDecimal, BigDecimal> returnedMap = kurtosis.plate(plate, mc);
    ...
    public void testAggregatedPlateCollection() {
    	...
    	Map<PlateBigDecimal, BigDecimal> aggregatedReturnedMap = kurtosis.platesAggregated(collection, mc);
    ...
    public void testAggregatedPlateArray() {
    	...
    	Map<PlateBigDecimal, BigDecimal> aggregatedReturnedMap = kurtosis.platesAggregated(array, mc);
    	Map<PlateBigDecimal, BigDecimal> aggregatedResultMap = new TreeMap<PlateBigDecimal, BigDecimal>();
    ...
    public void testAggregatedPlateCollectionIndices() {
    	...
    	Map<PlateBigDecimal, BigDecimal> aggregatedReturnedMap = kurtosis.platesAggregated(collection, begin, end - begin, mc);
    ...
    public void testAggregatedPlateArrayIndices() {
    	...
    	Map<PlateBigDecimal, BigDecimal> aggregatedReturnedMap = kurtosis.platesAggregated(arrayIndices, begin, end - begin, mc);
    	Map<PlateBigDecimal, BigDecimal> aggregatedResultMap = new TreeMap<PlateBigDecimal, BigDecimal>();
    ...
    public void testSet() {
    	...
    	for(PlateBigDecimal plate : array) {
    		...
    		Map<WellBigDecimal, BigDecimal> resultMap = new TreeMap<WellBigDecimal, BigDecimal>();
    		Map<WellBigDecimal, BigDecimal> returnedMap = kurtosis.set(plate.dataSet(), mc);
    ...
    public void testAggregatedSetCollection() {
    	...
    	Map<WellSetBigDecimal, BigDecimal> aggregatedReturnedMap = kurtosis.setsAggregated(collection, mc);
    ...
    public void testAggregatedSetArray() {
    	...
    	Map<WellSetBigDecimal, BigDecimal> aggregatedReturnedMap = kurtosis.setsAggregated(setArray, mc);
    	Map<WellSetBigDecimal, BigDecimal> aggregatedResultMap = new TreeMap<WellSetBigDecimal, BigDecimal>();
    ...
    public void testAggregatedSetCollectionIndices() {
    	...
    	Map<WellSetBigDecimal, BigDecimal> aggregatedReturnedMap = kurtosis.setsAggregated(collection, begin, end - begin, mc);
    	Map<WellSetBigDecimal, BigDecimal> aggregatedResultMap = new TreeMap<WellSetBigDecimal, BigDecimal>();
    ...
    public void testAggregatedSetArrayIndices() {
    	...
    	Map<WellSetBigDecimal, BigDecimal> aggregatedReturnedMap = kurtosis.setsAggregated(setArrayIndices, begin, end - begin, mc);
    	Map<WellSetBigDecimal, BigDecimal> aggregatedResultMap = new TreeMap<WellSetBigDecimal, BigDecimal>();
