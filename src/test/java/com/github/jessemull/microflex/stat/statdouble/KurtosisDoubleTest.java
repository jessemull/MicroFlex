...
import com.github.jessemull.microflex.doubleflex.stat.KurtosisDouble;
import com.github.jessemull.microflex.util.RandomUtil;

/**
 * This class tests the methods in the kurtosis double class.
 * 
 * @author Jesse L. Mull
...
public class KurtosisDoubleTest {
	...
	private static KurtosisDouble kurtosis = new KurtosisDouble();
	...
	public void testConstructor() {
		KurtosisDouble test = new KurtosisDouble();
		assertNotNull(test);
	}
    ...
    public void testPlate() {
		...
		for(PlateDouble plate : array) {
    		...
    		Map<WellDouble, Double> returnedMap = kurtosis.plate(plate);
    ...
    public void testPlateIndices() {
    	...
    	for(PlateDouble plate : arrayIndices) {
    		...
    		Map<WellDouble, Double> resultMap = new TreeMap<WellDouble, Double>();
    		Map<WellDouble, Double> returnedMap = kurtosis.plate(plate, begin, end - begin);
    ...
    public void testAggregatedPlateCollection() {
    	...
    	Map<PlateDouble, Double> aggregatedReturnedMap = kurtosis.platesAggregated(collection);
    ...
    public void testAggregatedPlateArray() {
    	...
    	Map<PlateDouble, Double> aggregatedReturnedMap = kurtosis.platesAggregated(array);
    	Map<PlateDouble, Double> aggregatedResultMap = new TreeMap<PlateDouble, Double>();
    ...
    public void testAggregatedPlateCollectionIndices() {
    	...
    	Map<PlateDouble, Double> aggregatedReturnedMap = kurtosis.platesAggregated(collection, begin, end - begin);
    ...
    public void testAggregatedPlateArrayIndices() {
    	...
    	Map<PlateDouble, Double> aggregatedReturnedMap = kurtosis.platesAggregated(arrayIndices, begin, end - begin);
    	Map<PlateDouble, Double> aggregatedResultMap = new TreeMap<PlateDouble, Double>();
    ...
    public void testSet() {
    	...
    	for(PlateDouble plate : array) {
    		...
    		Map<WellDouble, Double> resultMap = new TreeMap<WellDouble, Double>();
    		Map<WellDouble, Double> returnedMap = kurtosis.set(plate.dataSet());
    ...
    public void testSetIndices() {
    	...
    	for(PlateDouble plate : arrayIndices) {
    		...
    		Map<WellDouble, Double> resultMap = new TreeMap<WellDouble, Double>();
    		Map<WellDouble, Double> returnedMap = kurtosis.set(plate.dataSet(), begin, end - begin);
    ...
    public void testAggregatedSetCollection() {
    	...
    	Map<WellSetDouble, Double> aggregatedReturnedMap = kurtosis.setsAggregated(collection);
    ...
    public void testAggregatedSetArray() {
    	...
    	Map<WellSetDouble, Double> aggregatedReturnedMap = kurtosis.setsAggregated(setArray);
    	Map<WellSetDouble, Double> aggregatedResultMap = new TreeMap<WellSetDouble, Double>();
    ...
    public void testAggregatedSetCollectionIndices() {
    	...
    	Map<WellSetDouble, Double> aggregatedReturnedMap = kurtosis.setsAggregated(collection, begin, end - begin);
    	Map<WellSetDouble, Double> aggregatedResultMap = new TreeMap<WellSetDouble, Double>();
    ...
    public void testAggregatedSetArrayIndices() {
    	...
    	Map<WellSetDouble, Double> aggregatedReturnedMap = kurtosis.setsAggregated(setArrayIndices, begin, end - begin);
    	Map<WellSetDouble, Double> aggregatedResultMap = new TreeMap<WellSetDouble, Double>();
