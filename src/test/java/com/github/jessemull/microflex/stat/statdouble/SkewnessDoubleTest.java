...
import com.github.jessemull.microflex.doubleflex.stat.SkewnessDouble;
...
public class SkewnessDoubleTest {
	...
	private static SkewnessDouble mean = new SkewnessDouble();
	...
	public void testConstructor() {
		SkewnessDouble test = new SkewnessDouble();
		assertNotNull(test);
	}
