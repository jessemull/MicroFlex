...
import com.github.jessemull.microflex.integerflex.stat.KurtosisInteger;
import com.github.jessemull.microflex.util.RandomUtil;

/**
 * This class tests the methods in the kurtosis integer class.
 * @author Jesse L. Mull
...
public class KurtosisIntegerTest {
	...
	private static KurtosisInteger kurtosis = new KurtosisInteger();
	...
	public void testConstructor() {
		KurtosisInteger test = new KurtosisInteger();
		assertNotNull(test);
	}
    ...
    public void testPlate() {
		...
		for(PlateInteger plate : array) {
    		...
    		Map<WellInteger, Double> returnedMap = kurtosis.plate(plate);
    ...
    public void testPlateIndices() {
    	...
    	for(PlateInteger plate : arrayIndices) {
    		...
    		Map<WellInteger, Double> resultMap = new TreeMap<WellInteger, Double>();
    		Map<WellInteger, Double> returnedMap = kurtosis.plate(plate, begin, end - begin);
    ...
    public void testAggregatedPlate() {
    	...
    	for(PlateInteger plate : array) {
    		...
    		double aggregatedReturned = Precision.round(kurtosis.platesAggregated(plate), precision);
			...
			double resultAggregated = Precision.round(statAggregated.getKurtosis(), precision);
    ...
    public void testAggregatedPlateCollection() {
    	...
    	Map<PlateInteger, Double> aggregatedReturnedMap = kurtosis.platesAggregated(collection);
    	...
    	for(PlateInteger plate : collection) {
			...
			DescriptiveStatistics statAggregated = new DescriptiveStatistics(inputAggregated);
			double aggregatedResult = statAggregated.getKurtosis();
    ...
    public void testAggregatedPlateArray() {
    	...
    	Map<PlateInteger, Double> aggregatedReturnedMap = kurtosis.platesAggregated(array);
    	Map<PlateInteger, Double> aggregatedResultMap = new TreeMap<PlateInteger, Double>();
    ...
    public void testAggregatedPlateIndices() {
    	...
    	for(PlateInteger plate : arrayIndices) {
    	    ...
    	    List<Double> resultList = new ArrayList<Double>();
    		double aggregatedReturned = Precision.round(kurtosis.platesAggregated(plate, begin, end - begin), precision);
			...
			DescriptiveStatistics statAggregated = new DescriptiveStatistics(inputAggregated);
			double aggregatedResult = Precision.round(statAggregated.getKurtosis(), precision);
    ...
    public void testAggregatedPlateCollectionIndices() {
    	...
    	Map<PlateInteger, Double> aggregatedReturnedMap = kurtosis.platesAggregated(collection, begin, end - begin);
    	...
    	for(PlateInteger plate : collection) {
			...
			DescriptiveStatistics statAggregated = new DescriptiveStatistics(inputAggregated);
			double resultAggregated = statAggregated.getKurtosis();
    ...
    public void testAggregatedPlateArrayIndices() {
    	...
    	Map<PlateInteger, Double> aggregatedReturnedMap = kurtosis.platesAggregated(arrayIndices, begin, end - begin);
    	Map<PlateInteger, Double> aggregatedResultMap = new TreeMap<PlateInteger, Double>();
    ...
    public void testSet() {
    	...
    	for(PlateInteger plate : array) {
    		...
    		Map<WellInteger, Double> resultMap = new TreeMap<WellInteger, Double>();
    		Map<WellInteger, Double> returnedMap = kurtosis.set(plate.dataSet());
    ...
    public void testSetIndices() {
    	...
    	for(PlateInteger plate : arrayIndices) {
    		...
    		Map<WellInteger, Double> resultMap = new TreeMap<WellInteger, Double>();
    		Map<WellInteger, Double> returnedMap = kurtosis.set(plate.dataSet(), begin, end - begin);
    ...
    public void testAggregatedSet() {
    	...
    	for(PlateInteger plate : array) {
    		...
    		List<Double> resultList = new ArrayList<Double>();
    		double aggregatedReturned = Precision.round(kurtosis.setsAggregated(plate.dataSet()), precision);
    ...
    public void testAggregatedSetCollection() {
    	...
    	Map<WellSetInteger, Double> aggregatedReturnedMap = kurtosis.setsAggregated(collection);
    ...
    public void testAggregatedSetArray() {
    	...
    	Map<WellSetInteger, Double> aggregatedReturnedMap = kurtosis.setsAggregated(setArray);
    	Map<WellSetInteger, Double> aggregatedResultMap = new TreeMap<WellSetInteger, Double>();
    ...
    public void testAggregatedSetIndices() {
    	...
    	for(PlateInteger plate : arrayIndices) {
    		...
    		List<Double> resultList = new ArrayList<Double>();
    		double aggregatedReturned = Precision.round(kurtosis.setsAggregated(plate.dataSet(), begin, end - begin), precision);
    ...
    public void testAggregatedSetCollectionIndices() {
    	...
    	Map<WellSetInteger, Double> aggregatedReturnedMap = kurtosis.setsAggregated(collection, begin, end - begin);
    	Map<WellSetInteger, Double> aggregatedResultMap = new TreeMap<WellSetInteger, Double>();
    ...
    public void testAggregatedSetArrayIndices() {
    	...
    	Map<WellSetInteger, Double> aggregatedReturnedMap = kurtosis.setsAggregated(setArrayIndices, begin, end - begin);
    	Map<WellSetInteger, Double> aggregatedResultMap = new TreeMap<WellSetInteger, Double>();
    ...
    public void testWell() {
		...
		for(PlateInteger plate : array) {
			...
			for(WellInteger well : plate) {
				...
				DescriptiveStatistics stat = new DescriptiveStatistics(input);
				double result = Precision.round(stat.getKurtosis(), precision);
				double returned = Precision.round(kurtosis.well(well), precision);					
    ...
    public void testWellIndices() {
    	...
    	for(PlateInteger plate : arrayIndices) {
			...
			for(WellInteger well : plate) {
				...
				DescriptiveStatistics stat = new DescriptiveStatistics(ArrayUtils.subarray(input, begin, end));
				double result = Precision.round(stat.getKurtosis(), precision);
				double returned = Precision.round(kurtosis.well(well, begin, end - begin), precision);					
