...
import com.github.jessemull.microflex.bigintegerflex.stat.SumOfSquaresBigInteger;
import com.github.jessemull.microflex.util.RandomUtil;

/**
 * This class tests the methods in the sum squared big integer class.
 * 
 * @author Jesse L. Mull
...
public class SumOfSquaresBigIntegerWeightsTest {
	...
	private static SumOfSquaresBigInteger sum = new SumOfSquaresBigInteger();
    ...
    public void testPlateIndices() {
    	...
    	for(PlateBigInteger plate : arrayIndices) {
    		...
    		Map<WellBigInteger, BigDecimal> resultMap = new TreeMap<WellBigInteger, BigDecimal>();
    		Map<WellBigInteger, BigDecimal> returnedMap = sum.plate(plate, ArrayUtils.subarray(weightsIndices, begin, end), begin, end - begin, mc);
    ...
    public void testAggregatedPlateCollection() {
    	...
    	Map<PlateBigInteger, BigDecimal> aggregatedReturnedMap = sum.platesAggregated(collection, weights, mc);
    ...
    public void testAggregatedPlateArray() {
    	...
    	Map<PlateBigInteger, BigDecimal> aggregatedReturnedMap = sum.platesAggregated(array, weights, mc);
    	Map<PlateBigInteger, BigDecimal> aggregatedResultMap = new TreeMap<PlateBigInteger, BigDecimal>();
    ...
    public void testAggregatedPlateCollectionIndices() {
    	...
    	Map<PlateBigInteger, BigDecimal> aggregatedReturnedMap = sum.platesAggregated(collection, weightsIndices, begin, end - begin, mc);
    ...
    public void testAggregatedPlateArrayIndices() {
    	...
    	Map<PlateBigInteger, BigDecimal> aggregatedReturnedMap = sum.platesAggregated(arrayIndices, weightsIndices, begin, end - begin, mc);
    	Map<PlateBigInteger, BigDecimal> aggregatedResultMap = new TreeMap<PlateBigInteger, BigDecimal>();
    ...
    public void testSetIndices() {
    	...
    	for(PlateBigInteger plate : arrayIndices) {
    		...
    		Map<WellBigInteger, BigDecimal> resultMap = new TreeMap<WellBigInteger, BigDecimal>();
    		Map<WellBigInteger, BigDecimal> returnedMap = sum.set(plate.dataSet(), ArrayUtils.subarray(weightsIndices, begin, end), begin, end - begin, mc);
    ...
    public void testAggregatedSetCollection() {
    	...
    	Map<WellSetBigInteger, BigDecimal> aggregatedReturnedMap = sum.setsAggregated(collection, weights, mc);
    ...
    public void testAggregatedSetArray() {
    	...
    	Map<WellSetBigInteger, BigDecimal> aggregatedReturnedMap = sum.setsAggregated(setArray, weights, mc);
    	Map<WellSetBigInteger, BigDecimal> aggregatedResultMap = new TreeMap<WellSetBigInteger, BigDecimal>();
    ...
    public void testAggregatedSetCollectionIndices() {
    	...
    	Map<WellSetBigInteger, BigDecimal> aggregatedReturnedMap = sum.setsAggregated(collection, weightsIndices, begin, end - begin, mc);
    	Map<WellSetBigInteger, BigDecimal> aggregatedResultMap = new TreeMap<WellSetBigInteger, BigDecimal>();
    ...
    public void testAggregatedSetArrayIndices() {
    	...
    	Map<WellSetBigInteger, BigDecimal> aggregatedReturnedMap = sum.setsAggregated(setArrayIndices, weightsIndices, begin, end - begin, mc);
    	Map<WellSetBigInteger, BigDecimal> aggregatedResultMap = new TreeMap<WellSetBigInteger, BigDecimal>();
