...
import com.github.jessemull.microflex.doubleflex.stat.MinDouble;
import com.github.jessemull.microflex.util.RandomUtil;

/**
 * This class tests the methods in the min double class.
 * 
 * @author Jesse L. Mull
...
public class MinDoubleTest {
	...
	private static MinDouble min = new MinDouble();
    ...
    public void testPlateIndices() {
    	...
    	for(PlateDouble plate : arrayIndices) {
    		...
    		Map<WellDouble, Double> resultMap = new TreeMap<WellDouble, Double>();
    		Map<WellDouble, Double> returnedMap = min.plate(plate, begin, end - begin);
    ...
    public void testAggregatedPlateCollection() {
    	...
    	Map<PlateDouble, Double> aggregatedReturnedMap = min.platesAggregated(collection);
    ...
    public void testAggregatedPlateArray() {
    	...
    	Map<PlateDouble, Double> aggregatedReturnedMap = min.platesAggregated(array);
    	Map<PlateDouble, Double> aggregatedResultMap = new TreeMap<PlateDouble, Double>();
    ...
    public void testAggregatedPlateArrayIndices() {
    	...
    	Map<PlateDouble, Double> aggregatedReturnedMap = min.platesAggregated(arrayIndices, begin, end - begin);
    	Map<PlateDouble, Double> aggregatedResultMap = new TreeMap<PlateDouble, Double>();
    ...
    public void testSet() {
    	...
    	for(PlateDouble plate : array) {
    		...
    		Map<WellDouble, Double> resultMap = new TreeMap<WellDouble, Double>();
    		Map<WellDouble, Double> returnedMap = min.set(plate.dataSet());
    ...
    public void testSetIndices() {
    	...
    	for(PlateDouble plate : arrayIndices) {
    		...
    		Map<WellDouble, Double> resultMap = new TreeMap<WellDouble, Double>();
    		Map<WellDouble, Double> returnedMap = min.set(plate.dataSet(), begin, end - begin);
    ...
    public void testAggregatedSetCollectionIndices() {
    	...
    	Map<WellSetDouble, Double> aggregatedReturnedMap = min.setsAggregated(collection, begin, end - begin);
    	Map<WellSetDouble, Double> aggregatedResultMap = new TreeMap<WellSetDouble, Double>();
    ...
    public void testAggregatedSetArrayIndices() {
    	...
    	Map<WellSetDouble, Double> aggregatedReturnedMap = min.setsAggregated(setArrayIndices, begin, end - begin);
    	Map<WellSetDouble, Double> aggregatedResultMap = new TreeMap<WellSetDouble, Double>();
