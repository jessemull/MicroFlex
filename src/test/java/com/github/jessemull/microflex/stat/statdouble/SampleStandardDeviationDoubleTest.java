...
import com.github.jessemull.microflex.doubleflex.stat.SampleStandardDeviationDouble;
import com.github.jessemull.microflex.util.RandomUtil;

/**
 * This class tests the methods in the deviation double class.
 * 
 * @author Jesse L. Mull
...
public class SampleStandardDeviationDoubleTest {
	...
	private static SampleStandardDeviationDouble deviation = new SampleStandardDeviationDouble();
	...
	public void testConstructor() {
		SampleStandardDeviationDouble test = new SampleStandardDeviationDouble();
		assertNotNull(test);
	}
    ...
    public void testPlate() {
		...
		for(PlateDouble plate : array) {
    		...
    		Map<WellDouble, Double> returnedMap = deviation.plate(plate);
    ...
    public void testAggregatedPlateCollectionIndices() {
    	...
    	Map<PlateDouble, Double> aggregatedReturnedMap = deviation.platesAggregated(collection, begin, end - begin);
    ...
    public void testAggregatedPlateArrayIndices() {
    	...
    	Map<PlateDouble, Double> aggregatedReturnedMap = deviation.platesAggregated(arrayIndices, begin, end - begin);
    	Map<PlateDouble, Double> aggregatedResultMap = new TreeMap<PlateDouble, Double>();
    ...
    public void testSet() {
    	...
    	for(PlateDouble plate : array) {
    		...
    		Map<WellDouble, Double> resultMap = new TreeMap<WellDouble, Double>();
    		Map<WellDouble, Double> returnedMap = deviation.set(plate.dataSet());
    ...
    public void testSetIndices() {
    	...
    	for(PlateDouble plate : arrayIndices) {
    		...
    		Map<WellDouble, Double> resultMap = new TreeMap<WellDouble, Double>();
    		Map<WellDouble, Double> returnedMap = deviation.set(plate.dataSet(), begin, end - begin);
    ...
    public void testAggregatedSetCollection() {
    	...
    	Map<WellSetDouble, Double> aggregatedReturnedMap = deviation.setsAggregated(collection);
    ...
    public void testAggregatedSetArray() {
    	...
    	Map<WellSetDouble, Double> aggregatedReturnedMap = deviation.setsAggregated(setArray);
    	Map<WellSetDouble, Double> aggregatedResultMap = new TreeMap<WellSetDouble, Double>();
    ...
    public void testAggregatedSetCollectionIndices() {
    	...
    	Map<WellSetDouble, Double> aggregatedReturnedMap = deviation.setsAggregated(collection, begin, end - begin);
    	Map<WellSetDouble, Double> aggregatedResultMap = new TreeMap<WellSetDouble, Double>();
    ...
    public void testAggregatedSetArrayIndices() {
    	...
    	Map<WellSetDouble, Double> aggregatedReturnedMap = deviation.setsAggregated(setArrayIndices, begin, end - begin);
    	Map<WellSetDouble, Double> aggregatedResultMap = new TreeMap<WellSetDouble, Double>();
