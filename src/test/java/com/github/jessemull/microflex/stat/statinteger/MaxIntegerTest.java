...
import com.github.jessemull.microflex.integerflex.stat.MaxInteger;
...
public class MaxIntegerTest {
	...
	private static MaxInteger max = new MaxInteger();
	...
	public void testConstructor() {
		MaxInteger test = new MaxInteger();
		assertNotNull(test);
	}
    ...
    public void testPlate() {
		...
		for(PlateInteger plate : array) {
    		...
    		Map<WellInteger, Double> returnedMap = max.plate(plate);
    ...
    public void testAggregatedPlate() {
    	...
    	for(PlateInteger plate : array) {
    		...
    		double aggregatedReturned = Precision.round(max.platesAggregated(plate), precision);
			...
			double resultAggregated = Precision.round(statAggregated.getMax(), precision);
    ...
    public void testAggregatedPlateCollectionIndices() {
    	...
    	Map<PlateInteger, Double> aggregatedReturnedMap = max.platesAggregated(collection, begin, end - begin);
    	...
    	for(PlateInteger plate : collection) {
			...
			DescriptiveStatistics statAggregated = new DescriptiveStatistics(inputAggregated);
			double resultAggregated = statAggregated.getMax();
    ...
    public void testAggregatedPlateArrayIndices() {
    	...
    	Map<PlateInteger, Double> aggregatedReturnedMap = max.platesAggregated(arrayIndices, begin, end - begin);
    	Map<PlateInteger, Double> aggregatedResultMap = new TreeMap<PlateInteger, Double>();
    ...
    public void testSet() {
    	...
    	for(PlateInteger plate : array) {
    		...
    		Map<WellInteger, Double> resultMap = new TreeMap<WellInteger, Double>();
    		Map<WellInteger, Double> returnedMap = max.set(plate.dataSet());
    ...
    public void testAggregatedSet() {
    	...
    	for(PlateInteger plate : array) {
    		...
    		List<Double> resultList = new ArrayList<Double>();
    		double aggregatedReturned = Precision.round(max.setsAggregated(plate.dataSet()), precision);
    ...
    public void testAggregatedSetCollection() {
    	...
    	Map<WellSetInteger, Double> aggregatedReturnedMap = max.setsAggregated(collection);
    ...
    public void testAggregatedSetArray() {
    	...
    	Map<WellSetInteger, Double> aggregatedReturnedMap = max.setsAggregated(setArray);
    	Map<WellSetInteger, Double> aggregatedResultMap = new TreeMap<WellSetInteger, Double>();
    ...
    public void testAggregatedSetIndices() {
    	...
    	for(PlateInteger plate : arrayIndices) {
    		...
    		List<Double> resultList = new ArrayList<Double>();
    		double aggregatedReturned = Precision.round(max.setsAggregated(plate.dataSet(), begin, end - begin), precision);
    ...
    public void testAggregatedSetCollectionIndices() {
    	...
    	Map<WellSetInteger, Double> aggregatedReturnedMap = max.setsAggregated(collection, begin, end - begin);
    	Map<WellSetInteger, Double> aggregatedResultMap = new TreeMap<WellSetInteger, Double>();
    ...
    public void testAggregatedSetArrayIndices() {
    	...
    	Map<WellSetInteger, Double> aggregatedReturnedMap = max.setsAggregated(setArrayIndices, begin, end - begin);
    	Map<WellSetInteger, Double> aggregatedResultMap = new TreeMap<WellSetInteger, Double>();
    ...
    public void testWellIndices() {
    	...
    	for(PlateInteger plate : arrayIndices) {
			...
			for(WellInteger well : plate) {
				...
				DescriptiveStatistics stat = new DescriptiveStatistics(ArrayUtils.subarray(input, begin, end));
				double result = Precision.round(stat.getMax(), precision);
				double returned = Precision.round(max.well(well, begin, end - begin), precision);					
