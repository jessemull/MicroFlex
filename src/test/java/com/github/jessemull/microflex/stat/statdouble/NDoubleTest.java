...
import com.github.jessemull.microflex.doubleflex.stat.NDouble;
...
public class NDoubleTest {
	...
	private static double maxValue = 100;    // Minimum double value for wells
	
	/* The addition operation */
	
	private static NDouble n = new NDouble();
    ...
    public void testAggregatedPlateCollection() {
    	...
    	Map<PlateDouble, Integer> aggregatedReturnedMap = n.platesAggregated(collection);
    	Map<PlateDouble, Integer> aggregatedResultMap = new TreeMap<PlateDouble, Integer>();
    ...
    public void testAggregatedPlateArray() {
    	...
    	Map<PlateDouble, Integer> aggregatedReturnedMap = n.platesAggregated(array);
    	Map<PlateDouble, Integer> aggregatedResultMap = new TreeMap<PlateDouble, Integer>();
