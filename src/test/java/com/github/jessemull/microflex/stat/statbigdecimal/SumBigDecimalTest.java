...
public class SumBigDecimalTest {
	...
	private static SumBigDecimal sum = new SumBigDecimal();
    ...
    public void testPlate() {
		...
		for(PlateBigDecimal plate : array) {
    		...
    		Map<WellBigDecimal, BigDecimal> returnedMap = sum.plate(plate, mc);
    ...
    public void testAggregatedPlateCollection() {
    	...
    	Map<PlateBigDecimal, BigDecimal> aggregatedReturnedMap = sum.platesAggregated(collection, mc);
    ...
    public void testAggregatedPlateArray() {
    	...
    	Map<PlateBigDecimal, BigDecimal> aggregatedReturnedMap = sum.platesAggregated(array, mc);
    	Map<PlateBigDecimal, BigDecimal> aggregatedResultMap = new TreeMap<PlateBigDecimal, BigDecimal>();
    ...
    public void testAggregatedPlateCollectionIndices() {
    	...
    	Map<PlateBigDecimal, BigDecimal> aggregatedReturnedMap = sum.platesAggregated(collection, begin, end - begin, mc);
    ...
    public void testAggregatedPlateArrayIndices() {
    	...
    	Map<PlateBigDecimal, BigDecimal> aggregatedReturnedMap = sum.platesAggregated(arrayIndices, begin, end - begin, mc);
    	Map<PlateBigDecimal, BigDecimal> aggregatedResultMap = new TreeMap<PlateBigDecimal, BigDecimal>();
    ...
    public void testAggregatedSetCollection() {
    	...
    	Map<WellSetBigDecimal, BigDecimal> aggregatedReturnedMap = sum.setsAggregated(collection, mc);
    ...
    public void testAggregatedSetArray() {
    	...
    	Map<WellSetBigDecimal, BigDecimal> aggregatedReturnedMap = sum.setsAggregated(setArray, mc);
    	Map<WellSetBigDecimal, BigDecimal> aggregatedResultMap = new TreeMap<WellSetBigDecimal, BigDecimal>();
    ...
    public void testAggregatedSetCollectionIndices() {
    	...
    	Map<WellSetBigDecimal, BigDecimal> aggregatedReturnedMap = sum.setsAggregated(collection, begin, end - begin, mc);
    	Map<WellSetBigDecimal, BigDecimal> aggregatedResultMap = new TreeMap<WellSetBigDecimal, BigDecimal>();
    ...
    public void testAggregatedSetArrayIndices() {
    	...
    	Map<WellSetBigDecimal, BigDecimal> aggregatedReturnedMap = sum.setsAggregated(setArrayIndices, begin, end - begin, mc);
    	Map<WellSetBigDecimal, BigDecimal> aggregatedResultMap = new TreeMap<WellSetBigDecimal, BigDecimal>();
