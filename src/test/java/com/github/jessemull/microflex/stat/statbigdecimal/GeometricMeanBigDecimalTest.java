...
import com.github.jessemull.microflex.bigdecimalflex.stat.GeometricMeanBigDecimal;
...
public class GeometricMeanBigDecimalTest {
	...
	private static GeometricMeanBigDecimal mean = new GeometricMeanBigDecimal();
	...
	public void testConstructor() {
		GeometricMeanBigDecimal test = new GeometricMeanBigDecimal();
		assertNotNull(test);
	}
    ...
    public void testAggregatedPlateCollectionIndices() {
    	...
    	Map<PlateBigDecimal, BigDecimal> aggregatedReturnedMap = mean.platesAggregated(collection, begin, end - begin, mc);
    ...
    public void testAggregatedPlateArrayIndices() {
    	...
    	Map<PlateBigDecimal, BigDecimal> aggregatedReturnedMap = mean.platesAggregated(arrayIndices, begin, end - begin, mc);
    ...
    public void testAggregatedSetCollection() {
    	...
    	Map<WellSetBigDecimal, BigDecimal> aggregatedReturnedMap = mean.setsAggregated(collection, mc);
    ...
    public void testAggregatedSetArray() {
    	...
    	Map<WellSetBigDecimal, BigDecimal> aggregatedReturnedMap = mean.setsAggregated(setArray, mc);
    	Map<WellSetBigDecimal, BigDecimal> aggregatedResultMap = new TreeMap<WellSetBigDecimal, BigDecimal>();
    ...
    public void testAggregatedSetCollectionIndices() {
    	...
    	Map<WellSetBigDecimal, BigDecimal> aggregatedReturnedMap = mean.setsAggregated(collection, begin, end - begin, mc);
    	Map<WellSetBigDecimal, BigDecimal> aggregatedResultMap = new TreeMap<WellSetBigDecimal, BigDecimal>();
    ...
    public void testAggregatedSetArrayIndices() {
    	...
    	Map<WellSetBigDecimal, BigDecimal> aggregatedReturnedMap = mean.setsAggregated(array, begin, end - begin, mc);
    	Map<WellSetBigDecimal, BigDecimal> aggregatedResultMap = new TreeMap<WellSetBigDecimal, BigDecimal>();
