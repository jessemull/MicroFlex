...
public class StandardDeviationBigDecimalTest {
	...
	private static SampleStandardDeviationBigDecimal deviation = new SampleStandardDeviationBigDecimal();
    ...
    public void testPlate() {
		...
		for(PlateBigDecimal plate : array) {
    		...
    		Map<WellBigDecimal, BigDecimal> returnedMap = deviation.plate(plate, mc);
    ...
    public void testAggregatedPlateCollection() {
    	...
    	Map<PlateBigDecimal, BigDecimal> aggregatedReturnedMap = deviation.platesAggregated(collection, mc);
    ...
    public void testAggregatedPlateArray() {
    	...
    	Map<PlateBigDecimal, BigDecimal> aggregatedReturnedMap = deviation.platesAggregated(array, mc);
    	Map<PlateBigDecimal, BigDecimal> aggregatedResultMap = new TreeMap<PlateBigDecimal, BigDecimal>();
    ...
    public void testAggregatedPlateCollectionIndices() {
    	...
    	Map<PlateBigDecimal, BigDecimal> aggregatedReturnedMap = deviation.platesAggregated(collection, begin, end - begin, mc);
    ...
    public void testAggregatedPlateArrayIndices() {
    	...
    	Map<PlateBigDecimal, BigDecimal> aggregatedReturnedMap = deviation.platesAggregated(arrayIndices, begin, end - begin, mc);
    	Map<PlateBigDecimal, BigDecimal> aggregatedResultMap = new TreeMap<PlateBigDecimal, BigDecimal>();
    ...
    public void testSet() {
    	...
    	for(PlateBigDecimal plate : array) {
    		...
    		Map<WellBigDecimal, BigDecimal> resultMap = new TreeMap<WellBigDecimal, BigDecimal>();
    		Map<WellBigDecimal, BigDecimal> returnedMap = deviation.set(plate.dataSet(), mc);
    ...
    public void testAggregatedSetCollection() {
    	...
    	Map<WellSetBigDecimal, BigDecimal> aggregatedReturnedMap = deviation.setsAggregated(collection, mc);
    ...
    public void testAggregatedSetArray() {
    	...
    	Map<WellSetBigDecimal, BigDecimal> aggregatedReturnedMap = deviation.setsAggregated(setArray, mc);
    	Map<WellSetBigDecimal, BigDecimal> aggregatedResultMap = new TreeMap<WellSetBigDecimal, BigDecimal>();
    ...
    public void testAggregatedSetCollectionIndices() {
    	...
    	Map<WellSetBigDecimal, BigDecimal> aggregatedReturnedMap = deviation.setsAggregated(collection, begin, end - begin, mc);
    	Map<WellSetBigDecimal, BigDecimal> aggregatedResultMap = new TreeMap<WellSetBigDecimal, BigDecimal>();
    ...
    public void testAggregatedSetArrayIndices() {
    	...
    	Map<WellSetBigDecimal, BigDecimal> aggregatedReturnedMap = deviation.setsAggregated(setArrayIndices, begin, end - begin, mc);
    	Map<WellSetBigDecimal, BigDecimal> aggregatedResultMap = new TreeMap<WellSetBigDecimal, BigDecimal>();
