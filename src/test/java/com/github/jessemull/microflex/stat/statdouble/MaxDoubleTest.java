...
import com.github.jessemull.microflex.doubleflex.stat.MaxDouble;
import com.github.jessemull.microflex.util.RandomUtil;

/**
 * This class tests the methods in the max double class.
 * @author Jesse L. Mull
...
public class MaxDoubleTest {
	...
	private static MaxDouble max = new MaxDouble();
    ...
    public void testPlate() {
		...
		for(PlateDouble plate : array) {
    		...
    		Map<WellDouble, Double> returnedMap = max.plate(plate);
    ...
    public void testAggregatedPlateCollectionIndices() {
    	...
    	Map<PlateDouble, Double> aggregatedReturnedMap = max.platesAggregated(collection, begin, end - begin);
    ...
    public void testAggregatedPlateArrayIndices() {
    	...
    	Map<PlateDouble, Double> aggregatedReturnedMap = max.platesAggregated(arrayIndices, begin, end - begin);
    	Map<PlateDouble, Double> aggregatedResultMap = new TreeMap<PlateDouble, Double>();
    ...
    public void testSet() {
    	...
    	for(PlateDouble plate : array) {
    		...
    		Map<WellDouble, Double> resultMap = new TreeMap<WellDouble, Double>();
    		Map<WellDouble, Double> returnedMap = max.set(plate.dataSet());
    ...
    public void testAggregatedSetCollection() {
    	...
    	Map<WellSetDouble, Double> aggregatedReturnedMap = max.setsAggregated(collection);
    ...
    public void testAggregatedSetArray() {
    	...
    	Map<WellSetDouble, Double> aggregatedReturnedMap = max.setsAggregated(setArray);
    	Map<WellSetDouble, Double> aggregatedResultMap = new TreeMap<WellSetDouble, Double>();
