...
import com.github.jessemull.microflex.bigintegerflex.math.DivisionBigInteger;
...
/**
 * This class tests the methods in the division big integer class.
 * 
 * @author Jesse L. Mull
...
public class DivisionBigIntegerTest {
	...
	private static DivisionBigInteger division = new DivisionBigInteger();
	...
	public static void setUp() {
    	...
    	for(int i = 0; i < stackNumber; i++) {
    		...
    		for(PlateBigInteger plate1 : stack1) {
	    		for(WellBigInteger well : plate1) {				
					if(well.contains(BigInteger.ZERO)) {
						Collections.replaceAll(well.data(), BigInteger.ZERO, BigInteger.ONE);
					} 				
				}
    		}
			
    		for(PlateBigInteger plate2 : stack2) {
				for(WellBigInteger well : plate2) {
					if(well.contains(BigInteger.ZERO)) {
						Collections.replaceAll(well.data(), BigInteger.ZERO, BigInteger.ONE);
					}
				}
			...
			for(PlateBigInteger plateUneven : stackUneven) {
				for(WellBigInteger well : plateUneven) {
					if(well.contains(BigInteger.ZERO)) {
						Collections.replaceAll(well.data(), BigInteger.ZERO, BigInteger.ONE);
					}
				}
    	...
    	for(int i = 0; i < arrayNumber; i++) {
    		...
    		for(int j = 0; j < array1.length; j++) {
    			...
    			for(WellBigInteger well : unevenPlate) {
    				if(well.contains(BigInteger.ZERO)) {
    					Collections.replaceAll(well.data(), BigInteger.ZERO, BigInteger.ONE);
    				}
    			}
	...
	public void testConstructor() {		
		DivisionBigInteger test = new DivisionBigInteger();
		assertNotNull(test);
	}
    ...
    public void testWells() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(int j = 0; j < well1.length; j++) {
    			...
    			List<BigInteger> returned = division.wells(well1[j], well2[j]);
    			List<BigInteger> returnedUneven = division.wells(well1[j], wellUneven[j]);
    			
    			for(int k = 0; k < list1.size(); k++) {
    				result.add(list1.get(k).divide(list2.get(k)));
    				resultUneven.add(list1.get(k).divide(unevenList.get(k)));
    			}
    ...
    public void testWellsIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(int j = 0; j < well1.length; j++) {
    			...
    			List<BigInteger> result = new ArrayList<BigInteger>();
    			List<BigInteger> resultUneven = new ArrayList<BigInteger>();
    			List<BigInteger> returned = division.wells(well1[j], well2[j], begin, end - begin);
    			List<BigInteger> returnedUneven = division.wells(well1[j], wellUneven[j], begin, end - begin);
    ...
    public void testWellsStrict() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(int j = 0; j < well1.length; j++) {
    			...
    			List<BigInteger> result = new ArrayList<BigInteger>();
    			List<BigInteger> resultUneven = new ArrayList<BigInteger>();
    			List<BigInteger> returned = division.wellsStrict(well1[j], well2[j]);
    			List<BigInteger> returnedUneven = division.wellsStrict(well1[j], wellUneven[j]);
    ...
    public void testWellsStrictIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(int j = 0; j < well1.length; j++) {
    			...
    			List<BigInteger> result = new ArrayList<BigInteger>();
    			List<BigInteger> resultUneven = new ArrayList<BigInteger>();
    			List<BigInteger> returned = division.wellsStrict(well1[j], well2[j], begin, end - begin);
    			List<BigInteger> returnedUneven = division.wellsStrict(well1[j], wellUneven[j], begin, end - begin);
    ...
    public void testWellConstant() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(int j = 0; j < well1.length; j++) {
    			...
    			List<BigInteger> list1 = well1[j].data();
    			List<BigInteger> result = new ArrayList<BigInteger>();
    			List<BigInteger> returned = division.wells(well1[j], constantBigInteger);
    			
    			for(int k = 0; k < list1.size(); k++) {
    				result.add(list1.get(k).divide(constantBigInteger));
    			}
    ...
    public void testWellArray() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(int j = 0; j < well1.length; j++) {
    			...
    			List<BigInteger> result = new ArrayList<BigInteger>();
    			List<BigInteger> resultUneven = new ArrayList<BigInteger>();
    			List<BigInteger> returned = division.wells(well1[j], array);
    			List<BigInteger> returnedUneven = division.wells(well1[j], arrayUneven);
    			
    			for(int k = 0; k < list1.size(); k++) {
    				result.add(list1.get(k).divide(array[k]));
    				resultUneven.add(list1.get(k).divide(arrayUneven[k]));
    			}
    ...
    public void testWellArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(int j = 0; j < well1.length; j++) {
    			...
    			List<BigInteger> result = new ArrayList<BigInteger>();
    			List<BigInteger> resultUneven = new ArrayList<BigInteger>();
    			List<BigInteger> returned = division.wells(well1[j], array, begin, end - begin);
    			List<BigInteger> returnedUneven = division.wells(well1[j], arrayUneven, begin, end - begin);
    ...
    public void testWellStrictArray() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(int j = 0; j < well1.length; j++) {
    			...
    			List<BigInteger> result = new ArrayList<BigInteger>();
    			List<BigInteger> resultUneven = new ArrayList<BigInteger>();
    			List<BigInteger> returned = division.wellsStrict(well1[j], array);
    			List<BigInteger> returnedUneven = division.wellsStrict(well1[j], arrayUneven);
    ...
    public void testWellStrictArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(int j = 0; j < well1.length; j++) {
    			...
    			List<BigInteger> result = new ArrayList<BigInteger>();
    			List<BigInteger> resultUneven = new ArrayList<BigInteger>();
    			List<BigInteger> returned = division.wellsStrict(well1[j], array, begin, end - begin);
    			List<BigInteger> returnedUneven = division.wellsStrict(well1[j], arrayUneven, begin, end - begin);
    ...
    public void testPlates() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateBigInteger returnedPlate = division.plates(plate1, plate2);
    		PlateBigInteger returnedPlateUneven = division.plates(plate1, plateUneven);
    ...
    public void testPlatesIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateBigInteger returnedPlate = division.plates(plate1, plate2, begin, end - begin);
    		PlateBigInteger returnedPlateUneven = division.plates(plate1, plateUneven, begin, end - begin);
    		PlateBigInteger resultPlate = new PlateBigInteger(plate1.rows(), plate2.columns(), result[0]);
    		PlateBigInteger resultUnevenPlate = new PlateBigInteger(plateUneven.rows(), plateUneven.columns(), result[1]);
    ...
    public void testPlatesStrict() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateBigInteger returnedPlate = division.platesStrict(plate1, plate2);
    		PlateBigInteger returnedPlateUneven = division.platesStrict(plate1, plateUneven);
    		PlateBigInteger resultPlate = new PlateBigInteger(plate1.rows(), plate2.columns(), result[0]);
    		PlateBigInteger resultUnevenPlate = new PlateBigInteger(plateUneven.rows(), plateUneven.columns(), result[1]);
    ...
    public void testPlatesStrictIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateBigInteger returnedPlate = division.platesStrict(plate1, plate2, begin, end - begin);
    		PlateBigInteger returnedPlateUneven = division.platesStrict(plate1, plateUneven, begin, end - begin);
    		PlateBigInteger resultPlate = new PlateBigInteger(plate1.rows(), plate2.columns(), result[0]);
    		PlateBigInteger resultUnevenPlate = new PlateBigInteger(plateUneven.rows(), plateUneven.columns(), result[1]);
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(WellBigInteger well : set1) {
    			...
    			for(BigInteger bd : well.data()) {
    				list.add(bd.divide(randomBigInteger));
    			}
    			
    			result.add(new WellBigInteger(well.row(), well.column(), list));
    		}

    		PlateBigInteger returnedPlate = division.plates(plate1, randomBigInteger);
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(WellBigInteger well : set1) {
    			...
    			for(index = 0; index < list.size() && index < array.length; index++) {
    				wellResult.add(list.get(index).divide(array[index]));
    			}
    		...
    		for(WellBigInteger well : set1) {
    			...
    			for(index = 0; index < list.size() && index < arrayUneven.length; index++) {
    				wellResult.add(list.get(index).divide(arrayUneven[index]));
    			}
    		...
    		PlateBigInteger returned = division.plates(plate1, array);
    		PlateBigInteger returnedUneven = division.plates(plate1, arrayUneven);
    ...
    public void testPlateArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
           ...
           for(WellBigInteger well : set1) {
    		...
    		PlateBigInteger resultPlate = new PlateBigInteger(plate1.rows(), plate1.columns(), result);
    		PlateBigInteger resultPlateUneven = new PlateBigInteger(plate1.rows(), plate1.columns(), resultUneven);
    		PlateBigInteger returned = division.plates(plate1, array, begin, end - begin);
    		PlateBigInteger returnedUneven = division.plates(plate1, arrayUneven, begin, end - begin);
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(WellBigInteger well : set1) {
    			...
    			for(index = 0; index < list.size() && index < inputList.size(); index++) {
    				wellResult.add(list.get(index).divide(inputList.get(index)));
    			}
    		...
    		for(WellBigInteger well : set1) {
    			...
    			for(index = 0; index < list.size() && index < inputListUneven.size(); index++) {
    				wellResult.add(list.get(index).divide(inputListUneven.get(index)));
    			}
    		...
    		PlateBigInteger resultPlate = new PlateBigInteger(plate1.rows(), plate1.columns(), result);
    		PlateBigInteger resultPlateUneven = new PlateBigInteger(plate1.rows(), plate1.columns(), resultUneven);
    		PlateBigInteger returned = division.plates(plate1, inputList);
    		PlateBigInteger returnedUneven = division.plates(plate1, inputListUneven);
    ...
    public void testPlateCollectionIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
           ...
           for(WellBigInteger well : set1) {
    		...
    		PlateBigInteger returned = division.plates(plate1, inputList, begin, end - begin);
    		PlateBigInteger returnedUneven = division.plates(plate1, inputListUneven, begin, end - begin);
    ...
    public void testPlateStrictArray() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateBigInteger resultPlate = new PlateBigInteger(plate1.rows(), plate1.columns(), result);
    		PlateBigInteger resultPlateUneven = new PlateBigInteger(plate1.rows(), plate1.columns(), resultUneven);
    		PlateBigInteger returned = division.platesStrict(plate1, array);
    		PlateBigInteger returnedUneven = division.platesStrict(plate1, arrayUneven);
    ...
    public void testPlateStrictArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateBigInteger resultPlate = new PlateBigInteger(plate1.rows(), plate1.columns(), result);
    		PlateBigInteger resultPlateUneven = new PlateBigInteger(plate1.rows(), plate1.columns(), resultUneven);
    		PlateBigInteger returned = division.platesStrict(plate1, array, begin, end - begin);
    		PlateBigInteger returnedUneven = division.platesStrict(plate1, arrayUneven, begin, end - begin);
    ...
    public void testPlateStrictCollection() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateBigInteger resultPlate = new PlateBigInteger(plate1.rows(), plate1.columns(), result);
    		PlateBigInteger resultPlateUneven = new PlateBigInteger(plate1.rows(), plate1.columns(), resultUneven);
    		PlateBigInteger returned = division.platesStrict(plate1, inputList);
    		PlateBigInteger returnedUneven = division.platesStrict(plate1, inputListUneven);
    ...
    public void testPlateStrictCollectionIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
           ...
           for(WellBigInteger well : set1) {
    		...
    		PlateBigInteger returned = division.platesStrict(plate1, inputList, begin, end - begin);
    		PlateBigInteger returnedUneven = division.platesStrict(plate1, inputListUneven, begin, end - begin);
    ...
    public void testSets() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigInteger[] result = this.set(set1, set2, setUneven, false);
    		WellSetBigInteger returned = division.sets(set1, set2);
    		WellSetBigInteger returnedUneven = division.sets(set1, setUneven);
    ...
    public void testSetsIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigInteger[] result = this.set(set1, set2, setUneven, begin, end, false);
    		WellSetBigInteger returned = division.sets(set1, set2, begin, end - begin);
    		WellSetBigInteger returnedUneven = division.sets(set1, setUneven, begin, end - begin);
    ...
    public void testSetsStrict() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigInteger[] result = this.set(set1, set2, setUneven, true);
    		WellSetBigInteger returned = division.setsStrict(set1, set2);
    		WellSetBigInteger returnedUneven = division.setsStrict(set1, setUneven);
    ...
    public void testSetsStrictIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigInteger[] result = this.set(set1, set2, setUneven, begin, end, true);
    		WellSetBigInteger returned = division.setsStrict(set1, set2, begin, end - begin);
    		WellSetBigInteger returnedUneven = division.setsStrict(set1, setUneven, begin, end - begin);
    ...
    public void testSetConstant() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigInteger returned = division.sets(set, randomBigInteger);
    ...
    public void testSetArray() {   	
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigInteger returned = division.sets(set1, array);
    		WellSetBigInteger returnedUneven = division.sets(set1, arrayUneven);
    ...
    public void testSetArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigInteger returned = division.sets(set1, array, begin, end - begin);
    		WellSetBigInteger returnedUneven = division.sets(set1, arrayUneven, begin, end - begin);
    ...
    public void testSetCollection() {   
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigInteger returned = division.sets(set1, inputList);
    		WellSetBigInteger returnedUneven = division.sets(set1, inputListUneven);
    ...
    public void testSetCollectionIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigInteger returned = division.sets(set1, inputList, begin, end - begin);
    		WellSetBigInteger returnedUneven = division.sets(set1, inputListUneven, begin, end - begin);
    ...
    public void testSetStrictArray() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigInteger returned = division.setsStrict(set1, array);
    		WellSetBigInteger returnedUneven = division.setsStrict(set1, arrayUneven);
    ...
    public void testSetStrictArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigInteger returned = division.setsStrict(set1, array, begin, end - begin);
    		WellSetBigInteger returnedUneven = division.setsStrict(set1, arrayUneven, begin, end - begin);
    ...
    public void testSetStrictCollection() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigInteger returned = division.setsStrict(set1, inputList);
    		WellSetBigInteger returnedUneven = division.setsStrict(set1, inputListUneven);
    ...
    public void testSetStrictCollectionIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigInteger returned = division.setsStrict(set1, inputList, begin, end - begin);
    		WellSetBigInteger returnedUneven = division.setsStrict(set1, inputListUneven, begin, end - begin);
    ...
    public void testStacks() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigInteger returned = division.stacks(stack1, stack2);
	    	StackBigInteger returnedUneven = division.stacks(stack1, stackUneven);
    ...
    public void testStacksIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigInteger returned = division.stacks(stack1, stack2, begin, end - begin);
	    	StackBigInteger returnedUneven = division.stacks(stack1, stackUneven, begin, end - begin);
    ...
    public void testStacksStrict() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigInteger returned = division.stacksStrict(stack1, stack2);
	    	StackBigInteger returnedUneven = division.stacksStrict(stack1, stackUneven);
    ...
    public void testStacksStrictIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigInteger returned = division.stacksStrict(stack1, stack2, begin, end - begin);
	    	StackBigInteger returnedUneven = division.stacksStrict(stack1, stackUneven, begin, end - begin);
    ...
    public void testStackConstant() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	while(stackIter1.hasNext()) {
	    		...
	    		for(WellBigInteger well : plate) {
	    			...
	    			for(BigInteger bd : well) {
	    				resultList.add(bd.divide(randomBigInteger));
	    			}
	    	...
	    	StackBigInteger returned = division.stacks(stack1, randomBigInteger);
    ...
    public void testStackArray() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigInteger returned = division.stacks(stack1, array);
	    	StackBigInteger returnedUneven = division.stacks(stack1, arrayUneven);
    ...
    public void testStackArrayIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigInteger returned = division.stacks(stack1, array, begin, end - begin);
	    	StackBigInteger returnedUneven = division.stacks(stack1, arrayUneven, begin, end - begin);
    ...
    public void testStackCollection() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigInteger returned = division.stacks(stack1, inputList);
	    	StackBigInteger returnedUneven = division.stacks(stack1, inputListUneven);
    ...
    public void testStackCollectionIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigInteger returned = division.stacks(stack1, inputList, begin, end - begin);
	    	StackBigInteger returnedUneven = division.stacks(stack1, inputListUneven, begin, end - begin);
    ...
    public void testStackStrictArray() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigInteger returned = division.stacksStrict(stack1, array);
	    	StackBigInteger returnedUneven = division.stacksStrict(stack1, arrayUneven);
    ...
    public void testStackStrictArrayIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigInteger returned = division.stacksStrict(stack1, array, begin, end - begin);
	    	StackBigInteger returnedUneven = division.stacksStrict(stack1, arrayUneven, begin, end - begin);
    ...
    public void testStackStrictCollection() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigInteger returned = division.stacksStrict(stack1, inputList);
	    	StackBigInteger returnedUneven = division.stacksStrict(stack1, inputListUneven);
    ...
    public void testStackStrictCollectionIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigInteger returned = division.stacksStrict(stack1, inputList, begin, end - begin);
	    	StackBigInteger returnedUneven = division.stacksStrict(stack1, inputListUneven, begin, end - begin);
