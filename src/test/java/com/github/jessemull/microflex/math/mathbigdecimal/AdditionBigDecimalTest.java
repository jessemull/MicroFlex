...
import com.github.jessemull.microflex.bigdecimalflex.math.AdditionBigDecimal;
...
public class AdditionBigDecimalTest {
...
/* ---------------------------- Local fields ---------------------------- */
	...
	private static AdditionBigDecimal addition = new AdditionBigDecimal();
	...
	public void testConstructor() {		
		AdditionBigDecimal test = new AdditionBigDecimal();
		assertNotNull(test);
	}
    ...
    public void testPlates() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateBigDecimal returnedPlate = addition.plates(plate1, plate2);
    		PlateBigDecimal returnedPlateUneven = addition.plates(plate1, plateUneven);
    ...
    public void testPlatesIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateBigDecimal returnedPlate = addition.plates(plate1, plate2, begin, end - begin);
    		PlateBigDecimal returnedPlateUneven = addition.plates(plate1, plateUneven, begin, end - begin);
    		PlateBigDecimal resultPlate = new PlateBigDecimal(plate1.rows(), plate2.columns(), result[0]);
    		PlateBigDecimal resultUnevenPlate = new PlateBigDecimal(plateUneven.rows(), plateUneven.columns(), result[1]);
    ...
    public void testPlatesStrict() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateBigDecimal returnedPlate = addition.platesStrict(plate1, plate2);
    		PlateBigDecimal returnedPlateUneven = addition.platesStrict(plate1, plateUneven);
    		PlateBigDecimal resultPlate = new PlateBigDecimal(plate1.rows(), plate2.columns(), result[0]);
    		PlateBigDecimal resultUnevenPlate = new PlateBigDecimal(plateUneven.rows(), plateUneven.columns(), result[1]);
    ...
    public void testPlatesStrictIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateBigDecimal returnedPlate = addition.platesStrict(plate1, plate2, begin, end - begin);
    		PlateBigDecimal returnedPlateUneven = addition.platesStrict(plate1, plateUneven, begin, end - begin);
    		PlateBigDecimal resultPlate = new PlateBigDecimal(plate1.rows(), plate2.columns(), result[0]);
    		PlateBigDecimal resultUnevenPlate = new PlateBigDecimal(plateUneven.rows(), plateUneven.columns(), result[1]);
    ...
    public void testPlateConstant() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateBigDecimal returnedPlate = addition.plates(plate1, randomBigDecimal);
    ...
    public void testPlateArray() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateBigDecimal returned = addition.plates(plate1, array);
    		PlateBigDecimal returnedUneven = addition.plates(plate1, arrayUneven);
    ...
    public void testPlateArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
           ...
           for(WellBigDecimal well : set1) {
    		...
    		PlateBigDecimal resultPlate = new PlateBigDecimal(plate1.rows(), plate1.columns(), result);
    		PlateBigDecimal resultPlateUneven = new PlateBigDecimal(plate1.rows(), plate1.columns(), resultUneven);
    		PlateBigDecimal returned = addition.plates(plate1, array, begin, end - begin);
    		PlateBigDecimal returnedUneven = addition.plates(plate1, arrayUneven, begin, end - begin);
    ...
    public void testPlateCollection() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateBigDecimal resultPlate = new PlateBigDecimal(plate1.rows(), plate1.columns(), result);
    		PlateBigDecimal resultPlateUneven = new PlateBigDecimal(plate1.rows(), plate1.columns(), resultUneven);
    		PlateBigDecimal returned = addition.plates(plate1, inputList);
    		PlateBigDecimal returnedUneven = addition.plates(plate1, inputListUneven);
    ...
    public void testPlateCollectionIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
           ...
           for(WellBigDecimal well : set1) {
    		...
    		PlateBigDecimal returned = addition.plates(plate1, inputList, begin, end - begin);
    		PlateBigDecimal returnedUneven = addition.plates(plate1, inputListUneven, begin, end - begin);
    ...
    public void testPlateStrictArray() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateBigDecimal resultPlate = new PlateBigDecimal(plate1.rows(), plate1.columns(), result);
    		PlateBigDecimal resultPlateUneven = new PlateBigDecimal(plate1.rows(), plate1.columns(), resultUneven);
    		PlateBigDecimal returned = addition.platesStrict(plate1, array);
    		PlateBigDecimal returnedUneven = addition.platesStrict(plate1, arrayUneven);
    ...
    public void testPlateStrictArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateBigDecimal resultPlate = new PlateBigDecimal(plate1.rows(), plate1.columns(), result);
    		PlateBigDecimal resultPlateUneven = new PlateBigDecimal(plate1.rows(), plate1.columns(), resultUneven);
    		PlateBigDecimal returned = addition.platesStrict(plate1, array, begin, end - begin);
    		PlateBigDecimal returnedUneven = addition.platesStrict(plate1, arrayUneven, begin, end - begin);
    ...
    public void testPlateStrictCollection() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateBigDecimal resultPlate = new PlateBigDecimal(plate1.rows(), plate1.columns(), result);
    		PlateBigDecimal resultPlateUneven = new PlateBigDecimal(plate1.rows(), plate1.columns(), resultUneven);
    		PlateBigDecimal returned = addition.platesStrict(plate1, inputList);
    		PlateBigDecimal returnedUneven = addition.platesStrict(plate1, inputListUneven);
    ...
    public void testPlateStrictCollectionIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
           ...
           for(WellBigDecimal well : set1) {
    		...
    		PlateBigDecimal returned = addition.platesStrict(plate1, inputList, begin, end - begin);
    		PlateBigDecimal returnedUneven = addition.platesStrict(plate1, inputListUneven, begin, end - begin);
    ...
    public void testSets() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigDecimal[] result = this.set(set1, set2, setUneven, false);
    		WellSetBigDecimal returned = addition.sets(set1, set2);
    		WellSetBigDecimal returnedUneven = addition.sets(set1, setUneven);
    ...
    public void testSetsIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigDecimal[] result = this.set(set1, set2, setUneven, begin, end, false);
    		WellSetBigDecimal returned = addition.sets(set1, set2, begin, end - begin);
    		WellSetBigDecimal returnedUneven = addition.sets(set1, setUneven, begin, end - begin);
    ...
    public void testSetsStrict() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigDecimal[] result = this.set(set1, set2, setUneven, true);
    		WellSetBigDecimal returned = addition.setsStrict(set1, set2);
    		WellSetBigDecimal returnedUneven = addition.setsStrict(set1, setUneven);
    ...
    public void testSetsStrictIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigDecimal[] result = this.set(set1, set2, setUneven, begin, end, true);
    		WellSetBigDecimal returned = addition.setsStrict(set1, set2, begin, end - begin);
    		WellSetBigDecimal returnedUneven = addition.setsStrict(set1, setUneven, begin, end - begin);
    ...
    public void testSetConstant() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigDecimal returned = addition.sets(set, randomBigDecimal);
    ...
    public void testSetArray() {   	
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigDecimal returned = addition.sets(set1, array);
    		WellSetBigDecimal returnedUneven = addition.sets(set1, arrayUneven);
    ...
    public void testSetArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigDecimal returned = addition.sets(set1, array, begin, end - begin);
    		WellSetBigDecimal returnedUneven = addition.sets(set1, arrayUneven, begin, end - begin);
    ...
    public void testSetCollection() {   
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigDecimal returned = addition.sets(set1, inputList);
    		WellSetBigDecimal returnedUneven = addition.sets(set1, inputListUneven);
    ...
    public void testSetCollectionIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigDecimal returned = addition.sets(set1, inputList, begin, end - begin);
    		WellSetBigDecimal returnedUneven = addition.sets(set1, inputListUneven, begin, end - begin);
    ...
    public void testSetStrictArray() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigDecimal returned = addition.setsStrict(set1, array);
    		WellSetBigDecimal returnedUneven = addition.setsStrict(set1, arrayUneven);
    ...
    public void testSetStrictArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigDecimal returned = addition.setsStrict(set1, array, begin, end - begin);
    		WellSetBigDecimal returnedUneven = addition.setsStrict(set1, arrayUneven, begin, end - begin);
    ...
    public void testSetStrictCollection() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigDecimal returned = addition.setsStrict(set1, inputList);
    		WellSetBigDecimal returnedUneven = addition.setsStrict(set1, inputListUneven);
    ...
    public void testSetStrictCollectionIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigDecimal returned = addition.setsStrict(set1, inputList, begin, end - begin);
    		WellSetBigDecimal returnedUneven = addition.setsStrict(set1, inputListUneven, begin, end - begin);
    ...
    public void testStacks() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigDecimal returned = addition.stacks(stack1, stack2);
	    	StackBigDecimal returnedUneven = addition.stacks(stack1, stackUneven);
    ...
    public void testStacksIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigDecimal returned = addition.stacks(stack1, stack2, begin, end - begin);
	    	StackBigDecimal returnedUneven = addition.stacks(stack1, stackUneven, begin, end - begin);
    ...
    public void testStacksStrict() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigDecimal returned = addition.stacksStrict(stack1, stack2);
	    	StackBigDecimal returnedUneven = addition.stacksStrict(stack1, stackUneven);
    ...
    public void testStacksStrictIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigDecimal returned = addition.stacksStrict(stack1, stack2, begin, end - begin);
	    	StackBigDecimal returnedUneven = addition.stacksStrict(stack1, stackUneven, begin, end - begin);
    ...
    public void testStackConstant() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigDecimal returned = addition.stacks(stack1, randomBigDecimal);
    ...
    public void testStackArray() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigDecimal returned = addition.stacks(stack1, array);
	    	StackBigDecimal returnedUneven = addition.stacks(stack1, arrayUneven);
    ...
    public void testStackArrayIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigDecimal returned = addition.stacks(stack1, array, begin, end - begin);
	    	StackBigDecimal returnedUneven = addition.stacks(stack1, arrayUneven, begin, end - begin);
    ...
    public void testStackCollection() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigDecimal returned = addition.stacks(stack1, inputList);
	    	StackBigDecimal returnedUneven = addition.stacks(stack1, inputListUneven);
    ...
    public void testStackCollectionIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigDecimal returned = addition.stacks(stack1, inputList, begin, end - begin);
	    	StackBigDecimal returnedUneven = addition.stacks(stack1, inputListUneven, begin, end - begin);
    ...
    public void testStackStrictArray() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigDecimal returned = addition.stacksStrict(stack1, array);
	    	StackBigDecimal returnedUneven = addition.stacksStrict(stack1, arrayUneven);
    ...
    public void testStackStrictArrayIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigDecimal returned = addition.stacksStrict(stack1, array, begin, end - begin);
	    	StackBigDecimal returnedUneven = addition.stacksStrict(stack1, arrayUneven, begin, end - begin);
    ...
    public void testStackStrictCollection() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigDecimal returned = addition.stacksStrict(stack1, inputList);
	    	StackBigDecimal returnedUneven = addition.stacksStrict(stack1, inputListUneven);
    ...
    public void testStackStrictCollectionIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigDecimal returned = addition.stacksStrict(stack1, inputList, begin, end - begin);
	    	StackBigDecimal returnedUneven = addition.stacksStrict(stack1, inputListUneven, begin, end - begin);
