...
import com.github.jessemull.microflex.bigdecimalflex.math.ModulusBigDecimal;
...
public class ModulusBigDecimalTest {
...
/* ---------------------------- Local fields ---------------------------- */
	...
	private static ModulusBigDecimal modulus = new ModulusBigDecimal();
	...
	public void testConstructor() {		
		ModulusBigDecimal test = new ModulusBigDecimal();
		assertNotNull(test);
	}
    ...
    public void testPlates() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateBigDecimal returnedPlate = modulus.plates(plate1, plate2, mc);
    		PlateBigDecimal returnedPlateUneven = modulus.plates(plate1, plateUneven, mc);
    ...
    public void testPlatesIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateBigDecimal returnedPlate = modulus.plates(plate1, plate2, begin, end - begin, mc);
    		PlateBigDecimal returnedPlateUneven = modulus.plates(plate1, plateUneven, begin, end - begin, mc);
    		PlateBigDecimal resultPlate = new PlateBigDecimal(plate1.rows(), plate2.columns(), result[0]);
    		PlateBigDecimal resultUnevenPlate = new PlateBigDecimal(plateUneven.rows(), plateUneven.columns(), result[1]);
    ...
    public void testPlatesStrict() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateBigDecimal returnedPlate = modulus.platesStrict(plate1, plate2, mc);
    		PlateBigDecimal returnedPlateUneven = modulus.platesStrict(plate1, plateUneven, mc);
    		PlateBigDecimal resultPlate = new PlateBigDecimal(plate1.rows(), plate2.columns(), result[0]);
    		PlateBigDecimal resultUnevenPlate = new PlateBigDecimal(plateUneven.rows(), plateUneven.columns(), result[1]);
    ...
    public void testPlatesStrictIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateBigDecimal returnedPlate = modulus.platesStrict(plate1, plate2, begin, end - begin, mc);
    		PlateBigDecimal returnedPlateUneven = modulus.platesStrict(plate1, plateUneven, begin, end - begin, mc);
    		PlateBigDecimal resultPlate = new PlateBigDecimal(plate1.rows(), plate2.columns(), result[0]);
    		PlateBigDecimal resultUnevenPlate = new PlateBigDecimal(plateUneven.rows(), plateUneven.columns(), result[1]);
    ...
    public void testPlateConstant() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateBigDecimal returnedPlate = modulus.plates(plate1, randomBigDecimal, mc);
    ...
    public void testPlateArray() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateBigDecimal returned = modulus.plates(plate1, array, mc);
    		PlateBigDecimal returnedUneven = modulus.plates(plate1, arrayUneven, mc);
    ...
    public void testPlateArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
           ...
           for(WellBigDecimal well : set1) {
    		...
    		PlateBigDecimal resultPlate = new PlateBigDecimal(plate1.rows(), plate1.columns(), result);
    		PlateBigDecimal resultPlateUneven = new PlateBigDecimal(plate1.rows(), plate1.columns(), resultUneven);
    		PlateBigDecimal returned = modulus.plates(plate1, array, begin, end - begin, mc);
    		PlateBigDecimal returnedUneven = modulus.plates(plate1, arrayUneven, begin, end - begin, mc);
    ...
    public void testPlateCollection() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateBigDecimal resultPlate = new PlateBigDecimal(plate1.rows(), plate1.columns(), result);
    		PlateBigDecimal resultPlateUneven = new PlateBigDecimal(plate1.rows(), plate1.columns(), resultUneven);
    		PlateBigDecimal returned = modulus.plates(plate1, inputList, mc);
    		PlateBigDecimal returnedUneven = modulus.plates(plate1, inputListUneven, mc);
    ...
    public void testPlateCollectionIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
           ...
           for(WellBigDecimal well : set1) {
    		...
    		PlateBigDecimal returned = modulus.plates(plate1, inputList, begin, end - begin, mc);
    		PlateBigDecimal returnedUneven = modulus.plates(plate1, inputListUneven, begin, end - begin, mc);
    ...
    public void testPlateStrictArray() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateBigDecimal resultPlate = new PlateBigDecimal(plate1.rows(), plate1.columns(), result);
    		PlateBigDecimal resultPlateUneven = new PlateBigDecimal(plate1.rows(), plate1.columns(), resultUneven);
    		PlateBigDecimal returned = modulus.platesStrict(plate1, array, mc);
    		PlateBigDecimal returnedUneven = modulus.platesStrict(plate1, arrayUneven, mc);
    ...
    public void testPlateStrictArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateBigDecimal resultPlate = new PlateBigDecimal(plate1.rows(), plate1.columns(), result);
    		PlateBigDecimal resultPlateUneven = new PlateBigDecimal(plate1.rows(), plate1.columns(), resultUneven);
    		PlateBigDecimal returned = modulus.platesStrict(plate1, array, begin, end - begin, mc);
    		PlateBigDecimal returnedUneven = modulus.platesStrict(plate1, arrayUneven, begin, end - begin, mc);
    ...
    public void testPlateStrictCollection() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateBigDecimal resultPlate = new PlateBigDecimal(plate1.rows(), plate1.columns(), result);
    		PlateBigDecimal resultPlateUneven = new PlateBigDecimal(plate1.rows(), plate1.columns(), resultUneven);
    		PlateBigDecimal returned = modulus.platesStrict(plate1, inputList, mc);
    		PlateBigDecimal returnedUneven = modulus.platesStrict(plate1, inputListUneven, mc);
    ...
    public void testPlateStrictCollectionIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
           ...
           for(WellBigDecimal well : set1) {
    		...
    		PlateBigDecimal returned = modulus.platesStrict(plate1, inputList, begin, end - begin, mc);
    		PlateBigDecimal returnedUneven = modulus.platesStrict(plate1, inputListUneven, begin, end - begin, mc);
    ...
    public void testSets() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigDecimal[] result = this.set(set1, set2, setUneven, false);
    		WellSetBigDecimal returned = modulus.sets(set1, set2, mc);
    		WellSetBigDecimal returnedUneven = modulus.sets(set1, setUneven, mc);
    ...
    public void testSetsIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigDecimal[] result = this.set(set1, set2, setUneven, begin, end, false);
    		WellSetBigDecimal returned = modulus.sets(set1, set2, begin, end - begin, mc);
    		WellSetBigDecimal returnedUneven = modulus.sets(set1, setUneven, begin, end - begin, mc);
    ...
    public void testSetsStrict() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigDecimal[] result = this.set(set1, set2, setUneven, true);
    		WellSetBigDecimal returned = modulus.setsStrict(set1, set2, mc);
    		WellSetBigDecimal returnedUneven = modulus.setsStrict(set1, setUneven, mc);
    ...
    public void testSetsStrictIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigDecimal[] result = this.set(set1, set2, setUneven, begin, end, true);
    		WellSetBigDecimal returned = modulus.setsStrict(set1, set2, begin, end - begin, mc);
    		WellSetBigDecimal returnedUneven = modulus.setsStrict(set1, setUneven, begin, end - begin, mc);
    ...
    public void testSetConstant() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigDecimal returned = modulus.sets(set, randomBigDecimal, mc);
    ...
    public void testSetArray() {   	
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigDecimal returned = modulus.sets(set1, array, mc);
    		WellSetBigDecimal returnedUneven = modulus.sets(set1, arrayUneven, mc);
    ...
    public void testSetArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigDecimal returned = modulus.sets(set1, array, begin, end - begin, mc);
    		WellSetBigDecimal returnedUneven = modulus.sets(set1, arrayUneven, begin, end - begin, mc);
    ...
    public void testSetCollection() {   
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigDecimal returned = modulus.sets(set1, inputList, mc);
    		WellSetBigDecimal returnedUneven = modulus.sets(set1, inputListUneven, mc);
    ...
    public void testSetCollectionIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigDecimal returned = modulus.sets(set1, inputList, begin, end - begin, mc);
    		WellSetBigDecimal returnedUneven = modulus.sets(set1, inputListUneven, begin, end - begin, mc);
    ...
    public void testSetStrictArray() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigDecimal returned = modulus.setsStrict(set1, array, mc);
    		WellSetBigDecimal returnedUneven = modulus.setsStrict(set1, arrayUneven, mc);
    ...
    public void testSetStrictArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigDecimal returned = modulus.setsStrict(set1, array, begin, end - begin, mc);
    		WellSetBigDecimal returnedUneven = modulus.setsStrict(set1, arrayUneven, begin, end - begin, mc);
    ...
    public void testSetStrictCollection() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigDecimal returned = modulus.setsStrict(set1, inputList, mc);
    		WellSetBigDecimal returnedUneven = modulus.setsStrict(set1, inputListUneven, mc);
    ...
    public void testSetStrictCollectionIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigDecimal returned = modulus.setsStrict(set1, inputList, begin, end - begin, mc);
    		WellSetBigDecimal returnedUneven = modulus.setsStrict(set1, inputListUneven, begin, end - begin, mc);
    ...
    public void testStacks() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigDecimal returned = modulus.stacks(stack1, stack2, mc);
	    	StackBigDecimal returnedUneven = modulus.stacks(stack1, stackUneven, mc);
    ...
    public void testStacksIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigDecimal returned = modulus.stacks(stack1, stack2, begin, end - begin, mc);
	    	StackBigDecimal returnedUneven = modulus.stacks(stack1, stackUneven, begin, end - begin, mc);
    ...
    public void testStacksStrict() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigDecimal returned = modulus.stacksStrict(stack1, stack2, mc);
	    	StackBigDecimal returnedUneven = modulus.stacksStrict(stack1, stackUneven, mc);
    ...
    public void testStacksStrictIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigDecimal returned = modulus.stacksStrict(stack1, stack2, begin, end - begin, mc);
	    	StackBigDecimal returnedUneven = modulus.stacksStrict(stack1, stackUneven, begin, end - begin, mc);
    ...
    public void testStackConstant() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigDecimal returned = modulus.stacks(stack1, randomBigDecimal, mc);
    ...
    public void testStackArray() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigDecimal returned = modulus.stacks(stack1, array, mc);
	    	StackBigDecimal returnedUneven = modulus.stacks(stack1, arrayUneven, mc);
    ...
    public void testStackArrayIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigDecimal returned = modulus.stacks(stack1, array, begin, end - begin, mc);
	    	StackBigDecimal returnedUneven = modulus.stacks(stack1, arrayUneven, begin, end - begin, mc);
    ...
    public void testStackCollection() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigDecimal returned = modulus.stacks(stack1, inputList, mc);
	    	StackBigDecimal returnedUneven = modulus.stacks(stack1, inputListUneven, mc);
    ...
    public void testStackCollectionIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigDecimal returned = modulus.stacks(stack1, inputList, begin, end - begin, mc);
	    	StackBigDecimal returnedUneven = modulus.stacks(stack1, inputListUneven, begin, end - begin, mc);
    ...
    public void testStackStrictArray() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigDecimal returned = modulus.stacksStrict(stack1, array, mc);
	    	StackBigDecimal returnedUneven = modulus.stacksStrict(stack1, arrayUneven, mc);
    ...
    public void testStackStrictArrayIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigDecimal returned = modulus.stacksStrict(stack1, array, begin, end - begin, mc);
	    	StackBigDecimal returnedUneven = modulus.stacksStrict(stack1, arrayUneven, begin, end - begin, mc);
    ...
    public void testStackStrictCollection() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigDecimal returned = modulus.stacksStrict(stack1, inputList, mc);
	    	StackBigDecimal returnedUneven = modulus.stacksStrict(stack1, inputListUneven, mc);
    ...
    public void testStackStrictCollectionIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigDecimal returned = modulus.stacksStrict(stack1, inputList, begin, end - begin, mc);
	    	StackBigDecimal returnedUneven = modulus.stacksStrict(stack1, inputListUneven, begin, end - begin, mc);
