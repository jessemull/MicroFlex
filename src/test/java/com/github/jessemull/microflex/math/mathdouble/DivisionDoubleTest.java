...
import com.github.jessemull.microflex.doubleflex.math.DivisionDouble;
...
/**
 * This class tests the methods in the division double class.
 * 
 * @author Jesse L. Mull
...
public class DivisionDoubleTest {
	...
	private static DivisionDouble division = new DivisionDouble();
	...
	public void testConstructor() {		
		DivisionDouble test = new DivisionDouble();
		assertNotNull(test);
	}
    ...
    public void testWells() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(int j = 0; j < well1.length; j++) {
    			...
    			List<Double> returned = division.wells(well1[j], well2[j]);
    			List<Double> returnedUneven = division.wells(well1[j], wellUneven[j]);
    ...
    public void testWellsIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(int j = 0; j < well1.length; j++) {
    			...
    			List<Double> result = new ArrayList<Double>();
    			List<Double> resultUneven = new ArrayList<Double>();
    			List<Double> returned = division.wells(well1[j], well2[j], begin, end - begin);
    			List<Double> returnedUneven = division.wells(well1[j], wellUneven[j], begin, end - begin);
    ...
    public void testWellsStrict() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(int j = 0; j < well1.length; j++) {
    			...
    			List<Double> result = new ArrayList<Double>();
    			List<Double> resultUneven = new ArrayList<Double>();
    			List<Double> returned = division.wellsStrict(well1[j], well2[j]);
    			List<Double> returnedUneven = division.wellsStrict(well1[j], wellUneven[j]);
    ...
    public void testWellsStrictIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(int j = 0; j < well1.length; j++) {
    			...
    			List<Double> result = new ArrayList<Double>();
    			List<Double> resultUneven = new ArrayList<Double>();
    			List<Double> returned = division.wellsStrict(well1[j], well2[j], begin, end - begin);
    			List<Double> returnedUneven = division.wellsStrict(well1[j], wellUneven[j], begin, end - begin);
    ...
    public void testWellConstant() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(int j = 0; j < well1.length; j++) {
    			...
    			List<Double> list1 = well1[j].data();
    			List<Double> result = new ArrayList<Double>();
    			List<Double> returned = division.wells(well1[j], constantDouble);
    ...
    public void testPlates() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateDouble returnedPlate = division.plates(plate1, plate2);
    		PlateDouble returnedPlateUneven = division.plates(plate1, plateUneven);
    ...
    public void testPlatesIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateDouble returnedPlate = division.plates(plate1, plate2, begin, end - begin);
    		PlateDouble returnedPlateUneven = division.plates(plate1, plateUneven, begin, end - begin);
    		PlateDouble resultPlate = new PlateDouble(plate1.rows(), plate2.columns(), result[0]);
    		PlateDouble resultUnevenPlate = new PlateDouble(plateUneven.rows(), plateUneven.columns(), result[1]);
    ...
    public void testPlatesStrict() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateDouble returnedPlate = division.platesStrict(plate1, plate2);
    		PlateDouble returnedPlateUneven = division.platesStrict(plate1, plateUneven);
    		PlateDouble resultPlate = new PlateDouble(plate1.rows(), plate2.columns(), result[0]);
    		PlateDouble resultUnevenPlate = new PlateDouble(plateUneven.rows(), plateUneven.columns(), result[1]);
    ...
    public void testPlatesStrictIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateDouble returnedPlate = division.platesStrict(plate1, plate2, begin, end - begin);
    		PlateDouble returnedPlateUneven = division.platesStrict(plate1, plateUneven, begin, end - begin);
    		PlateDouble resultPlate = new PlateDouble(plate1.rows(), plate2.columns(), result[0]);
    		PlateDouble resultUnevenPlate = new PlateDouble(plateUneven.rows(), plateUneven.columns(), result[1]);
    ...
    public void testPlateConstant() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateDouble returnedPlate = division.plates(plate1, randomDouble);
    ...
    public void testPlateArray() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateDouble returned = division.plates(plate1, array);
    		PlateDouble returnedUneven = division.plates(plate1, arrayUneven);
    ...
    public void testPlateArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
           ...
           for(WellDouble well : set1) {
    		...
    		PlateDouble resultPlate = new PlateDouble(plate1.rows(), plate1.columns(), result);
    		PlateDouble resultPlateUneven = new PlateDouble(plate1.rows(), plate1.columns(), resultUneven);
    		PlateDouble returned = division.plates(plate1, array, begin, end - begin);
    		PlateDouble returnedUneven = division.plates(plate1, arrayUneven, begin, end - begin);
    ...
    public void testPlateCollection() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateDouble resultPlate = new PlateDouble(plate1.rows(), plate1.columns(), result);
    		PlateDouble resultPlateUneven = new PlateDouble(plate1.rows(), plate1.columns(), resultUneven);
    		PlateDouble returned = division.plates(plate1, inputList);
    		PlateDouble returnedUneven = division.plates(plate1, inputListUneven);
    ...
    public void testPlateCollectionIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
           ...
           for(WellDouble well : set1) {
    		...
    		PlateDouble returned = division.plates(plate1, inputList, begin, end - begin);
    		PlateDouble returnedUneven = division.plates(plate1, inputListUneven, begin, end - begin);
    ...
    public void testPlateStrictArray() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateDouble resultPlate = new PlateDouble(plate1.rows(), plate1.columns(), result);
    		PlateDouble resultPlateUneven = new PlateDouble(plate1.rows(), plate1.columns(), resultUneven);
    		PlateDouble returned = division.platesStrict(plate1, array);
    		PlateDouble returnedUneven = division.platesStrict(plate1, arrayUneven);
    ...
    public void testPlateStrictArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateDouble resultPlate = new PlateDouble(plate1.rows(), plate1.columns(), result);
    		PlateDouble resultPlateUneven = new PlateDouble(plate1.rows(), plate1.columns(), resultUneven);
    		PlateDouble returned = division.platesStrict(plate1, array, begin, end - begin);
    		PlateDouble returnedUneven = division.platesStrict(plate1, arrayUneven, begin, end - begin);
    ...
    public void testPlateStrictCollection() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateDouble resultPlate = new PlateDouble(plate1.rows(), plate1.columns(), result);
    		PlateDouble resultPlateUneven = new PlateDouble(plate1.rows(), plate1.columns(), resultUneven);
    		PlateDouble returned = division.platesStrict(plate1, inputList);
    		PlateDouble returnedUneven = division.platesStrict(plate1, inputListUneven);
    ...
    public void testPlateStrictCollectionIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
           ...
           for(WellDouble well : set1) {
    		...
    		PlateDouble returned = division.platesStrict(plate1, inputList, begin, end - begin);
    		PlateDouble returnedUneven = division.platesStrict(plate1, inputListUneven, begin, end - begin);
    ...
    public void testSets() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetDouble[] result = this.set(set1, set2, setUneven, false);
    		WellSetDouble returned = division.sets(set1, set2);
    		WellSetDouble returnedUneven = division.sets(set1, setUneven);
    ...
    public void testSetsIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetDouble[] result = this.set(set1, set2, setUneven, begin, end, false);
    		WellSetDouble returned = division.sets(set1, set2, begin, end - begin);
    		WellSetDouble returnedUneven = division.sets(set1, setUneven, begin, end - begin);
    ...
    public void testSetsStrict() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetDouble[] result = this.set(set1, set2, setUneven, true);
    		WellSetDouble returned = division.setsStrict(set1, set2);
    		WellSetDouble returnedUneven = division.setsStrict(set1, setUneven);
    ...
    public void testSetsStrictIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetDouble[] result = this.set(set1, set2, setUneven, begin, end, true);
    		WellSetDouble returned = division.setsStrict(set1, set2, begin, end - begin);
    		WellSetDouble returnedUneven = division.setsStrict(set1, setUneven, begin, end - begin);
    ...
    public void testSetConstant() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetDouble returned = division.sets(set, randomDouble);
    ...
    public void testSetArray() {   	
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetDouble returned = division.sets(set1, array);
    		WellSetDouble returnedUneven = division.sets(set1, arrayUneven);
    ...
    public void testSetArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetDouble returned = division.sets(set1, array, begin, end - begin);
    		WellSetDouble returnedUneven = division.sets(set1, arrayUneven, begin, end - begin);
    ...
    public void testSetCollection() {   
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetDouble returned = division.sets(set1, inputList);
    		WellSetDouble returnedUneven = division.sets(set1, inputListUneven);
    ...
    public void testSetCollectionIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetDouble returned = division.sets(set1, inputList, begin, end - begin);
    		WellSetDouble returnedUneven = division.sets(set1, inputListUneven, begin, end - begin);
    ...
    public void testSetStrictArray() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetDouble returned = division.setsStrict(set1, array);
    		WellSetDouble returnedUneven = division.setsStrict(set1, arrayUneven);
    ...
    public void testSetStrictArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetDouble returned = division.setsStrict(set1, array, begin, end - begin);
    		WellSetDouble returnedUneven = division.setsStrict(set1, arrayUneven, begin, end - begin);
    ...
    public void testSetStrictCollection() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetDouble returned = division.setsStrict(set1, inputList);
    		WellSetDouble returnedUneven = division.setsStrict(set1, inputListUneven);
    ...
    public void testSetStrictCollectionIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetDouble returned = division.setsStrict(set1, inputList, begin, end - begin);
    		WellSetDouble returnedUneven = division.setsStrict(set1, inputListUneven, begin, end - begin);
    ...
    public void testStacks() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackDouble returned = division.stacks(stack1, stack2);
	    	StackDouble returnedUneven = division.stacks(stack1, stackUneven);
    ...
    public void testStacksIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackDouble returned = division.stacks(stack1, stack2, begin, end - begin);
	    	StackDouble returnedUneven = division.stacks(stack1, stackUneven, begin, end - begin);
    ...
    public void testStacksStrict() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackDouble returned = division.stacksStrict(stack1, stack2);
	    	StackDouble returnedUneven = division.stacksStrict(stack1, stackUneven);
    ...
    public void testStacksStrictIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackDouble returned = division.stacksStrict(stack1, stack2, begin, end - begin);
	    	StackDouble returnedUneven = division.stacksStrict(stack1, stackUneven, begin, end - begin);
    ...
    public void testStackConstant() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackDouble returned = division.stacks(stack1, randomDouble);
    ...
    public void testStackArray() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackDouble returned = division.stacks(stack1, array);
	    	StackDouble returnedUneven = division.stacks(stack1, arrayUneven);
    ...
    public void testStackArrayIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackDouble returned = division.stacks(stack1, array, begin, end - begin);
	    	StackDouble returnedUneven = division.stacks(stack1, arrayUneven, begin, end - begin);
    ...
    public void testStackCollection() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackDouble returned = division.stacks(stack1, inputList);
	    	StackDouble returnedUneven = division.stacks(stack1, inputListUneven);
    ...
    public void testStackCollectionIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackDouble returned = division.stacks(stack1, inputList, begin, end - begin);
	    	StackDouble returnedUneven = division.stacks(stack1, inputListUneven, begin, end - begin);
    ...
    public void testStackStrictArray() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackDouble returned = division.stacksStrict(stack1, array);
	    	StackDouble returnedUneven = division.stacksStrict(stack1, arrayUneven);
    ...
    public void testStackStrictArrayIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackDouble returned = division.stacksStrict(stack1, array, begin, end - begin);
	    	StackDouble returnedUneven = division.stacksStrict(stack1, arrayUneven, begin, end - begin);
    ...
    public void testStackStrictCollection() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackDouble returned = division.stacksStrict(stack1, inputList);
	    	StackDouble returnedUneven = division.stacksStrict(stack1, inputListUneven);
    ...
    public void testStackStrictCollectionIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackDouble returned = division.stacksStrict(stack1, inputList, begin, end - begin);
	    	StackDouble returnedUneven = division.stacksStrict(stack1, inputListUneven, begin, end - begin);
