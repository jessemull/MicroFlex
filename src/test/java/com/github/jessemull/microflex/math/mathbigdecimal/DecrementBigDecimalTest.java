...
import com.github.jessemull.microflex.bigdecimalflex.math.DecrementBigDecimal;
...
public class DecrementBigDecimalTest {
	...
	private static DecrementBigDecimal decrement = new DecrementBigDecimal();
	...
	public void testConstructor() {
		DecrementBigDecimal test = new DecrementBigDecimal();
		assertNotNull(test);
	}
    ...
    public void testPlates() {
        ...
        for(PlateBigDecimal[] plates : arrays) {
			...
			for(PlateBigDecimal plate : plates) {
				...
				PlateBigDecimal returnedPlate = decrement.plates(plate);
    ...
    public void testPlatesIndices() {
    	...
    	for(PlateBigDecimal[] plates : arrays) {
			...
			for(PlateBigDecimal plate : plates) {
				...
				PlateBigDecimal resultPlate = new PlateBigDecimal(plate.rows(), plate.columns(), result);
				PlateBigDecimal returnedPlate = decrement.plates(plate, begin, end - begin);
    ...
    public void testSets() {
        ...
        for(PlateBigDecimal[] plates : arrays) {
			...
			for(PlateBigDecimal plate : plates) {
				...
				WellSetBigDecimal result = new WellSetBigDecimal();
				WellSetBigDecimal returned = decrement.sets(plate.dataSet());
    ...
    public void testSetsIndices() {
        ...
        for(PlateBigDecimal[] plates : arrays) {
			...
			for(PlateBigDecimal plate : plates) {
				...
				WellSetBigDecimal result = new WellSetBigDecimal();
				WellSetBigDecimal returned = decrement.sets(plate.dataSet(), begin, end - begin);
    ...
    public void testStacks() {
        ...
        for(StackBigDecimal stack : stacks) {
			...
			StackBigDecimal returnedStack = decrement.stacks(stack);
    ...
    public void testStacksIndices() {
    	...
    	for(StackBigDecimal stack : stacks) {
			...
			StackBigDecimal returnedStack = decrement.stacks(stack, begin, end - begin);
