...
import com.github.jessemull.microflex.bigdecimalflex.math.DivisionBigDecimal;
...
public class DivisionBigDecimalTest {
...
/* ---------------------------- Local fields ---------------------------- */
	...
	private static DivisionBigDecimal division = new DivisionBigDecimal();
	...
	public void testConstructor() {		
		DivisionBigDecimal test = new DivisionBigDecimal();
		assertNotNull(test);
	}
    ...
    public void testPlates() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateBigDecimal returnedPlate = division.plates(plate1, plate2, mc);
    		PlateBigDecimal returnedPlateUneven = division.plates(plate1, plateUneven, mc);
    ...
    public void testPlatesIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateBigDecimal returnedPlate = division.plates(plate1, plate2, begin, end - begin, mc);
    		PlateBigDecimal returnedPlateUneven = division.plates(plate1, plateUneven, begin, end - begin, mc);
    		PlateBigDecimal resultPlate = new PlateBigDecimal(plate1.rows(), plate2.columns(), result[0]);
    		PlateBigDecimal resultUnevenPlate = new PlateBigDecimal(plateUneven.rows(), plateUneven.columns(), result[1]);
    ...
    public void testPlatesStrict() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateBigDecimal returnedPlate = division.platesStrict(plate1, plate2, mc);
    		PlateBigDecimal returnedPlateUneven = division.platesStrict(plate1, plateUneven, mc);
    		PlateBigDecimal resultPlate = new PlateBigDecimal(plate1.rows(), plate2.columns(), result[0]);
    		PlateBigDecimal resultUnevenPlate = new PlateBigDecimal(plateUneven.rows(), plateUneven.columns(), result[1]);
    ...
    public void testPlatesStrictIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateBigDecimal returnedPlate = division.platesStrict(plate1, plate2, begin, end - begin, mc);
    		PlateBigDecimal returnedPlateUneven = division.platesStrict(plate1, plateUneven, begin, end - begin, mc);
    		PlateBigDecimal resultPlate = new PlateBigDecimal(plate1.rows(), plate2.columns(), result[0]);
    		PlateBigDecimal resultUnevenPlate = new PlateBigDecimal(plateUneven.rows(), plateUneven.columns(), result[1]);
    ...
    public void testPlateConstant() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateBigDecimal returnedPlate = division.plates(plate1, randomBigDecimal, mc);
    ...
    public void testPlateArray() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateBigDecimal returned = division.plates(plate1, array, mc);
    		PlateBigDecimal returnedUneven = division.plates(plate1, arrayUneven, mc);
    ...
    public void testPlateArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
           ...
           for(WellBigDecimal well : set1) {
    		...
    		PlateBigDecimal resultPlate = new PlateBigDecimal(plate1.rows(), plate1.columns(), result);
    		PlateBigDecimal resultPlateUneven = new PlateBigDecimal(plate1.rows(), plate1.columns(), resultUneven);
    		PlateBigDecimal returned = division.plates(plate1, array, begin, end - begin, mc);
    		PlateBigDecimal returnedUneven = division.plates(plate1, arrayUneven, begin, end - begin, mc);
    ...
    public void testPlateCollection() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateBigDecimal resultPlate = new PlateBigDecimal(plate1.rows(), plate1.columns(), result);
    		PlateBigDecimal resultPlateUneven = new PlateBigDecimal(plate1.rows(), plate1.columns(), resultUneven);
    		PlateBigDecimal returned = division.plates(plate1, inputList, mc);
    		PlateBigDecimal returnedUneven = division.plates(plate1, inputListUneven, mc);
    ...
    public void testPlateCollectionIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
           ...
           for(WellBigDecimal well : set1) {
    		...
    		PlateBigDecimal returned = division.plates(plate1, inputList, begin, end - begin, mc);
    		PlateBigDecimal returnedUneven = division.plates(plate1, inputListUneven, begin, end - begin, mc);
    ...
    public void testPlateStrictArray() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateBigDecimal resultPlate = new PlateBigDecimal(plate1.rows(), plate1.columns(), result);
    		PlateBigDecimal resultPlateUneven = new PlateBigDecimal(plate1.rows(), plate1.columns(), resultUneven);
    		PlateBigDecimal returned = division.platesStrict(plate1, array, mc);
    		PlateBigDecimal returnedUneven = division.platesStrict(plate1, arrayUneven, mc);
    ...
    public void testPlateStrictArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateBigDecimal resultPlate = new PlateBigDecimal(plate1.rows(), plate1.columns(), result);
    		PlateBigDecimal resultPlateUneven = new PlateBigDecimal(plate1.rows(), plate1.columns(), resultUneven);
    		PlateBigDecimal returned = division.platesStrict(plate1, array, begin, end - begin, mc);
    		PlateBigDecimal returnedUneven = division.platesStrict(plate1, arrayUneven, begin, end - begin, mc);
    ...
    public void testPlateStrictCollection() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateBigDecimal resultPlate = new PlateBigDecimal(plate1.rows(), plate1.columns(), result);
    		PlateBigDecimal resultPlateUneven = new PlateBigDecimal(plate1.rows(), plate1.columns(), resultUneven);
    		PlateBigDecimal returned = division.platesStrict(plate1, inputList, mc);
    		PlateBigDecimal returnedUneven = division.platesStrict(plate1, inputListUneven, mc);
    ...
    public void testPlateStrictCollectionIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
           ...
           for(WellBigDecimal well : set1) {
    		...
    		PlateBigDecimal returned = division.platesStrict(plate1, inputList, begin, end - begin, mc);
    		PlateBigDecimal returnedUneven = division.platesStrict(plate1, inputListUneven, begin, end - begin, mc);
    ...
    public void testSets() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigDecimal[] result = this.set(set1, set2, setUneven, false);
    		WellSetBigDecimal returned = division.sets(set1, set2, mc);
    		WellSetBigDecimal returnedUneven = division.sets(set1, setUneven, mc);
    ...
    public void testSetsIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigDecimal[] result = this.set(set1, set2, setUneven, begin, end, false);
    		WellSetBigDecimal returned = division.sets(set1, set2, begin, end - begin, mc);
    		WellSetBigDecimal returnedUneven = division.sets(set1, setUneven, begin, end - begin, mc);
    ...
    public void testSetsStrict() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigDecimal[] result = this.set(set1, set2, setUneven, true);
    		WellSetBigDecimal returned = division.setsStrict(set1, set2, mc);
    		WellSetBigDecimal returnedUneven = division.setsStrict(set1, setUneven, mc);
    ...
    public void testSetsStrictIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigDecimal[] result = this.set(set1, set2, setUneven, begin, end, true);
    		WellSetBigDecimal returned = division.setsStrict(set1, set2, begin, end - begin, mc);
    		WellSetBigDecimal returnedUneven = division.setsStrict(set1, setUneven, begin, end - begin, mc);
    ...
    public void testSetConstant() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigDecimal returned = division.sets(set, randomBigDecimal, mc);
    ...
    public void testSetArray() {   	
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigDecimal returned = division.sets(set1, array, mc);
    		WellSetBigDecimal returnedUneven = division.sets(set1, arrayUneven, mc);
    ...
    public void testSetArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigDecimal returned = division.sets(set1, array, begin, end - begin, mc);
    		WellSetBigDecimal returnedUneven = division.sets(set1, arrayUneven, begin, end - begin, mc);
    ...
    public void testSetCollection() {   
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigDecimal returned = division.sets(set1, inputList, mc);
    		WellSetBigDecimal returnedUneven = division.sets(set1, inputListUneven, mc);
    ...
    public void testSetCollectionIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigDecimal returned = division.sets(set1, inputList, begin, end - begin, mc);
    		WellSetBigDecimal returnedUneven = division.sets(set1, inputListUneven, begin, end - begin, mc);
    ...
    public void testSetStrictArray() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigDecimal returned = division.setsStrict(set1, array, mc);
    		WellSetBigDecimal returnedUneven = division.setsStrict(set1, arrayUneven, mc);
    ...
    public void testSetStrictArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigDecimal returned = division.setsStrict(set1, array, begin, end - begin, mc);
    		WellSetBigDecimal returnedUneven = division.setsStrict(set1, arrayUneven, begin, end - begin, mc);
    ...
    public void testSetStrictCollection() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigDecimal returned = division.setsStrict(set1, inputList, mc);
    		WellSetBigDecimal returnedUneven = division.setsStrict(set1, inputListUneven, mc);
    ...
    public void testSetStrictCollectionIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigDecimal returned = division.setsStrict(set1, inputList, begin, end - begin, mc);
    		WellSetBigDecimal returnedUneven = division.setsStrict(set1, inputListUneven, begin, end - begin, mc);
    ...
    public void testStacks() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigDecimal returned = division.stacks(stack1, stack2, mc);
	    	StackBigDecimal returnedUneven = division.stacks(stack1, stackUneven, mc);
    ...
    public void testStacksIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigDecimal returned = division.stacks(stack1, stack2, begin, end - begin, mc);
	    	StackBigDecimal returnedUneven = division.stacks(stack1, stackUneven, begin, end - begin, mc);
    ...
    public void testStacksStrict() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigDecimal returned = division.stacksStrict(stack1, stack2, mc);
	    	StackBigDecimal returnedUneven = division.stacksStrict(stack1, stackUneven, mc);
    ...
    public void testStacksStrictIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigDecimal returned = division.stacksStrict(stack1, stack2, begin, end - begin, mc);
	    	StackBigDecimal returnedUneven = division.stacksStrict(stack1, stackUneven, begin, end - begin, mc);
    ...
    public void testStackConstant() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigDecimal returned = division.stacks(stack1, randomBigDecimal, mc);
    ...
    public void testStackArray() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigDecimal returned = division.stacks(stack1, array, mc);
	    	StackBigDecimal returnedUneven = division.stacks(stack1, arrayUneven, mc);
    ...
    public void testStackArrayIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigDecimal returned = division.stacks(stack1, array, begin, end - begin, mc);
	    	StackBigDecimal returnedUneven = division.stacks(stack1, arrayUneven, begin, end - begin, mc);
    ...
    public void testStackCollection() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigDecimal returned = division.stacks(stack1, inputList, mc);
	    	StackBigDecimal returnedUneven = division.stacks(stack1, inputListUneven, mc);
    ...
    public void testStackCollectionIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigDecimal returned = division.stacks(stack1, inputList, begin, end - begin, mc);
	    	StackBigDecimal returnedUneven = division.stacks(stack1, inputListUneven, begin, end - begin, mc);
    ...
    public void testStackStrictArray() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigDecimal returned = division.stacksStrict(stack1, array, mc);
	    	StackBigDecimal returnedUneven = division.stacksStrict(stack1, arrayUneven, mc);
    ...
    public void testStackStrictArrayIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigDecimal returned = division.stacksStrict(stack1, array, begin, end - begin, mc);
	    	StackBigDecimal returnedUneven = division.stacksStrict(stack1, arrayUneven, begin, end - begin, mc);
    ...
    public void testStackStrictCollection() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigDecimal returned = division.stacksStrict(stack1, inputList, mc);
	    	StackBigDecimal returnedUneven = division.stacksStrict(stack1, inputListUneven, mc);
    ...
    public void testStackStrictCollectionIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigDecimal returned = division.stacksStrict(stack1, inputList, begin, end - begin, mc);
	    	StackBigDecimal returnedUneven = division.stacksStrict(stack1, inputListUneven, begin, end - begin, mc);
