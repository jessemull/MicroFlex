...
import com.github.jessemull.microflex.integerflex.math.IncrementInteger;
...
/**
 * This class tests the methods in the increment integer class.
 * 
 * @author Jesse L. Mull
...
public class IncrementIntegerTest {
	...
	private static IncrementInteger increment = new IncrementInteger();
		...
		for(PlateInteger[] plates : arrays) {
			...
			for(PlateInteger plate : plates) {
				...
				for(WellInteger well : plate) {
					...
					List<Integer> returned = increment.wells(well);
        ...
        for(PlateInteger[] plates : arrays) {
			...
			for(PlateInteger plate : plates) {
				...
				for(WellInteger well : plate) {
	    			...
	    			List<Integer> result = new ArrayList<Integer>();
					List<Integer> returned = increment.wells(well, begin, end - begin);				
    ...
    public void testPlates() {
        ...
        for(PlateInteger[] plates : arrays) {
			...
			for(PlateInteger plate : plates) {
				...
				PlateInteger returnedPlate = increment.plates(plate);
    ...
    public void testPlatesIndices() {
    	...
    	for(PlateInteger[] plates : arrays) {
			...
			for(PlateInteger plate : plates) {
				...
				PlateInteger resultPlate = new PlateInteger(plate.rows(), plate.columns(), result);
				PlateInteger returnedPlate = increment.plates(plate, begin, end - begin);
    ...
    public void testSets() {
        ...
        for(PlateInteger[] plates : arrays) {
			...
			for(PlateInteger plate : plates) {
				...
				WellSetInteger result = new WellSetInteger();
				WellSetInteger returned = increment.sets(plate.dataSet());
    ...
    public void testSetsIndices() {
        ...
        for(PlateInteger[] plates : arrays) {
			...
			for(PlateInteger plate : plates) {
				...
				WellSetInteger result = new WellSetInteger();
				WellSetInteger returned = increment.sets(plate.dataSet(), begin, end - begin);
    ...
    public void testStacks() {
        ...
        for(StackInteger stack : stacks) {
			...
			StackInteger returnedStack = increment.stacks(stack);
    ...
    public void testStacksIndices() {
    	...
    	for(StackInteger stack : stacks) {
			...
			StackInteger returnedStack = increment.stacks(stack, begin, end - begin);
