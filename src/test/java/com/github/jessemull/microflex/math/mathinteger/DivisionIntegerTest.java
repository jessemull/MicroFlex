...
import com.github.jessemull.microflex.integerflex.math.DivisionInteger;
...
/**
 * This class tests the methods in the division integer class.
 * 
 * @author Jesse L. Mull
...
public class DivisionIntegerTest {
	...
	private static DivisionInteger division = new DivisionInteger();
	...
	public void testConstructor() {		
		DivisionInteger test = new DivisionInteger();
		assertNotNull(test);
	}
    ...
    public void testWells() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(int j = 0; j < well1.length; j++) {
    			...
    			List<Integer> returned = division.wells(well1[j], well2[j]);
    			List<Integer> returnedUneven = division.wells(well1[j], wellUneven[j]);
    ...
    public void testWellsIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(int j = 0; j < well1.length; j++) {
    			...
    			List<Integer> result = new ArrayList<Integer>();
    			List<Integer> resultUneven = new ArrayList<Integer>();
    			List<Integer> returned = division.wells(well1[j], well2[j], begin, end - begin);
    			List<Integer> returnedUneven = division.wells(well1[j], wellUneven[j], begin, end - begin);
    ...
    public void testWellsStrict() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(int j = 0; j < well1.length; j++) {
    			...
    			List<Integer> result = new ArrayList<Integer>();
    			List<Integer> resultUneven = new ArrayList<Integer>();
    			List<Integer> returned = division.wellsStrict(well1[j], well2[j]);
    			List<Integer> returnedUneven = division.wellsStrict(well1[j], wellUneven[j]);
    ...
    public void testWellsStrictIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(int j = 0; j < well1.length; j++) {
    			...
    			List<Integer> result = new ArrayList<Integer>();
    			List<Integer> resultUneven = new ArrayList<Integer>();
    			List<Integer> returned = division.wellsStrict(well1[j], well2[j], begin, end - begin);
    			List<Integer> returnedUneven = division.wellsStrict(well1[j], wellUneven[j], begin, end - begin);
    ...
    public void testWellConstant() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(int j = 0; j < well1.length; j++) {
    			...
    			List<Integer> list1 = well1[j].data();
    			List<Integer> result = new ArrayList<Integer>();
    			List<Integer> returned = division.wells(well1[j], constantInt);
    ...
    public void testPlates() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateInteger returnedPlate = division.plates(plate1, plate2);
    		PlateInteger returnedPlateUneven = division.plates(plate1, plateUneven);
    ...
    public void testPlatesIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateInteger returnedPlate = division.plates(plate1, plate2, begin, end - begin);
    		PlateInteger returnedPlateUneven = division.plates(plate1, plateUneven, begin, end - begin);
    		PlateInteger resultPlate = new PlateInteger(plate1.rows(), plate2.columns(), result[0]);
    		PlateInteger resultUnevenPlate = new PlateInteger(plateUneven.rows(), plateUneven.columns(), result[1]);
    ...
    public void testPlatesStrict() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateInteger returnedPlate = division.platesStrict(plate1, plate2);
    		PlateInteger returnedPlateUneven = division.platesStrict(plate1, plateUneven);
    		PlateInteger resultPlate = new PlateInteger(plate1.rows(), plate2.columns(), result[0]);
    		PlateInteger resultUnevenPlate = new PlateInteger(plateUneven.rows(), plateUneven.columns(), result[1]);
    ...
    public void testPlatesStrictIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateInteger returnedPlate = division.platesStrict(plate1, plate2, begin, end - begin);
    		PlateInteger returnedPlateUneven = division.platesStrict(plate1, plateUneven, begin, end - begin);
    		PlateInteger resultPlate = new PlateInteger(plate1.rows(), plate2.columns(), result[0]);
    		PlateInteger resultUnevenPlate = new PlateInteger(plateUneven.rows(), plateUneven.columns(), result[1]);
    ...
    public void testPlateConstant() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateInteger returnedPlate = division.plates(plate1, randomInt);
    ...
    public void testPlateArray() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateInteger returned = division.plates(plate1, array);
    		PlateInteger returnedUneven = division.plates(plate1, arrayUneven);
    ...
    public void testPlateArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
           ...
           for(WellInteger well : set1) {
    		...
    		PlateInteger resultPlate = new PlateInteger(plate1.rows(), plate1.columns(), result);
    		PlateInteger resultPlateUneven = new PlateInteger(plate1.rows(), plate1.columns(), resultUneven);
    		PlateInteger returned = division.plates(plate1, array, begin, end - begin);
    		PlateInteger returnedUneven = division.plates(plate1, arrayUneven, begin, end - begin);
    ...
    public void testPlateCollection() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateInteger resultPlate = new PlateInteger(plate1.rows(), plate1.columns(), result);
    		PlateInteger resultPlateUneven = new PlateInteger(plate1.rows(), plate1.columns(), resultUneven);
    		PlateInteger returned = division.plates(plate1, inputList);
    		PlateInteger returnedUneven = division.plates(plate1, inputListUneven);
    ...
    public void testPlateCollectionIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
           ...
           for(WellInteger well : set1) {
    		...
    		PlateInteger returned = division.plates(plate1, inputList, begin, end - begin);
    		PlateInteger returnedUneven = division.plates(plate1, inputListUneven, begin, end - begin);
    ...
    public void testPlateStrictArray() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateInteger resultPlate = new PlateInteger(plate1.rows(), plate1.columns(), result);
    		PlateInteger resultPlateUneven = new PlateInteger(plate1.rows(), plate1.columns(), resultUneven);
    		PlateInteger returned = division.platesStrict(plate1, array);
    		PlateInteger returnedUneven = division.platesStrict(plate1, arrayUneven);
    ...
    public void testPlateStrictArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateInteger resultPlate = new PlateInteger(plate1.rows(), plate1.columns(), result);
    		PlateInteger resultPlateUneven = new PlateInteger(plate1.rows(), plate1.columns(), resultUneven);
    		PlateInteger returned = division.platesStrict(plate1, array, begin, end - begin);
    		PlateInteger returnedUneven = division.platesStrict(plate1, arrayUneven, begin, end - begin);
    ...
    public void testPlateStrictCollection() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateInteger resultPlate = new PlateInteger(plate1.rows(), plate1.columns(), result);
    		PlateInteger resultPlateUneven = new PlateInteger(plate1.rows(), plate1.columns(), resultUneven);
    		PlateInteger returned = division.platesStrict(plate1, inputList);
    		PlateInteger returnedUneven = division.platesStrict(plate1, inputListUneven);
    ...
    public void testPlateStrictCollectionIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
           ...
           for(WellInteger well : set1) {
    		...
    		PlateInteger returned = division.platesStrict(plate1, inputList, begin, end - begin);
    		PlateInteger returnedUneven = division.platesStrict(plate1, inputListUneven, begin, end - begin);
    ...
    public void testSets() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetInteger[] result = this.set(set1, set2, setUneven, false);
    		WellSetInteger returned = division.sets(set1, set2);
    		WellSetInteger returnedUneven = division.sets(set1, setUneven);
    ...
    public void testSetsIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetInteger[] result = this.set(set1, set2, setUneven, begin, end, false);
    		WellSetInteger returned = division.sets(set1, set2, begin, end - begin);
    		WellSetInteger returnedUneven = division.sets(set1, setUneven, begin, end - begin);
    ...
    public void testSetsStrict() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetInteger[] result = this.set(set1, set2, setUneven, true);
    		WellSetInteger returned = division.setsStrict(set1, set2);
    		WellSetInteger returnedUneven = division.setsStrict(set1, setUneven);
    ...
    public void testSetsStrictIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetInteger[] result = this.set(set1, set2, setUneven, begin, end, true);
    		WellSetInteger returned = division.setsStrict(set1, set2, begin, end - begin);
    		WellSetInteger returnedUneven = division.setsStrict(set1, setUneven, begin, end - begin);
    ...
    public void testSetConstant() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetInteger returned = division.sets(set, randomInt);
    ...
    public void testSetArray() {   	
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetInteger returned = division.sets(set1, array);
    		WellSetInteger returnedUneven = division.sets(set1, arrayUneven);
    ...
    public void testSetArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetInteger returned = division.sets(set1, array, begin, end - begin);
    		WellSetInteger returnedUneven = division.sets(set1, arrayUneven, begin, end - begin);
    ...
    public void testSetCollection() {   
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetInteger returned = division.sets(set1, inputList);
    		WellSetInteger returnedUneven = division.sets(set1, inputListUneven);
    ...
    public void testSetCollectionIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetInteger returned = division.sets(set1, inputList, begin, end - begin);
    		WellSetInteger returnedUneven = division.sets(set1, inputListUneven, begin, end - begin);
    ...
    public void testSetStrictArray() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetInteger returned = division.setsStrict(set1, array);
    		WellSetInteger returnedUneven = division.setsStrict(set1, arrayUneven);
    ...
    public void testSetStrictArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetInteger returned = division.setsStrict(set1, array, begin, end - begin);
    		WellSetInteger returnedUneven = division.setsStrict(set1, arrayUneven, begin, end - begin);
    ...
    public void testSetStrictCollection() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetInteger returned = division.setsStrict(set1, inputList);
    		WellSetInteger returnedUneven = division.setsStrict(set1, inputListUneven);
    ...
    public void testSetStrictCollectionIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetInteger returned = division.setsStrict(set1, inputList, begin, end - begin);
    		WellSetInteger returnedUneven = division.setsStrict(set1, inputListUneven, begin, end - begin);
    ...
    public void testStacks() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackInteger returned = division.stacks(stack1, stack2);
	    	StackInteger returnedUneven = division.stacks(stack1, stackUneven);
    ...
    public void testStacksIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackInteger returned = division.stacks(stack1, stack2, begin, end - begin);
	    	StackInteger returnedUneven = division.stacks(stack1, stackUneven, begin, end - begin);
    ...
    public void testStacksStrict() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackInteger returned = division.stacksStrict(stack1, stack2);
	    	StackInteger returnedUneven = division.stacksStrict(stack1, stackUneven);
    ...
    public void testStacksStrictIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackInteger returned = division.stacksStrict(stack1, stack2, begin, end - begin);
	    	StackInteger returnedUneven = division.stacksStrict(stack1, stackUneven, begin, end - begin);
    ...
    public void testStackConstant() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackInteger returned = division.stacks(stack1, randomInt);
    ...
    public void testStackArray() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackInteger returned = division.stacks(stack1, array);
	    	StackInteger returnedUneven = division.stacks(stack1, arrayUneven);
    ...
    public void testStackArrayIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackInteger returned = division.stacks(stack1, array, begin, end - begin);
	    	StackInteger returnedUneven = division.stacks(stack1, arrayUneven, begin, end - begin);
    ...
    public void testStackCollection() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackInteger returned = division.stacks(stack1, inputList);
	    	StackInteger returnedUneven = division.stacks(stack1, inputListUneven);
    ...
    public void testStackCollectionIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackInteger returned = division.stacks(stack1, inputList, begin, end - begin);
	    	StackInteger returnedUneven = division.stacks(stack1, inputListUneven, begin, end - begin);
    ...
    public void testStackStrictArray() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackInteger returned = division.stacksStrict(stack1, array);
	    	StackInteger returnedUneven = division.stacksStrict(stack1, arrayUneven);
    ...
    public void testStackStrictArrayIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackInteger returned = division.stacksStrict(stack1, array, begin, end - begin);
	    	StackInteger returnedUneven = division.stacksStrict(stack1, arrayUneven, begin, end - begin);
    ...
    public void testStackStrictCollection() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackInteger returned = division.stacksStrict(stack1, inputList);
	    	StackInteger returnedUneven = division.stacksStrict(stack1, inputListUneven);
    ...
    public void testStackStrictCollectionIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackInteger returned = division.stacksStrict(stack1, inputList, begin, end - begin);
	    	StackInteger returnedUneven = division.stacksStrict(stack1, inputListUneven, begin, end - begin);
