...
import com.github.jessemull.microflex.doubleflex.math.AdditionDouble;
...
/**
 * This class tests the methods in the addition double class.
 * 
 * @author Jesse L. Mull
...
/* ---------------------------- Local fields ---------------------------- */
	...
	private static AdditionDouble addition = new AdditionDouble();
	...
	public void testConstructor() {		
		AdditionDouble test = new AdditionDouble();
		assertNotNull(test);
	}
    ...
    public void testWells() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(int j = 0; j < well1.length; j++) {
    			...
    			List<Double> returned = addition.wells(well1[j], well2[j]);
    			List<Double> returnedUneven = addition.wells(well1[j], wellUneven[j]);
    ...
    public void testWellsIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(int j = 0; j < well1.length; j++) {
    			...
    			List<Double> result = new ArrayList<Double>();
    			List<Double> resultUneven = new ArrayList<Double>();
    			List<Double> returned = addition.wells(well1[j], well2[j], begin, end - begin);
    			List<Double> returnedUneven = addition.wells(well1[j], wellUneven[j], begin, end - begin);
    ...
    public void testWellsStrict() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(int j = 0; j < well1.length; j++) {
    			...
    			List<Double> result = new ArrayList<Double>();
    			List<Double> resultUneven = new ArrayList<Double>();
    			List<Double> returned = addition.wellsStrict(well1[j], well2[j]);
    			List<Double> returnedUneven = addition.wellsStrict(well1[j], wellUneven[j]);
    ...
    public void testWellsStrictIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(int j = 0; j < well1.length; j++) {
    			...
    			List<Double> result = new ArrayList<Double>();
    			List<Double> resultUneven = new ArrayList<Double>();
    			List<Double> returned = addition.wellsStrict(well1[j], well2[j], begin, end - begin);
    			List<Double> returnedUneven = addition.wellsStrict(well1[j], wellUneven[j], begin, end - begin);
    ...
    public void testWellConstant() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(int j = 0; j < well1.length; j++) {
    			...
    			List<Double> list1 = well1[j].data();
    			List<Double> result = new ArrayList<Double>();
    			List<Double> returned = addition.wells(well1[j], constantDouble);
    ...
    public void testPlates() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateDouble returnedPlate = addition.plates(plate1, plate2);
    		PlateDouble returnedPlateUneven = addition.plates(plate1, plateUneven);
    ...
    public void testPlatesIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateDouble returnedPlate = addition.plates(plate1, plate2, begin, end - begin);
    		PlateDouble returnedPlateUneven = addition.plates(plate1, plateUneven, begin, end - begin);
    		PlateDouble resultPlate = new PlateDouble(plate1.rows(), plate2.columns(), result[0]);
    		PlateDouble resultUnevenPlate = new PlateDouble(plateUneven.rows(), plateUneven.columns(), result[1]);
    ...
    public void testPlatesStrict() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateDouble returnedPlate = addition.platesStrict(plate1, plate2);
    		PlateDouble returnedPlateUneven = addition.platesStrict(plate1, plateUneven);
    		PlateDouble resultPlate = new PlateDouble(plate1.rows(), plate2.columns(), result[0]);
    		PlateDouble resultUnevenPlate = new PlateDouble(plateUneven.rows(), plateUneven.columns(), result[1]);
    ...
    public void testPlatesStrictIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateDouble returnedPlate = addition.platesStrict(plate1, plate2, begin, end - begin);
    		PlateDouble returnedPlateUneven = addition.platesStrict(plate1, plateUneven, begin, end - begin);
    		PlateDouble resultPlate = new PlateDouble(plate1.rows(), plate2.columns(), result[0]);
    		PlateDouble resultUnevenPlate = new PlateDouble(plateUneven.rows(), plateUneven.columns(), result[1]);
    ...
    public void testPlateConstant() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateDouble returnedPlate = addition.plates(plate1, randomDouble);
    ...
    public void testPlateArray() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateDouble returned = addition.plates(plate1, array);
    		PlateDouble returnedUneven = addition.plates(plate1, arrayUneven);
    ...
    public void testPlateArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
           ...
           for(WellDouble well : set1) {
    		...
    		PlateDouble resultPlate = new PlateDouble(plate1.rows(), plate1.columns(), result);
    		PlateDouble resultPlateUneven = new PlateDouble(plate1.rows(), plate1.columns(), resultUneven);
    		PlateDouble returned = addition.plates(plate1, array, begin, end - begin);
    		PlateDouble returnedUneven = addition.plates(plate1, arrayUneven, begin, end - begin);
    ...
    public void testPlateCollection() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateDouble resultPlate = new PlateDouble(plate1.rows(), plate1.columns(), result);
    		PlateDouble resultPlateUneven = new PlateDouble(plate1.rows(), plate1.columns(), resultUneven);
    		PlateDouble returned = addition.plates(plate1, inputList);
    		PlateDouble returnedUneven = addition.plates(plate1, inputListUneven);
    ...
    public void testPlateCollectionIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
           ...
           for(WellDouble well : set1) {
    		...
    		PlateDouble returned = addition.plates(plate1, inputList, begin, end - begin);
    		PlateDouble returnedUneven = addition.plates(plate1, inputListUneven, begin, end - begin);
    ...
    public void testPlateStrictArray() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateDouble resultPlate = new PlateDouble(plate1.rows(), plate1.columns(), result);
    		PlateDouble resultPlateUneven = new PlateDouble(plate1.rows(), plate1.columns(), resultUneven);
    		PlateDouble returned = addition.platesStrict(plate1, array);
    		PlateDouble returnedUneven = addition.platesStrict(plate1, arrayUneven);
    ...
    public void testPlateStrictArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateDouble resultPlate = new PlateDouble(plate1.rows(), plate1.columns(), result);
    		PlateDouble resultPlateUneven = new PlateDouble(plate1.rows(), plate1.columns(), resultUneven);
    		PlateDouble returned = addition.platesStrict(plate1, array, begin, end - begin);
    		PlateDouble returnedUneven = addition.platesStrict(plate1, arrayUneven, begin, end - begin);
    ...
    public void testPlateStrictCollection() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateDouble resultPlate = new PlateDouble(plate1.rows(), plate1.columns(), result);
    		PlateDouble resultPlateUneven = new PlateDouble(plate1.rows(), plate1.columns(), resultUneven);
    		PlateDouble returned = addition.platesStrict(plate1, inputList);
    		PlateDouble returnedUneven = addition.platesStrict(plate1, inputListUneven);
    ...
    public void testPlateStrictCollectionIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
           ...
           for(WellDouble well : set1) {
    		...
    		PlateDouble returned = addition.platesStrict(plate1, inputList, begin, end - begin);
    		PlateDouble returnedUneven = addition.platesStrict(plate1, inputListUneven, begin, end - begin);
    ...
    public void testSets() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetDouble[] result = this.set(set1, set2, setUneven, false);
    		WellSetDouble returned = addition.sets(set1, set2);
    		WellSetDouble returnedUneven = addition.sets(set1, setUneven);
    ...
    public void testSetsIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetDouble[] result = this.set(set1, set2, setUneven, begin, end, false);
    		WellSetDouble returned = addition.sets(set1, set2, begin, end - begin);
    		WellSetDouble returnedUneven = addition.sets(set1, setUneven, begin, end - begin);
    ...
    public void testSetsStrict() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetDouble[] result = this.set(set1, set2, setUneven, true);
    		WellSetDouble returned = addition.setsStrict(set1, set2);
    		WellSetDouble returnedUneven = addition.setsStrict(set1, setUneven);
    ...
    public void testSetsStrictIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetDouble[] result = this.set(set1, set2, setUneven, begin, end, true);
    		WellSetDouble returned = addition.setsStrict(set1, set2, begin, end - begin);
    		WellSetDouble returnedUneven = addition.setsStrict(set1, setUneven, begin, end - begin);
    ...
    public void testSetConstant() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetDouble returned = addition.sets(set, randomDouble);
    ...
    public void testSetArray() {   	
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetDouble returned = addition.sets(set1, array);
    		WellSetDouble returnedUneven = addition.sets(set1, arrayUneven);
    ...
    public void testSetArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetDouble returned = addition.sets(set1, array, begin, end - begin);
    		WellSetDouble returnedUneven = addition.sets(set1, arrayUneven, begin, end - begin);
    ...
    public void testSetCollection() {   
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetDouble returned = addition.sets(set1, inputList);
    		WellSetDouble returnedUneven = addition.sets(set1, inputListUneven);
    ...
    public void testSetCollectionIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetDouble returned = addition.sets(set1, inputList, begin, end - begin);
    		WellSetDouble returnedUneven = addition.sets(set1, inputListUneven, begin, end - begin);
    ...
    public void testSetStrictArray() {
		...
		WellDouble wellEven = arrays2.get(0)[0].dataSet().first();
		WellDouble wellUneven = uneven.get(0)[0].dataSet().first();
		double[] array = wellEven.toDoubleArray();		double[] arrayUneven = wellUneven.toDoubleArray();
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetDouble returned = addition.setsStrict(set1, array);
    		WellSetDouble returnedUneven = addition.setsStrict(set1, arrayUneven);
    ...
    public void testSetStrictArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetDouble returned = addition.setsStrict(set1, array, begin, end - begin);
    		WellSetDouble returnedUneven = addition.setsStrict(set1, arrayUneven, begin, end - begin);
    ...
    public void testSetStrictCollection() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetDouble returned = addition.setsStrict(set1, inputList);
    		WellSetDouble returnedUneven = addition.setsStrict(set1, inputListUneven);
    ...
    public void testSetStrictCollectionIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetDouble returned = addition.setsStrict(set1, inputList, begin, end - begin);
    		WellSetDouble returnedUneven = addition.setsStrict(set1, inputListUneven, begin, end - begin);
    ...
    public void testStacks() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackDouble returned = addition.stacks(stack1, stack2);
	    	StackDouble returnedUneven = addition.stacks(stack1, stackUneven);
    ...
    public void testStacksIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackDouble returned = addition.stacks(stack1, stack2, begin, end - begin);
	    	StackDouble returnedUneven = addition.stacks(stack1, stackUneven, begin, end - begin);
    ...
    public void testStacksStrict() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackDouble returned = addition.stacksStrict(stack1, stack2);
	    	StackDouble returnedUneven = addition.stacksStrict(stack1, stackUneven);
    ...
    public void testStacksStrictIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackDouble returned = addition.stacksStrict(stack1, stack2, begin, end - begin);
	    	StackDouble returnedUneven = addition.stacksStrict(stack1, stackUneven, begin, end - begin);
    ...
    public void testStackConstant() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackDouble returned = addition.stacks(stack1, randomDouble);
    ...
    public void testStackArray() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackDouble returned = addition.stacks(stack1, array);
	    	StackDouble returnedUneven = addition.stacks(stack1, arrayUneven);
    ...
    public void testStackArrayIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackDouble returned = addition.stacks(stack1, array, begin, end - begin);
	    	StackDouble returnedUneven = addition.stacks(stack1, arrayUneven, begin, end - begin);
    ...
    public void testStackCollection() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackDouble returned = addition.stacks(stack1, inputList);
	    	StackDouble returnedUneven = addition.stacks(stack1, inputListUneven);
    ...
    public void testStackCollectionIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackDouble returned = addition.stacks(stack1, inputList, begin, end - begin);
	    	StackDouble returnedUneven = addition.stacks(stack1, inputListUneven, begin, end - begin);
    ...
    public void testStackStrictArray() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackDouble returned = addition.stacksStrict(stack1, array);
	    	StackDouble returnedUneven = addition.stacksStrict(stack1, arrayUneven);
    ...
    public void testStackStrictArrayIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackDouble returned = addition.stacksStrict(stack1, array, begin, end - begin);
	    	StackDouble returnedUneven = addition.stacksStrict(stack1, arrayUneven, begin, end - begin);
    ...
    public void testStackStrictCollection() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackDouble returned = addition.stacksStrict(stack1, inputList);
	    	StackDouble returnedUneven = addition.stacksStrict(stack1, inputListUneven);
    ...
    public void testStackStrictCollectionIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackDouble returned = addition.stacksStrict(stack1, inputList, begin, end - begin);
	    	StackDouble returnedUneven = addition.stacksStrict(stack1, inputListUneven, begin, end - begin);
