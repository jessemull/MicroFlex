...
import com.github.jessemull.microflex.bigintegerflex.math.MultiplicationBigInteger;
...
public class MultiplicationBigIntegerTest {
...
/* ---------------------------- Local fields ---------------------------- */
	...
	private static MultiplicationBigInteger multiplication = new MultiplicationBigInteger();
	...
	public void testConstructor() {		
		MultiplicationBigInteger test = new MultiplicationBigInteger();
		assertNotNull(test);
	}
    ...
    public void testPlates() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateBigInteger returnedPlate = multiplication.plates(plate1, plate2);
    		PlateBigInteger returnedPlateUneven = multiplication.plates(plate1, plateUneven);
    ...
    public void testPlatesIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateBigInteger returnedPlate = multiplication.plates(plate1, plate2, begin, end - begin);
    		PlateBigInteger returnedPlateUneven = multiplication.plates(plate1, plateUneven, begin, end - begin);
    		PlateBigInteger resultPlate = new PlateBigInteger(plate1.rows(), plate2.columns(), result[0]);
    		PlateBigInteger resultUnevenPlate = new PlateBigInteger(plateUneven.rows(), plateUneven.columns(), result[1]);
    ...
    public void testPlatesStrict() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateBigInteger returnedPlate = multiplication.platesStrict(plate1, plate2);
    		PlateBigInteger returnedPlateUneven = multiplication.platesStrict(plate1, plateUneven);
    		PlateBigInteger resultPlate = new PlateBigInteger(plate1.rows(), plate2.columns(), result[0]);
    		PlateBigInteger resultUnevenPlate = new PlateBigInteger(plateUneven.rows(), plateUneven.columns(), result[1]);
    ...
    public void testPlatesStrictIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateBigInteger returnedPlate = multiplication.platesStrict(plate1, plate2, begin, end - begin);
    		PlateBigInteger returnedPlateUneven = multiplication.platesStrict(plate1, plateUneven, begin, end - begin);
    		PlateBigInteger resultPlate = new PlateBigInteger(plate1.rows(), plate2.columns(), result[0]);
    		PlateBigInteger resultUnevenPlate = new PlateBigInteger(plateUneven.rows(), plateUneven.columns(), result[1]);
    ...
    public void testPlateConstant() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateBigInteger returnedPlate = multiplication.plates(plate1, randomBigInteger);
    ...
    public void testPlateArray() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateBigInteger returned = multiplication.plates(plate1, array);
    		PlateBigInteger returnedUneven = multiplication.plates(plate1, arrayUneven);
    ...
    public void testPlateArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
           ...
           for(WellBigInteger well : set1) {
    		...
    		PlateBigInteger resultPlate = new PlateBigInteger(plate1.rows(), plate1.columns(), result);
    		PlateBigInteger resultPlateUneven = new PlateBigInteger(plate1.rows(), plate1.columns(), resultUneven);
    		PlateBigInteger returned = multiplication.plates(plate1, array, begin, end - begin);
    		PlateBigInteger returnedUneven = multiplication.plates(plate1, arrayUneven, begin, end - begin);
    ...
    public void testPlateCollection() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateBigInteger resultPlate = new PlateBigInteger(plate1.rows(), plate1.columns(), result);
    		PlateBigInteger resultPlateUneven = new PlateBigInteger(plate1.rows(), plate1.columns(), resultUneven);
    		PlateBigInteger returned = multiplication.plates(plate1, inputList);
    		PlateBigInteger returnedUneven = multiplication.plates(plate1, inputListUneven);
    ...
    public void testPlateCollectionIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
           ...
           for(WellBigInteger well : set1) {
    		...
    		PlateBigInteger returned = multiplication.plates(plate1, inputList, begin, end - begin);
    		PlateBigInteger returnedUneven = multiplication.plates(plate1, inputListUneven, begin, end - begin);
    ...
    public void testPlateStrictArray() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateBigInteger resultPlate = new PlateBigInteger(plate1.rows(), plate1.columns(), result);
    		PlateBigInteger resultPlateUneven = new PlateBigInteger(plate1.rows(), plate1.columns(), resultUneven);
    		PlateBigInteger returned = multiplication.platesStrict(plate1, array);
    		PlateBigInteger returnedUneven = multiplication.platesStrict(plate1, arrayUneven);
    ...
    public void testPlateStrictArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateBigInteger resultPlate = new PlateBigInteger(plate1.rows(), plate1.columns(), result);
    		PlateBigInteger resultPlateUneven = new PlateBigInteger(plate1.rows(), plate1.columns(), resultUneven);
    		PlateBigInteger returned = multiplication.platesStrict(plate1, array, begin, end - begin);
    		PlateBigInteger returnedUneven = multiplication.platesStrict(plate1, arrayUneven, begin, end - begin);
    ...
    public void testPlateStrictCollection() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		PlateBigInteger resultPlate = new PlateBigInteger(plate1.rows(), plate1.columns(), result);
    		PlateBigInteger resultPlateUneven = new PlateBigInteger(plate1.rows(), plate1.columns(), resultUneven);
    		PlateBigInteger returned = multiplication.platesStrict(plate1, inputList);
    		PlateBigInteger returnedUneven = multiplication.platesStrict(plate1, inputListUneven);
    ...
    public void testPlateStrictCollectionIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
           ...
           for(WellBigInteger well : set1) {
    		...
    		PlateBigInteger returned = multiplication.platesStrict(plate1, inputList, begin, end - begin);
    		PlateBigInteger returnedUneven = multiplication.platesStrict(plate1, inputListUneven, begin, end - begin);
    ...
    public void testSets() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigInteger[] result = this.set(set1, set2, setUneven, false);
    		WellSetBigInteger returned = multiplication.sets(set1, set2);
    		WellSetBigInteger returnedUneven = multiplication.sets(set1, setUneven);
    ...
    public void testSetsIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigInteger[] result = this.set(set1, set2, setUneven, begin, end, false);
    		WellSetBigInteger returned = multiplication.sets(set1, set2, begin, end - begin);
    		WellSetBigInteger returnedUneven = multiplication.sets(set1, setUneven, begin, end - begin);
    ...
    public void testSetsStrict() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigInteger[] result = this.set(set1, set2, setUneven, true);
    		WellSetBigInteger returned = multiplication.setsStrict(set1, set2);
    		WellSetBigInteger returnedUneven = multiplication.setsStrict(set1, setUneven);
    ...
    public void testSetsStrictIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigInteger[] result = this.set(set1, set2, setUneven, begin, end, true);
    		WellSetBigInteger returned = multiplication.setsStrict(set1, set2, begin, end - begin);
    		WellSetBigInteger returnedUneven = multiplication.setsStrict(set1, setUneven, begin, end - begin);
    ...
    public void testSetConstant() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigInteger returned = multiplication.sets(set, randomBigInteger);
    ...
    public void testSetArray() {   	
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigInteger returned = multiplication.sets(set1, array);
    		WellSetBigInteger returnedUneven = multiplication.sets(set1, arrayUneven);
    ...
    public void testSetArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigInteger returned = multiplication.sets(set1, array, begin, end - begin);
    		WellSetBigInteger returnedUneven = multiplication.sets(set1, arrayUneven, begin, end - begin);
    ...
    public void testSetCollection() {   
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigInteger returned = multiplication.sets(set1, inputList);
    		WellSetBigInteger returnedUneven = multiplication.sets(set1, inputListUneven);
    ...
    public void testSetCollectionIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigInteger returned = multiplication.sets(set1, inputList, begin, end - begin);
    		WellSetBigInteger returnedUneven = multiplication.sets(set1, inputListUneven, begin, end - begin);
    ...
    public void testSetStrictArray() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigInteger returned = multiplication.setsStrict(set1, array);
    		WellSetBigInteger returnedUneven = multiplication.setsStrict(set1, arrayUneven);
    ...
    public void testSetStrictArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigInteger returned = multiplication.setsStrict(set1, array, begin, end - begin);
    		WellSetBigInteger returnedUneven = multiplication.setsStrict(set1, arrayUneven, begin, end - begin);
    ...
    public void testSetStrictCollection() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigInteger returned = multiplication.setsStrict(set1, inputList);
    		WellSetBigInteger returnedUneven = multiplication.setsStrict(set1, inputListUneven);
    ...
    public void testSetStrictCollectionIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSetBigInteger returned = multiplication.setsStrict(set1, inputList, begin, end - begin);
    		WellSetBigInteger returnedUneven = multiplication.setsStrict(set1, inputListUneven, begin, end - begin);
    ...
    public void testStacks() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigInteger returned = multiplication.stacks(stack1, stack2);
	    	StackBigInteger returnedUneven = multiplication.stacks(stack1, stackUneven);
    ...
    public void testStacksIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigInteger returned = multiplication.stacks(stack1, stack2, begin, end - begin);
	    	StackBigInteger returnedUneven = multiplication.stacks(stack1, stackUneven, begin, end - begin);
    ...
    public void testStacksStrict() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigInteger returned = multiplication.stacksStrict(stack1, stack2);
	    	StackBigInteger returnedUneven = multiplication.stacksStrict(stack1, stackUneven);
    ...
    public void testStacksStrictIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigInteger returned = multiplication.stacksStrict(stack1, stack2, begin, end - begin);
	    	StackBigInteger returnedUneven = multiplication.stacksStrict(stack1, stackUneven, begin, end - begin);
    ...
    public void testStackConstant() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigInteger returned = multiplication.stacks(stack1, randomBigInteger);
    ...
    public void testStackArray() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigInteger returned = multiplication.stacks(stack1, array);
	    	StackBigInteger returnedUneven = multiplication.stacks(stack1, arrayUneven);
    ...
    public void testStackArrayIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigInteger returned = multiplication.stacks(stack1, array, begin, end - begin);
	    	StackBigInteger returnedUneven = multiplication.stacks(stack1, arrayUneven, begin, end - begin);
    ...
    public void testStackCollection() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigInteger returned = multiplication.stacks(stack1, inputList);
	    	StackBigInteger returnedUneven = multiplication.stacks(stack1, inputListUneven);
    ...
    public void testStackCollectionIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigInteger returned = multiplication.stacks(stack1, inputList, begin, end - begin);
	    	StackBigInteger returnedUneven = multiplication.stacks(stack1, inputListUneven, begin, end - begin);
    ...
    public void testStackStrictArray() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigInteger returned = multiplication.stacksStrict(stack1, array);
	    	StackBigInteger returnedUneven = multiplication.stacksStrict(stack1, arrayUneven);
    ...
    public void testStackStrictArrayIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigInteger returned = multiplication.stacksStrict(stack1, array, begin, end - begin);
	    	StackBigInteger returnedUneven = multiplication.stacksStrict(stack1, arrayUneven, begin, end - begin);
    ...
    public void testStackStrictCollection() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigInteger returned = multiplication.stacksStrict(stack1, inputList);
	    	StackBigInteger returnedUneven = multiplication.stacksStrict(stack1, inputListUneven);
    ...
    public void testStackStrictCollectionIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	StackBigInteger returned = multiplication.stacksStrict(stack1, inputList, begin, end - begin);
	    	StackBigInteger returnedUneven = multiplication.stacksStrict(stack1, inputListUneven, begin, end - begin);
