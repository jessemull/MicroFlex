...
import com.github.jessemull.microflex.doubleflex.math.IncrementDouble;
...
/**
 * This class tests the methods in the increment double class.
 * 
 * @author Jesse L. Mull
...
public class IncrementDoubleTest {
	...
	private static IncrementDouble increment = new IncrementDouble();
	...
	public void testConstructor() {
		IncrementDouble test = new IncrementDouble();
		assertNotNull(test);
	}
		...
		for(PlateDouble[] plates : arrays) {
			...
			for(PlateDouble plate : plates) {
				...
				for(WellDouble well : plate) {
					...
					List<Double> returned = increment.wells(well);
        ...
        for(PlateDouble[] plates : arrays) {
			...
			for(PlateDouble plate : plates) {
				...
				for(WellDouble well : plate) {
	    			...
	    			List<Double> result = new ArrayList<Double>();
					List<Double> returned = increment.wells(well, begin, end - begin);				
    ...
    public void testPlates() {
        ...
        for(PlateDouble[] plates : arrays) {
			...
			for(PlateDouble plate : plates) {
				...
				PlateDouble returnedPlate = increment.plates(plate);
    ...
    public void testPlatesIndices() {
    	...
    	for(PlateDouble[] plates : arrays) {
			...
			for(PlateDouble plate : plates) {
				...
				PlateDouble resultPlate = new PlateDouble(plate.rows(), plate.columns(), result);
				PlateDouble returnedPlate = increment.plates(plate, begin, end - begin);
    ...
    public void testSets() {
        ...
        for(PlateDouble[] plates : arrays) {
			...
			for(PlateDouble plate : plates) {
				...
				WellSetDouble result = new WellSetDouble();
				WellSetDouble returned = increment.sets(plate.dataSet());
    ...
    public void testSetsIndices() {
        ...
        for(PlateDouble[] plates : arrays) {
			...
			for(PlateDouble plate : plates) {
				...
				WellSetDouble result = new WellSetDouble();
				WellSetDouble returned = increment.sets(plate.dataSet(), begin, end - begin);
    ...
    public void testStacks() {
        ...
        for(StackDouble stack : stacks) {
			...
			StackDouble returnedStack = increment.stacks(stack);
    ...
    public void testStacksIndices() {
    	...
    	for(StackDouble stack : stacks) {
			...
			StackDouble returnedStack = increment.stacks(stack, begin, end - begin);
