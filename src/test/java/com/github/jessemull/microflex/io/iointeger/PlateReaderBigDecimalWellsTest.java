...
public class PlateReaderBigDecimalWellsTest {
	
    /* ---------------------------- Local Fields -----------------------------*/
	
    /* Minimum and maximum values for random well and lists */
	
	private static BigDecimal minValue = new BigDecimal(0);                         // Minimum int value for wells
	private static BigDecimal maxValue = new BigDecimal(10);                        // Maximum int value for wells
