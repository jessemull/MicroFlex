 ...
 */
public class StackInteger implements Iterable<PlateInteger> {

    /* ---------------------------- Private fields -------------------------- */
    
    /* Plate storage */
    
    private TreeSet<PlateInteger> stack;
     ...
     */
    public StackInteger(int type) {
        this.initializePlateType(type);
        this.stack = new TreeSet<PlateInteger>();
    }
     ...
     */
    public StackInteger(int rows, int columns) {
     ...
     */
    public StackInteger(int type, String labelIn) {
        this.initializePlateType(type);
        this.stack = new TreeSet<PlateInteger>();
        this.label = labelIn;
    }
     ...
     * @param    String    the plate stack label
     */
    public StackInteger(int rows, int columns, String labelIn) {
    	this.initializePlateType(rows, columns);
        this.stack = new TreeSet<PlateInteger>();
        this.label = labelIn;
    }
     ...
     */
    public StackInteger(PlateInteger plateIn) {
     ...
     * @param    String    the plate stack label
     */
    public StackInteger(PlateInteger plateIn, String labelIn) {
    	this.initializePlateType(plateIn.rows(), plateIn.columns());
    	ValUtil.validatePlateInteger(this.rows(), this.columns(), plateIn);
        this.stack = new TreeSet<PlateInteger>();
        this.stack.add(plateIn);
     ...
     */
    public StackInteger(Collection<PlateInteger> platesIn) {
        PlateInteger[] array = platesIn.toArray(new PlateInteger[platesIn.size()]);
     ...
     * @param    Collection<PlateInteger>    list of input plates
     */
    public StackInteger(Collection<PlateInteger> platesIn, String labelIn) {
        PlateInteger[] array = platesIn.toArray(new PlateInteger[platesIn.size()]);
        this.initializePlateType(array[0].rows(), array[0].columns());  
        ValUtil.validatePlateInteger(this.rows(), this.columns(), platesIn);   
        this.stack = new TreeSet<PlateInteger>();
     ...
     */
    public StackInteger(PlateInteger[] platesIn) {     
     ...
     * @param    PlateInteger[]    list of input plates
     */
    public StackInteger(PlateInteger[] platesIn, String labelIn) {       
        this.initializePlateType(platesIn[0].rows(), platesIn[0].columns()); 
        ValUtil.validatePlateInteger(this.rows(), this.columns(), platesIn);
        this.stack = new TreeSet<PlateInteger>();
        this.stack.addAll(Arrays.asList(platesIn));
     ...
     * @param    StackInteger    the input stack
     */
    public StackInteger(StackInteger stack) {              
     ...
     */
    public boolean add(PlateInteger plateIn) {
        try { 
            ValUtil.validatePlateInteger(this.rows(), this.columns(), plateIn);
            this.stack.add(plateIn);
            return true;
     ...
     * @return                               true on successful addition
     */
    public boolean add(Collection<PlateInteger> platesIn) {
        try {
            ValUtil.validatePlateInteger(this.rows(), this.columns(), platesIn);
            this.stack.addAll(platesIn);
            return true;
     ...
     * @return                     true on successful addition
     */
    public boolean add(PlateInteger[] platesIn) {
        try { 
            ValUtil.validatePlateInteger(this.rows(), this.columns(), platesIn);
            this.stack.addAll(Arrays.asList(platesIn));
            return true;
     ...
     */
    public boolean remove(PlateInteger plateIn) {
     ...
     * @return                               true on successful removal
     */
    public  boolean remove(Collection<PlateInteger> platesIn) {
        ...
        for(PlateInteger plate : platesIn) {
            try {
     ...
     * @return                     true on successful removal
     */
    public  boolean remove(PlateInteger[] platesIn) {
    ...
    public boolean remove(String label) {
        ...
        try {
        	...
        	for(PlateInteger plate : this.stack) {
    ...
    public boolean remove(List<String> labels) {
        ...
        Set<PlateInteger> list = new TreeSet<PlateInteger>();
     ...
     */
    public boolean replace(PlateInteger plateIn) {
     ...
     * @return                               true on successful replacement
     */
    public  boolean replace(Collection<PlateInteger> platesIn) {
     ...
     * @return                     true on successful replacement
     */
    public  boolean replace(PlateInteger[] platesIn) {
     ...
     */
    public boolean retain(PlateInteger plateIn) {
    	
    	boolean success = true;
        
        List<PlateInteger> list = new ArrayList<PlateInteger>();
        list.add(plateIn);
     ...
     * @return                               true on successful retention
     */
    public  boolean retain(Collection<PlateInteger> platesIn) {
     ...
     * @return                     true on successful retention
     */
    public  boolean retain(PlateInteger[] platesIn) {
    ...
    public boolean retain(String label) {
        ...
        try {
        	...
        	for(PlateInteger plate : this.stack) {
        		if(plate.label().equals(label)) {
        			List<PlateInteger> plateList = new ArrayList<PlateInteger>();
        			plateList.add(plate);
     ...
     * @return             the plate 
     */
    public PlateInteger get(String label) {
     ...
     * @return                        the plates
     */
    public Set<PlateInteger> get(List<String> labels) {

        Set<PlateInteger> plates = new TreeSet<PlateInteger>();
     ...
     */
    public PlateInteger get(PlateInteger plateIn) {
     ...
     */
    public Set<PlateInteger> get(Collection<PlateInteger> platesIn) {
    	
    	Preconditions.checkNotNull(platesIn, "The plate collection cannot be null.");
        
    	Set<PlateInteger> result = new TreeSet<PlateInteger>();
        
        for(PlateInteger plate : platesIn) {
        
        	PlateInteger toAdd = this.get(plate);
     ...
     * @result   PlateInteger            the output plate
     */
    public Set<PlateInteger> get(PlateInteger[] platesIn) {
     ...
     */
    public Set<PlateInteger> getAll() {
    	return this.stack;
    }
     ...
     */
    public boolean contains(PlateInteger plateIn) {
     ...
     */
    public boolean contains(Collection<PlateInteger> platesIn) {
     ...
     */
    public boolean contains(PlateInteger[] platesIn) {
     ...
     */
    public PlateInteger lower(PlateInteger plate) {
     ...
     */
    public Iterator<PlateInteger> iterator() {
     ...
     */
    public Iterator<PlateInteger> descendingIterator() {
     ...
     */
    public Set<PlateInteger> descendingSet() {
     ...
     * @return                   least plate greater than or equal to the input plate
     */
    public PlateInteger ceiling(PlateInteger plate) {
     ...
     * @return    greatest plate less than or equal to the input plate
     */
    public PlateInteger floor(PlateInteger plate) {
     ...
     */
    public Set<PlateInteger> headSet(PlateInteger plate) {
     ...
     * @param    PlateInteger plate    input   plate 
     * @param    boolean    a true value retains the input plate in the sub set
     * @return              plate set with plates less than the input plate
     */
    public Set<PlateInteger> headSet(PlateInteger plate, boolean inclusive) {
     ...
     */
    public Set<PlateInteger> tailSet(PlateInteger plate) {
     ...
     * @return                    set with plates greater than or equal to the input plate
     */
    public Set<PlateInteger> tailSet(PlateInteger plate, boolean inclusive) {
     ...
     * @param    PlateInteger    the first input plate
     * @param    PlateInteger    the second input plate
     ...
     */
    public Set<PlateInteger> subSet(PlateInteger plate1, boolean inclusive1, PlateInteger plate2, boolean inclusive2) {
     ...
     * @return                   plates in range
     */
    public Set<PlateInteger> subSet(PlateInteger plate1, PlateInteger plate2) {
    ...
    public boolean equals(Object object) {
        ...
        if (object instanceof StackInteger == false) {
            return false;
        }
		...
		StackInteger stackIn = (StackInteger) object;
        ...
        Iterator<PlateInteger> input = stackIn.iterator();
        Iterator<PlateInteger> compareTo = this.stack.iterator();
