...
import com.github.jessemull.microflex.integerflex.stat.DescriptiveStatisticIntegerWeights;
 ...
 */
public class ContraharmonicMeanInteger extends DescriptiveStatisticIntegerWeights {
    ...
    public double calculate(List<Double> list, double[] weights) {
    	...
    	for(int i = 0; i < list.size(); i++) {
    	   ...
    	   sumSquares += Math.pow(list.get(i) * weights[i], 2);
    	}
