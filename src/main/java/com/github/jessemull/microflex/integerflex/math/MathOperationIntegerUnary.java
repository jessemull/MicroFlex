...
public abstract class MathOperationIntegerUnary {
     ...
     */
    public List<Integer> wells(WellInteger well) {
     ...
     * @return                  result of the operation
     */
    public List<Integer> wells(WellInteger well, int begin, int length) {
     ...
     * @return                   result of the operation
     */
    public PlateInteger plates(PlateInteger plate) {
     ...
     * @return                   result of the operation
     */
    public PlateInteger plates(PlateInteger plate, int begin, int length) {
     ...
     * @return                     result of the operation
     */
    public WellSetInteger sets(WellSetInteger set) {
     ...
     * @return                     result of the operation
     */
    public WellSetInteger sets(WellSetInteger set, int begin, int length) {
     ...
     */
     public StackInteger stacks(StackInteger stack) {
      ...
      * @return                   the result of the operation
      */
     public StackInteger stacks(StackInteger stack, int begin, int length) {
     ...
     * @return                    result of the mathematical operation
     */
    public abstract List<Integer> calculate(List<Integer> list, int begin, int length);
}
