 ...
 */
public abstract class DescriptiveStatisticListInteger {
     ...
     */
    public Map<WellInteger, List<Double>> plate(PlateInteger plate) {
     ...
     * @return                   map of wells and results   
     */
    public Map<WellInteger, List<Double>> plate(PlateInteger plate, int begin, int length) {
     ...
     */
    public List<Double> platesAggregated(PlateInteger plate) {
     ...
     */
    public Map<PlateInteger, List<Double>> platesAggregated(Collection<PlateInteger> collection) {
     ...
     */
    public Map<PlateInteger, List<Double>> platesAggregated(PlateInteger[] array) {
     ...
     * @return                     map of wells and results
     */
    public Map<WellInteger, List<Double>> set(WellSetInteger set) {
     ...
     * @return                     map of wells and results
     */
    public Map<WellInteger, List<Double>> set(WellSetInteger set, int begin, int length) {
     ...
     * @return                     the aggregated result
     */
    public List<Double> setsAggregated(WellSetInteger set) {
     ...
     */ 
    public Map<WellSetInteger, List<Double>> setsAggregated(Collection<WellSetInteger> collection) {
     ...
     * @return                       map of well sets and aggregated results
     */
    public Map<WellSetInteger, List<Double>> setsAggregated(WellSetInteger[] array) {
     ...
     * @return                  the result
     */
    public List<Double> well(WellInteger well) {
     ...
     * @return                  the result
     */
    public List<Double> well(WellInteger well, int begin, int length) {
        Preconditions.checkNotNull(well, "The well cannot be null.");
