 ...
 */
public abstract class DescriptiveStatisticDouble {
     ...
     */
    public Map<WellDouble, Double> plate(PlateDouble plate) {
     ...
     * @return                  map of wells and results   
     */
    public Map<WellDouble, Double> plate(PlateDouble plate, int begin, int length) {
     ...
     */
    public double platesAggregated(PlateDouble plate) {
     ...
     */
    public Map<PlateDouble, Double> platesAggregated(Collection<PlateDouble> collection) {
     ...
     */
    public Map<PlateDouble, Double> platesAggregated(PlateDouble[] array) {
     ...
     * @return                    map of wells and results
     */
    public Map<WellDouble, Double> set(WellSetDouble set) {
     ...
     * @return                    map of wells and results
     */
    public Map<WellDouble, Double> set(WellSetDouble set, int begin, int length) {
     ...
     * @return                    the aggregated result
     */
    public double setsAggregated(WellSetDouble set) {
     ...
     */ 
    public Map<WellSetDouble, Double> setsAggregated(Collection<WellSetDouble> collection) {
     ...
     * @return                      map of well sets and aggregated results
     */
    public Map<WellSetDouble, Double> setsAggregated(WellSetDouble[] array) {
     ...
     * @return                 the result
     */
    public double well(WellDouble well) {
     ...
     * @return                 the result
     */
    public double well(WellDouble well, int begin, int length) {
        Preconditions.checkNotNull(well, "The well cannot be null.");
