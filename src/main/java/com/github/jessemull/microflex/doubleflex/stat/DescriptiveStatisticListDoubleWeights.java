...
public abstract class DescriptiveStatisticListDoubleWeights extends DescriptiveStatisticListDouble {
     ...
     */
    public Map<WellDouble, List<Double>> plate(PlateDouble plate, double[] weights) {
     ...
     * @return                  map of wells and results
     */
    public Map<WellDouble, List<Double>> plate(PlateDouble plate, double[] weights, int begin, int length) {
     ...
     */
    public List<Double> platesAggregated(PlateDouble plate, double[] weights) {
     ...
     * @return                  the aggregated result
     */
    public List<Double> platesAggregated(PlateDouble plate, double[] weights, int begin, int length) {
     ...
     * @return                    map of wells and results
     */
    public Map<WellDouble, List<Double>> set(WellSetDouble set, double[] weights) {
     ...
     * @return                    map of wells and results
     */
    public Map<WellDouble, List<Double>> set(WellSetDouble set, double[] weights, int begin, int length) {
     ...
     */
    public List<Double> setsAggregated(WellSetDouble set, double[] weights) {
     ...
     * @return                    the aggregated result
     */
    public List<Double> setsAggregated(WellSetDouble set, double[] weights, int begin, int length) {
     ...
     * @return                 the result
     */
    public List<Double> well(WellDouble well, double[] weights) {
     ...
     * @return                 the result
     */
    public List<Double> well(WellDouble well, double[] weights, int begin, int length) {
