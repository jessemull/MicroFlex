...
public class StackPOJODouble {
    ...
    private List<PlatePOJODouble> plates = 
    		new ArrayList<PlatePOJODouble>();    // List of plates in the stack
    
    /*------------------------------ Constructors ----------------------------*/
    
    public StackPOJODouble(){}
    
    /**
     * Creates a stack POJO from a stack object.
     * @param    StackDouble    the stack object
     */
    public StackPOJODouble(StackDouble stack) {
        ...
        for(PlateDouble plate : stack) {
            plates.add(new PlatePOJODouble(plate));
        }
    }
     ...
     * @param    List<PlatePOJODouble>    the plates
     */
    ...
    public StackDouble toStackObject() {
    	...
    	for(PlatePOJODouble plate : plates) {
