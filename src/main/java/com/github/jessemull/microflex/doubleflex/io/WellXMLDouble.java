...
public class WellXMLDouble {
    ...
    /**
     * Creates a well XML object from a well Double object.
     * @param    WellDouble    the well object
     */
    public WellXMLDouble(WellDouble well) {
     ...
     * @param    WellDouble    the well object
     */
    public WellXMLDouble(String index, int size, Double[] values, String type) {
        this.index = index;
        this.size = size;
        this.values = values;
        this.type = type;;
