...
public class ResultPOJODouble {
    ...
    private Map<String, Double> wells = 
    		new TreeMap<String, Double>();    // The map of well results
    
    /*------------------------------ Constructors ----------------------------*/
    
    public ResultPOJODouble(){}
    
    /**
     * Creates a result POJO.
     * @param    Map<WellDouble, Double>    the result object
     * @param    String                     the result label
     */
    public ResultPOJODouble(Map<WellDouble, Double> results, String label) {
        
        this.size = results.size();
        this.label = label;
        this.type = "Double";
        
        for (Map.Entry<WellDouble, Double> entry : results.entrySet()) {
     ...
     * @param   Map<String, Double>    the list of well results
     */
     ...
     * @return   the wells
     */
    public Map<String, Double> getWells() {
        return this.wells;
    }
}
