...
/**
 * This class returns a random subset of the data values for double plate stacks, 
 ...
 */
public class RandomSampleDouble extends DescriptiveStatisticListDouble {
	...
	public List<Double> calculate(List<Double> list) {
		...
		List<Double> clone = new ArrayList<Double>(list);
