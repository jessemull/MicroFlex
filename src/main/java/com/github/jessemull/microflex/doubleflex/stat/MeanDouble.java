...
/**
 * This class calculates the mean of double plate stacks, plates, wells and 
 * well sets.
 *
 * <br><br>
 * 
 ...
 */
public class MeanDouble extends DescriptiveStatisticDoubleWeights {
    ...
    /**
     * Calculates the mean of the values between the beginning and 
     * ending indices.
     * @param    List<Double>    the list
    ...
    /**
     * Calculates the weighted mean of the values between the beginning and 
     * ending indices.
     * @param    List<Double>    the list
