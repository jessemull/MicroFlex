...
public class PlateXMLDouble {
    ...
    private List<SimpleWellSetXMLDouble> wellsets = 
    		new ArrayList<SimpleWellSetXMLDouble>();    // Plate well sets
    private List<SimpleWellXMLDouble> wells = 
    		new ArrayList<SimpleWellXMLDouble>();       // Plate wells
     ...
     */
    public PlateXMLDouble(PlateDouble plate) {
        ...
        for(WellSetDouble set : plate.allGroups()) {
            wellsets.add(new SimpleWellSetXMLDouble(set));
        }
        
        for(WellDouble well : plate) {
            wells.add(new SimpleWellXMLDouble(well));
        }
    }
     ...
     * @param    List<SimpleWellSetXMLDouble>    list of plate well sets
     */
    @XmlElement(name="wellset")
    @XmlElementWrapper(name="wellsets")
    public void setWellsets(List<SimpleWellSetXMLDouble> wellsets) {
    	this.wellsets = wellsets;
    }
    
    /**
     * Sets the list of wells.
     * @param    List<SimpleWellXMLDouble>    list of plate wells
     */
    @XmlElement(name="well")
    @XmlElementWrapper(name="wells")
    public void setWells(List<SimpleWellXMLDouble> wells) {
    	this.wells = wells;
    }
    ...
    public PlateDouble toPlateObject() {
        ...
        for(SimpleWellSetXMLDouble set : this.wellsets) {
        	plate.addGroups(set.toWellSetObject().wellList());
        }
        
        for(SimpleWellXMLDouble well : wells) {
