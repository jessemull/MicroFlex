...
/**
 * This class calculates the pth central moment for double plate stacks, plates, 
 * wells and well sets.
 *
 ...
 */
public class CentralMomentDouble extends QuantileStatisticDouble {

    /* ------ Methods for calculating the central moment of a data set -----  */
