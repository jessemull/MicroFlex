...
/**
 * This class calculates the sum of squares for double plate stacks, plates, 
 * wells and well sets. 
 * 
 * <br><br>
 * 
 ...
 */
public class SumOfSquaresDouble extends DescriptiveStatisticDoubleWeights {
    ...
    public double calculate(List<Double> list, double[] weights) {
        ...
        for(int i = 0; i < list.size(); i++) {
        	sum += Math.pow(list.get(i) * weights[i], 2);
        }
