...
/**
 * This class calculates the sample standard deviation of double plate stacks, 
 ...
 */
public class SampleStandardDeviationDouble extends DescriptiveStatisticDouble {
