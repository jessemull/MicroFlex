...
/**
 * This class performs multiplication operations for double plate stacks, plates, 
 * wells and well sets.
 * 
 ...
 */
public class MultiplicationDouble extends MathOperationDoubleBinary {
	 ...
	 * treated as zeroes.
	 * @param    List<Double> list1    the first list
	 * @param    List<Double> list2    the second list
	 * @return             the result
	 * @override
	 */
	public List<Double> calculate(List<Double> list1, List<Double> list2) {
		
		List<Double> largest = null;
		List<Double> smallest = null;
	 ...
	 * @override
	 */
	public List<Double> calculateStrict(List<Double> list1, List<Double> list2) {
		
		List<Double> smallest = list1.size() < list2.size() ? list1 : list2;
		List<Double> result = new ArrayList<Double>();
	 ...
	 * @override
	 */
	public List<Double> calculate(List<Double> list1, List<Double> list2, int begin, int length) {

		
		List<Double> largest = list1.size() > list2.size() ? list1 : list2;
		List<Double> smallest = list1.size() < list2.size() ? list1 : list2;		
		List<Double> result = new ArrayList<Double>();
	 ...
	 * @override
	 */
	public List<Double> calculateStrict(List<Double> list1,
			List<Double> list2, int begin, int length) {
	 ...
	 * @param    List<Double> list    the list
	 * @param    double constant      the constant value
	 * @return            the result
	 * @override
	 */
	public List<Double> calculate(List<Double> list, double constant) {
		
		List<Double> result = new ArrayList<Double>();
		
		for(double db : list) {
			result.add(db * constant);
		}
	 ...
	 * @override
	 */
	public List<Double> calculate(List<Double> list, double[] array) {
	 ...
	 * @param    List<Double> list                the list
	 * @param    Collection<Double> collection    the collection of values
	 * @return                        the result
	 * @override
	 */
	public List<Double> calculate(List<Double> list, Collection<Double> collection) {
	...
	public List<Double> calculate(List<Double> list,
			Collection<Double> collection, int begin, int length) {
	 ...
	 * @override
	 */
	public List<Double> calculateStrict(List<Double> list, double[] array) {
	 ...
	 * points due to uneven list and array sizes are omitted.
	 * @param    List<Double> list                the list
	 * @param    Collection<Double> collection    the collection
	 * @return                        the result
	 * @override
	 */
	public List<Double> calculateStrict(List<Double> list,
