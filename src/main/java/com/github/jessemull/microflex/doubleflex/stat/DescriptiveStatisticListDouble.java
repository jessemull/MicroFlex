...
/**
 * This class performs statistical operations for double plate stacks, plates, 
 ...
 */
public abstract class DescriptiveStatisticListDouble {
     ...
     */
    public Map<WellDouble, List<Double>> plate(PlateDouble plate) {
        
        Preconditions.checkNotNull(plate, "The plate value cannot be null.");
        
        Map<WellDouble, List<Double>> result = new TreeMap<WellDouble, List<Double>>();
     ...
     * @return                  map of wells and results   
     */
    public Map<WellDouble, List<Double>> plate(PlateDouble plate, int begin, int length) {
     ...
     */
    public List<Double> platesAggregated(PlateDouble plate) {
     ...
     */
    public Map<PlateDouble, List<Double>> platesAggregated(Collection<PlateDouble> collection) {
        
        Preconditions.checkNotNull(collection, "The plate collection cannot be null.");

        Map<PlateDouble, List<Double>> results = new TreeMap<PlateDouble, List<Double>>();
     ...
     */
    public Map<PlateDouble, List<Double>> platesAggregated(PlateDouble[] array) {
    ...
    public List<Double> platesAggregated(
            PlateDouble plate, int begin, int length) {
     ...
     * @return                              map of plates and aggregated results
     */
    public Map<PlateDouble, List<Double>> platesAggregated(
            Collection<PlateDouble> collection, int begin, int length) {
     ...
     */
    public Map<PlateDouble, List<Double>> platesAggregated(
            PlateDouble[] array, int begin, int length) {
     ...
     * @return                    map of wells and results
     */
    public Map<WellDouble, List<Double>> set(WellSetDouble set) {
     ...
     * @return                    map of wells and results
     */
    public Map<WellDouble, List<Double>> set(WellSetDouble set, int begin, int length) {
     ...
     * @return                    the aggregated result
     */
    public List<Double> setsAggregated(WellSetDouble set) {
     ...
     */ 
    public Map<WellSetDouble, List<Double>> setsAggregated(Collection<WellSetDouble> collection) {
        
        Preconditions.checkNotNull(collection, "The well set collection cannot be null.");

        Map<WellSetDouble, List<Double>> results = new TreeMap<WellSetDouble, List<Double>>();
     ...
     * @return                      map of well sets and aggregated results
     */
    public Map<WellSetDouble, List<Double>> setsAggregated(WellSetDouble[] array) {
    ...
    public List<Double> setsAggregated(
            WellSetDouble set, int begin, int length) {
     ...
     * @return                                map of well sets and aggregated results
     */
    public Map<WellSetDouble, List<Double>> setsAggregated(
            Collection<WellSetDouble> collection, int begin, int length) {
     ...
     */
    public Map<WellSetDouble, List<Double>> setsAggregated(
            WellSetDouble[] array, int begin, int length) {
     ...
     * @return                 the result
     */
    public List<Double> well(WellDouble well) {
     ...
     * @return                 the result
     */
    public List<Double> well(WellDouble well, int begin, int length) {
        Preconditions.checkNotNull(well, "The well cannot be null.");
