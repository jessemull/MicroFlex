...
public class WellSetListXMLBigDecimal implements Iterable<WellSetXMLBigDecimal> {
	...
	private List<WellSetXMLBigDecimal> wellsets = new ArrayList<WellSetXMLBigDecimal>();
     ...
     */
    public WellSetListXMLBigDecimal(WellSetBigDecimal single) {
      this.wellsets.add(new WellSetXMLBigDecimal(single));
    }
    ...
    public WellSetListXMLBigDecimal(Collection<WellSetBigDecimal> collection) {
        for(WellSetBigDecimal set : collection) {
            this.wellsets.add(new WellSetXMLBigDecimal(set));
        }
    }
     ...
     * @param    WellSetBigDecimal    the well set object
     */
    public WellSetListXMLBigDecimal(WellSetBigDecimal[] array) {
    ...
    public void setWellsets(List<WellSetXMLBigDecimal> wellsets) {
     ...
     */
    public WellSetXMLBigDecimal get(int index) {
