...
public class ResultListPOJOBigDecimal implements Iterable<ResultPOJOBigDecimal> {
    ...
    private List<ResultPOJOBigDecimal> results = new ArrayList<ResultPOJOBigDecimal>();    // The results in the list
     ...
     */
    public ResultListPOJOBigDecimal(Map<WellBigDecimal, BigDecimal> results) {
        this.results.add(new ResultPOJOBigDecimal(results, "Result"));
    }
     ...
     * @param    Map<WellBigDecimal, BigDecimal>    the input results
     */
    public ResultListPOJOBigDecimal(Map<WellBigDecimal, BigDecimal> results, String label) {
        this.results.add(new ResultPOJOBigDecimal(results, label));
    }
    ...
    public ResultListPOJOBigDecimal(Collection<Map<WellBigDecimal, BigDecimal>> collection) {
        for(Map<WellBigDecimal, BigDecimal> result : collection) {
        	this.results.add(new ResultPOJOBigDecimal(result, "Result"));
        }
    }
     ...
     */
    public ResultListPOJOBigDecimal(Collection<Map<WellBigDecimal, BigDecimal>> collection, List<String> labels) {
    	int index = 0;
        for(Map<WellBigDecimal, BigDecimal> result : collection) {
        	this.results.add(new ResultPOJOBigDecimal(result, labels.get(index++)));
        }
    }
     ...
     */
    public void setResults(List<ResultPOJOBigDecimal> results) {
     ...
     */
    public ResultPOJOBigDecimal get(int index) {
