...
public class StackXMLBigDecimal {
    ...
    private List<PlateXMLBigDecimal> plates = 
    		new ArrayList<PlateXMLBigDecimal>();   // List of plates in the stack
    
    /*------------------------------ Constructors ----------------------------*/
    
    public StackXMLBigDecimal(){}
    
    /**
     * Creates an XML stack from a stack object.
     * @param    StackBigDecimal    the stack object
     */
    public StackXMLBigDecimal(StackBigDecimal stack) {
        ...
        for(PlateBigDecimal plate : stack) {
            plates.add(new PlateXMLBigDecimal(plate));
        }
    }
     ...
     * @return    the stack
     */
    public StackBigDecimal toStackObject() {

    	StackBigDecimal stack = new StackBigDecimal(this.rows, this.columns, this.label);
    	
    	for(PlateXMLBigDecimal plate : plates) {
