 ...
 */
public abstract class DescriptiveStatisticBigDecimal {
     ...
     */
    public Map<WellBigDecimal, BigDecimal> plate(PlateBigDecimal plate) {
     ...
     * @return                      map of wells and results   
     */
    public Map<WellBigDecimal, BigDecimal> plate(PlateBigDecimal plate, int begin, int length) {
     ...
     */
    public BigDecimal platesAggregated(PlateBigDecimal plate) {
     ...
     */
    public Map<PlateBigDecimal, BigDecimal> platesAggregated(Collection<PlateBigDecimal> collection) {
     ...
     */
    public Map<PlateBigDecimal, BigDecimal> platesAggregated(PlateBigDecimal[] array) {
    ...
    public BigDecimal platesAggregated(
            PlateBigDecimal plate, int begin, int length) {
    ...
    public Map<PlateBigDecimal, BigDecimal> platesAggregated(
            Collection<PlateBigDecimal> collection, int begin, int length) {
     ...
     */
    public Map<PlateBigDecimal, BigDecimal> platesAggregated(
            PlateBigDecimal[] array, int begin, int length) {
     ...
     * @return                        map of wells and results
     */
    public Map<WellBigDecimal, BigDecimal> set(WellSetBigDecimal set) {
     ...
     * @return                        map of wells and results
     */
    public Map<WellBigDecimal, BigDecimal> set(WellSetBigDecimal set, int begin, int length) {
     ...
     * @return                        the aggregated result
     */
    public BigDecimal setsAggregated(WellSetBigDecimal set) {
     ...
     */
    public Map<WellSetBigDecimal, BigDecimal> setsAggregated(Collection<WellSetBigDecimal> collection) {
     ...
     * @return                          map of well sets and aggregated results
     */
    public Map<WellSetBigDecimal, BigDecimal> setsAggregated(WellSetBigDecimal[] array) {
    ...
    public BigDecimal setsAggregated(
            WellSetBigDecimal set, int begin, int length) {
    ...
    public Map<WellSetBigDecimal, BigDecimal> setsAggregated(
            Collection<WellSetBigDecimal> collection, int begin, int length) {
     ...
     */
    public Map<WellSetBigDecimal, BigDecimal> setsAggregated(
            WellSetBigDecimal[] array, int begin, int length) {
     ...
     * @return                     the result
     */
    public BigDecimal well(WellBigDecimal well) {
     ...
     * @return                     the result
     */
    public BigDecimal well(WellBigDecimal well, int begin, int length) {
        Preconditions.checkNotNull(well, "The well cannot be null.");
