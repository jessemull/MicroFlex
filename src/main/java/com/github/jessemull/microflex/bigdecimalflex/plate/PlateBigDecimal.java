...
public class PlateBigDecimal implements Iterable<WellBigDecimal>, Comparable<PlateBigDecimal> {            
    ...
    private WellSetBigDecimal data;              // Well data
     ...
     */
    public PlateBigDecimal(int type) {
     ...
     */
    public PlateBigDecimal(int rows, int columns) {
        this.groups = new TreeSet<WellList>();
        this.data = new WellSetBigDecimal();
     ...
     */
    public PlateBigDecimal(int type, String label) {
        this(type);
        this.label = label;
    }
     ...
     * @param    String    plate label
     */
    public PlateBigDecimal(int rows, int columns, String label) {
        this(rows, columns);
        this.label = label;
    }
     ...
     */
    public PlateBigDecimal(int type, WellSetBigDecimal set) {  	
        this(type);
     ...
     * @param    WellSetBigDecimal    plate well sets
     */
    public PlateBigDecimal(int rows, int columns, WellSetBigDecimal set) {
        this(rows, columns);
        ValUtil.validateSet(this.rows, this.columns, set);
        this.addWells(set);
    }
     ...
     * @param    int                  plate type flag
     * @param    String               plate label
     * @param    WellSetBigDecimal    plate well set
     */
    public PlateBigDecimal(int type, String label, WellSetBigDecimal data) {
        this(type, data);
        this.label = label;
    }
     ...
     */
    public PlateBigDecimal(int rows, int columns, String label, WellSetBigDecimal data) {
     ...
     * @param    PlateBigDecimal    plate to clone
     */
    public PlateBigDecimal(PlateBigDecimal plate) {
        ...
        WellSetBigDecimal toAdd = plate.dataSet();
        this.addWells(toAdd);
    ...
    public Set<WellSetBigDecimal> allGroups() {
    	...
    	Set<WellSetBigDecimal> groups = new TreeSet<WellSetBigDecimal>();
    	...
    	for(WellList list : this.groups) {    		
    		...
    		for(WellIndex index : list) {
    			...
    			WellBigDecimal well = this.getWells(new WellBigDecimal(index.row(), index.column()));
    			
    			if(well == null) {
    				well = new WellBigDecimal(index.row(), index.column());
    			}
     ...
     */
    public WellSetBigDecimal getGroups(String label) {
     ...
     * @return               well set containing the group wells
     */
    public WellSetBigDecimal getGroups(WellList list) {
    ...
    public Set<WellSetBigDecimal> getGroups(Collection<WellList> collection) {
    	...
    	Set<WellSetBigDecimal> set = new TreeSet<WellSetBigDecimal>();
    	
    	for(WellList list : collection) {
    		
    		WellSetBigDecimal group = this.getGroups(list);
     ...
     * @return                             wells for each group
     */
    public Set<WellSetBigDecimal> getGroups(WellList[] array) {
     ...
     */
    public Set<WellSetBigDecimal> getGroups(List<String> labels) {
     ...
     * @param    WellBigDecimal    input well
     ...
     * @param    WellBigDecimal well    input   well 
     ...
     * @param     WellBigDecimal    the input well
     ...
     * @param    WellBigDecimal    the first input well
     * @param    WellBigDecimal    the second input well
    ...
    public WellBigDecimal[] toArray() {
        return (WellBigDecimal[]) this.data.toWellArray();
    }
     ...
     */
    public boolean addWells(WellBigDecimal well) {
        
        try {
            
            ValUtil.validateWell(this.rows, this.columns, well);
            
            boolean add = this.data.add(new WellBigDecimal(well.row(), well.column(), well.data()));
     ...
     *                                in the set
     */
    public boolean addWells(WellSetBigDecimal set) {
     ...
     *                               in the array
     */
    public boolean addWells(WellBigDecimal[] array) {
     ...
     */
    public boolean removeWells(WellBigDecimal well) {
     ...
     */
    public boolean removeWells(WellSetBigDecimal set) {
     ...
     * @return                       true on successful removal of all wells
     */
    public boolean removeWells(WellBigDecimal[] wells) {
    ...
    public boolean removeWells(String wellList, String delimiter) {
        ...
        for(String well : split) {
            try {
            	WellBigDecimal toRemove = new WellBigDecimal(well);
    ...
    public boolean removeWells(WellIndex index) {
        ...
        try {
        	...
        	WellBigDecimal toRemove = new WellBigDecimal(index.row(), index.column());
    ...
    public boolean removeWells(WellList list) {
        ...
        for(WellIndex index : list) {
            try {
            	WellBigDecimal well = new WellBigDecimal(index.row(), index.column());
                ValUtil.validateWell(this.rows,  this.columns, well);
                success = this.removeWells(well) ? success : false;
            } catch(Exception e) {
                System.err.println(e.getMessage());
     ...
     * does not exist.
     * @param    WellBigDecimal    the well for replacement
     * @return                     true on successful well replacement
     */
    public boolean replaceWells(WellBigDecimal well) {
     ...
     */
    public boolean replaceWells(WellSetBigDecimal set) {
     ...
     * @return                       true on successful replacement of all wells
     */
    public boolean replaceWells(WellBigDecimal[] array) {
     ...
     */
    public boolean retainWells(WellBigDecimal well) {
     ...
     */
    public boolean retainWells(WellSetBigDecimal set) {
     ...
     * @return                       true on successful retention of all wells
     */
    public boolean retainWells(WellBigDecimal[] array) {
    ...
    public boolean retainWells(String wellList, String delimiter) {
        ...
        for(String well : split) {
            try {
            	WellBigDecimal toRetain = new WellBigDecimal(well);
    ...
    public boolean retainWells(WellIndex index) {
    	return this.retainWells(new WellBigDecimal(index.row(), index.column()));
    }
     ...
     */
    public WellBigDecimal getWells(WellBigDecimal well) {
    	
    	Preconditions.checkNotNull(well, "Well cannot be null.");
    	
    	for(WellBigDecimal result : this.data) {
    ...
    /**
     * Returns the well or null if no such well exists.
     * @param    WellSetBigDecimal    the well
     * @return                        the well set
     */
    public WellSetBigDecimal getWells(WellSetBigDecimal set) {
        ...
        for(WellBigDecimal well : set) {
        	...
        	WellBigDecimal toAdd = this.getWells(new WellBigDecimal(well.row(), well.column()));
    ...
    public WellBigDecimal getWells(String well) {
        ...
        for(WellBigDecimal toReturn : this.data) {
    ...
    public WellBigDecimal getWells(WellIndex index) {
        ...
        for(WellBigDecimal well : this.data) {
    ...
    public WellSetBigDecimal getWells(WellList list) {
        ...
        for(WellIndex index : list) {
        	...
        	WellBigDecimal well = this.getWells(index);
    ...
    public boolean contains(String wellList, String delimiter) {
        ...
        for(String well : split) {
            ...
            if(!this.contains(new WellBigDecimal(well))) {
                return false;
            }
        }
    ...
    public boolean contains(String well) {
        return this.data.contains(new WellBigDecimal(well));
    }
    ...
    public boolean contains(WellIndex index) {
    	...
    	return this.data.contains(new WellBigDecimal(index.row(), index.column()));
    }
     ...
     */
    public <T extends Number> String printData(WellBigDecimal well) {
    ...
    public boolean equals(Object object) {
        ...
        if (object instanceof PlateBigDecimal == false) {
            return false;
        }
        ...
        PlateBigDecimal plate = (PlateBigDecimal) object;
     ...
     * @param    PlateBigDecimal plate the plate for comparison
     * @return       this == plate --> 0
     *               this > plate --> 1
     *               this < plate --> -1
     */
    public int compareTo(PlateBigDecimal plate) {
    	return this.compare(this, plate);
    }
    
    /**
     * Plates are ordered using the size, data type, label and number of sets.  
     * @param    PlateBigDecimal    the plate for comparison
     * @return                      plate1 == plate2 --> 0
     *                              plate1 > plate2 --> 1
     *                              plate1 < plate2 --> -1
     */
    public int compare(PlateBigDecimal plate1, PlateBigDecimal plate2) throws ClassCastException {
