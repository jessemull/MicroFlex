...
public class WellListXMLBigDecimal implements Iterable<WellXMLBigDecimal> {
    ...
    List<WellXMLBigDecimal> wells = new ArrayList<WellXMLBigDecimal>();    // The wells in the list
     ...
     */
    public WellListXMLBigDecimal(WellBigDecimal well) {
        this.wells.add(new WellXMLBigDecimal(well));
    }
     ...
     */
    public WellListXMLBigDecimal(WellBigDecimal[] array) {
    ...
    public void setWells(List<WellXMLBigDecimal> wells) {
        this.wells = wells;
    }
     ...
     * @return          the XML well
     */
    public WellXMLBigDecimal get(int index) {
