 ...
 */
public abstract class DescriptiveStatisticBigDecimalWeightsContext extends DescriptiveStatisticBigDecimalContext {
     ...
     */
    public Map<WellBigDecimal, BigDecimal> plate(PlateBigDecimal plate, double[] weights, MathContext mc) {
     ...
     * @return                      map of wells and results
     */
    public Map<WellBigDecimal, BigDecimal> plate(PlateBigDecimal plate, double[] weights, int begin, int length, MathContext mc) {
     ...
     */
    public BigDecimal platesAggregated(PlateBigDecimal plate, double[] weights, MathContext mc) {
     ...
     * @return                      the aggregated result
     */
    public BigDecimal platesAggregated(PlateBigDecimal plate, double[] weights, int begin, int length, MathContext mc) {
     ...
     * @return                        map of wells and results
     */
    public Map<WellBigDecimal, BigDecimal> set(WellSetBigDecimal set, double[] weights, MathContext mc) {
     ...
     * @return                        map of wells and results
     */
    public Map<WellBigDecimal, BigDecimal> set(WellSetBigDecimal set, double[] weights, int begin, int length, MathContext mc) {
     ...
     */
    public BigDecimal setsAggregated(WellSetBigDecimal set, double[] weights, MathContext mc) {
     ...
     * @return                        the aggregated result
     */
    public BigDecimal setsAggregated(WellSetBigDecimal set, double[] weights, int begin, int length, MathContext mc) {
     ...
     * @return                     the result
     */
    public BigDecimal well(WellBigDecimal well, double[] weights, MathContext mc) {
     ...
     * @return                     the result
     */
    public BigDecimal well(WellBigDecimal well, double[] weights, int begin, int length, MathContext mc) {
