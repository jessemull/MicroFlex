...
public abstract class MathOperationBigDecimalBinaryContext {
	 ...
	 */
	public MathOperationBigDecimalBinaryContext() {}
     ...
     */
    public List<BigDecimal> wells(WellBigDecimal well1, WellBigDecimal well2, MathContext mc) {
     ...
     * @return                     result of the operation
     */
    public List<BigDecimal> wells(WellBigDecimal well1, WellBigDecimal well2, int begin, int length, MathContext mc) {
     ...
     * @return                     result of the operation
     */
    public List<BigDecimal> wellsStrict(WellBigDecimal well1, WellBigDecimal well2, MathContext mc) {
    	this.validateArgs(well1, well2);
     ...
     * @return                     result of the operation
     */
    public List<BigDecimal> wellsStrict(WellBigDecimal well1, WellBigDecimal well2, int begin, int length, MathContext mc) {
    	this.validateArgs(well1, well2, begin, length);
     ...
     * @return                     result of the operation
     */
    public List<BigDecimal> wells(WellBigDecimal well, BigDecimal constant, MathContext mc) {
     ...
     * @return                     result of the operation
     */
    public List<BigDecimal> wells(WellBigDecimal well, BigDecimal[] array, MathContext mc) {
     ...
     * @return                     result of the operation
     */
    public List<BigDecimal> wells(WellBigDecimal well, BigDecimal[] array, int begin, int length, MathContext mc) {
     ...
     * @return                             result of the operation
     */
    public List<BigDecimal> wells(WellBigDecimal well, Collection<BigDecimal> collection, MathContext mc) {
     ...
     * @return                             result of the operation
     */
    public List<BigDecimal> wells(WellBigDecimal well, Collection<BigDecimal> collection, int begin, int length, MathContext mc) {
     ...
     * @return                     result of the operation
     */
    public List<BigDecimal> wellsStrict(WellBigDecimal well, BigDecimal[] array, MathContext mc) {
    	this.validateArgs(well, array);
     ...
     * @return                     result of the operation
     */
    public List<BigDecimal> wellsStrict(WellBigDecimal well, BigDecimal[] array, int begin, int length, MathContext mc) {
    	this.validateArgs(well, array, begin, length);
     ...
     * @return                             result of the operation
     */
    public List<BigDecimal> wellsStrict(WellBigDecimal well, Collection<BigDecimal> collection, MathContext mc) {
    	this.validateArgs(well, collection);
     ...
     * @return                             result of the operation
     */
    public List<BigDecimal> wellsStrict(WellBigDecimal well, Collection<BigDecimal> collection, int begin, int length, MathContext mc) {
    	this.validateArgs(well, collection, begin, length);
     ...
     * @return                      result of the operation
     */
    public PlateBigDecimal plates(PlateBigDecimal plate1, PlateBigDecimal plate2, MathContext mc) {
    	...
    	WellSetBigDecimal resultSet = this.sets(plate1.dataSet(), plate2.dataSet(), mc);
     ...
     * @return                      result of the operation
     */
    public PlateBigDecimal plates(PlateBigDecimal plate1, PlateBigDecimal plate2, int begin, int length, MathContext mc) {
    	...
    	WellSetBigDecimal resultSet = this.sets(plate1.dataSet(), plate2.dataSet(), begin, length, mc);
     ...
     * @return                      result of the operation
     */
    public PlateBigDecimal platesStrict(PlateBigDecimal plate1, PlateBigDecimal plate2, MathContext mc) {
    	...
    	WellSetBigDecimal resultSet = this.setsStrict(plate1.dataSet(), plate2.dataSet(), mc);
     ...
     * @return                      result of the operation
     */
    public PlateBigDecimal platesStrict(PlateBigDecimal plate1, PlateBigDecimal plate2, int begin, int length, MathContext mc) {
    	...
    	WellSetBigDecimal resultSet = this.setsStrict(plate1.dataSet(), plate2.dataSet(), begin, length, mc);
     ...
     * @return                      result of the operation
     */
    public PlateBigDecimal plates(PlateBigDecimal plate, BigDecimal constant, MathContext mc) {
    	...
    	WellSetBigDecimal resultSet = this.sets(plate.dataSet(), constant, mc);
     ...
     * @return                      result of the operation
     */
    public PlateBigDecimal plates(PlateBigDecimal plate, BigDecimal[] array, MathContext mc) {
    	...
    	WellSetBigDecimal resultSet = this.sets(plate.dataSet(), array, mc);
     ...
     * @return                      result of the operation
     */
    public PlateBigDecimal plates(PlateBigDecimal plate, BigDecimal[] array, int begin, int length, MathContext mc) {
    	...
    	WellSetBigDecimal resultSet = this.sets(plate.dataSet(), array, begin, length, mc);
     ...
     * @return                             result of the operation
     */
    public PlateBigDecimal plates(PlateBigDecimal plate, Collection<BigDecimal> collection, MathContext mc) {
    	...
    	WellSetBigDecimal resultSet = this.sets(plate.dataSet(), collection, mc);
     ...
     * @return                             result of the operation
     */
    public PlateBigDecimal plates(PlateBigDecimal plate, Collection<BigDecimal> collection, int begin, int length, MathContext mc) {
    	...
    	WellSetBigDecimal resultSet = this.sets(plate.dataSet(), collection, begin, length, mc);
     ...
     * @return                      result of the operation
     */
    public PlateBigDecimal platesStrict(PlateBigDecimal plate, BigDecimal[] array, MathContext mc) {
    	...
    	WellSetBigDecimal resultSet = this.setsStrict(plate.dataSet(), array, mc);
     ...
     * @return                      result of the operation
     */
    public PlateBigDecimal platesStrict(PlateBigDecimal plate, BigDecimal[] array, int begin, int length, MathContext mc) {
    	...
    	WellSetBigDecimal resultSet = this.setsStrict(plate.dataSet(), array, begin, length, mc);
     ...
     * @return                             result of the operation
     */
    public PlateBigDecimal platesStrict(PlateBigDecimal plate, Collection<BigDecimal> collection, MathContext mc) {
    	...
    	WellSetBigDecimal resultSet = this.setsStrict(plate.dataSet(), collection, mc);
     ...
     * @return                             result of the operation
     */
    public PlateBigDecimal platesStrict(PlateBigDecimal plate, Collection<BigDecimal> collection, int begin, int length, MathContext mc) {
    	...
    	this.validateArgs(plate, collection);
     	...
     	WellSetBigDecimal resultSet = this.setsStrict(plate.dataSet(), collection, begin, length, mc);
     ...
     * @return                        result of the operation
     */
    public WellSetBigDecimal sets(WellSetBigDecimal set1, WellSetBigDecimal set2, MathContext mc) {
     ...
     * @return                        result of the operation
     */
    public WellSetBigDecimal sets(WellSetBigDecimal set1, WellSetBigDecimal set2, int begin, int length, MathContext mc) {
     ...
     * @return                        result of the operation
     */
    public WellSetBigDecimal setsStrict(WellSetBigDecimal set1, WellSetBigDecimal set2, MathContext mc) {
     ...
     * @return                        result of the operation
     */
    public WellSetBigDecimal setsStrict(WellSetBigDecimal set1, WellSetBigDecimal set2, int begin, int length, MathContext mc) {
     ...
     * @return                        result of the operation
     */
    public WellSetBigDecimal sets(WellSetBigDecimal set, BigDecimal constant, MathContext mc) {
     ...
     * @return                        result of the operation
     */
    public WellSetBigDecimal sets(WellSetBigDecimal set, BigDecimal[] array, MathContext mc) {
     ...
     * @return                        result of the operation
     */
    public WellSetBigDecimal sets(WellSetBigDecimal set, BigDecimal[] array, int begin, int length, MathContext mc) {
     ...
     * @return                             result of the operation
     */
    public WellSetBigDecimal sets(WellSetBigDecimal set, Collection<BigDecimal> collection, MathContext mc) {
    	...
    	for(WellBigDecimal well : set) {
    		result.add(new WellBigDecimal(well.row(), well.column(), this.calculate(well.data(), collection, mc)));
         } 
     ...
     * @return                             result of the operation
     */
    public WellSetBigDecimal sets(WellSetBigDecimal set, Collection<BigDecimal> collection, int begin, int length, MathContext mc) {
     ...
     * @return                        result of the operation
     */
    public WellSetBigDecimal setsStrict(WellSetBigDecimal set, BigDecimal[] array, MathContext mc) {
        ...
        for(WellBigDecimal well : set) {
        	result.add(new WellBigDecimal(well.row(), well.column(), this.calculateStrict(well.data(), array, mc)));
        }
     ...
     * @return                        result of the operation
     */
    public WellSetBigDecimal setsStrict(WellSetBigDecimal set, BigDecimal[] array, int begin, int length, MathContext mc) {
        ...
        for(WellBigDecimal well : set) {
        	this.validateArgs(well, begin, length);
        	result.add(new WellBigDecimal(well.row(), well.column(), this.calculateStrict(well.data(), array, begin, length, mc)));
        }
     ...
     * @return                             result of the operation
     */
    public WellSetBigDecimal setsStrict(WellSetBigDecimal set, Collection<BigDecimal> collection, MathContext mc) {
        ...
        for(WellBigDecimal well : set) {
        	result.add(new WellBigDecimal(well.row(), well.column(), this.calculateStrict(well.data(), collection, mc)));
        }
     ...
     * @return                             result of the operation
     */
    public WellSetBigDecimal setsStrict(WellSetBigDecimal set, Collection<BigDecimal> collection, int begin, int length, MathContext mc) {
        ...
        for(WellBigDecimal well : set) {
        	this.validateArgs(well, begin, length);
        	result.add(new WellBigDecimal(well.row(), well.column(), this.calculateStrict(well.data(), collection, begin, length, mc)));
        }
     ...
     */
    public StackBigDecimal stacks(StackBigDecimal stack1, StackBigDecimal stack2, MathContext mc) {
    	...
    	while(iter1.hasNext() && iter2.hasNext()) {
    	    PlateBigDecimal resultPlate = this.plates(iter1.next(), iter2.next(), mc);
     ...
     */
    public StackBigDecimal stacks(StackBigDecimal stack1, StackBigDecimal stack2, int begin, int length, MathContext mc) {
    	...
    	while(iter1.hasNext() && iter2.hasNext()) {
    	    PlateBigDecimal resultPlate = this.plates(iter1.next(), iter2.next(), begin, length, mc);
    	    result.add(resultPlate);
    	}
     ...
     * @return                      the result of the operation
     */
    public StackBigDecimal stacksStrict(StackBigDecimal stack1, StackBigDecimal stack2, MathContext mc) {
    	...
    	while(iter1.hasNext() && iter2.hasNext()) {
    	    PlateBigDecimal resultPlate = this.platesStrict(iter1.next(), iter2.next(), mc);
    	    result.add(resultPlate);
    	}
     ...
     * @return                      the result of the addition
     */
    public StackBigDecimal stacksStrict(StackBigDecimal stack1, StackBigDecimal stack2, int begin, int length, MathContext mc) {
    	...
    	while(iter1.hasNext() && iter2.hasNext()) {
    	    PlateBigDecimal resultPlate = this.platesStrict(iter1.next(), iter2.next(), begin, length, mc);
    	    result.add(resultPlate);
    	}
     ...
     * @return                      result of the operation
     */
    public StackBigDecimal stacks(StackBigDecimal stack, BigDecimal constant, MathContext mc) {
    	...
    	while(iter1.hasNext()) {
    	    PlateBigDecimal resultPlate = this.plates(iter1.next(), constant, mc);
    	    result.add(resultPlate);
    	}
     ...
     * @return                      result of the operation
     */
    public StackBigDecimal stacks(StackBigDecimal stack, BigDecimal[] array, MathContext mc) {
    	...
    	while(iter1.hasNext()) {
    	    PlateBigDecimal resultPlate = this.plates(iter1.next(), array, mc);
    	    result.add(resultPlate);
    	}
     ...
     * @return                      result of the operation
     */
    public StackBigDecimal stacks(StackBigDecimal stack, BigDecimal[] array, int begin, int length, MathContext mc) {
    	...
    	while(iter1.hasNext()) {
    	    PlateBigDecimal resultPlate = this.plates(iter1.next(), array, begin, length, mc);
    	    result.add(resultPlate);
    	}
     ...
     * @return                             result of the operation
     */
    public StackBigDecimal stacks(StackBigDecimal stack, Collection<BigDecimal> collection, MathContext mc) {
    	...
    	while(iter1.hasNext()) {
    	    PlateBigDecimal resultPlate = this.plates(iter1.next(), collection, mc);
    	    result.add(resultPlate);
    	}
     ...
     * @return                             result of the operation
     */
    public StackBigDecimal stacks(StackBigDecimal stack, Collection<BigDecimal> collection, int begin, int length, MathContext mc) {
    	...
    	while(iter1.hasNext()) {
    	    PlateBigDecimal resultPlate = this.plates(iter1.next(), collection, begin, length, mc);
    	    result.add(resultPlate);
    	}
     ...
     * @return                      result of the operation
     */
    public StackBigDecimal stacksStrict(StackBigDecimal stack, BigDecimal[] array, MathContext mc) {
    	...
    	while(iter1.hasNext()) {
    	    PlateBigDecimal resultPlate = this.platesStrict(iter1.next(), array, mc);
    	    result.add(resultPlate);
    	}
     ...
     * @return                      result of the operation
     */
    public StackBigDecimal stacksStrict(StackBigDecimal stack, BigDecimal[] array, int begin, int length, MathContext mc) {
    	...
    	while(iter1.hasNext()) {
    	    PlateBigDecimal resultPlate = this.platesStrict(iter1.next(), array, begin, length, mc);
    	    result.add(resultPlate);
    	}
     ...
     * @return                             result of the operation
     */
    public StackBigDecimal stacksStrict(StackBigDecimal stack, Collection<BigDecimal> collection, MathContext mc) {
    	...
    	while(iter1.hasNext()) {
    	    PlateBigDecimal resultPlate = this.platesStrict(iter1.next(), collection, mc);
    	    result.add(resultPlate);
    	}
     ...
     * @return                             result of the operation
     */
    public StackBigDecimal stacksStrict(StackBigDecimal stack, Collection<BigDecimal> collection, int begin, int length, MathContext mc) {
    	...
    	while(iter1.hasNext()) {
    	    PlateBigDecimal resultPlate = this.platesStrict(iter1.next(), collection, begin, length, mc);
    	    result.add(resultPlate);
    	}
