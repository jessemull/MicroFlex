 ...
 */
public class StackPOJOBigDecimal {
    ...
    List<PlatePOJOBigDecimal> plates = 
    		new ArrayList<PlatePOJOBigDecimal>();    // List of plates in the stack
    
    /*------------------------------ Constructors ----------------------------*/
    
    public StackPOJOBigDecimal(){}
    
    /**
     * Creates a stack POJO from a stack object.
     * @param    StackBigDecimal    the stack object
     */
    public StackPOJOBigDecimal(StackBigDecimal stack) {
        ...
        for(PlateBigDecimal plate : stack) {
            plates.add(new PlatePOJOBigDecimal(plate));
        }
    }
    ...
    public StackBigDecimal toStackObject() {
    	...
    	for(PlatePOJOBigDecimal plate : plates) {
