...
public abstract class DescriptiveStatisticBigInteger {
     ...
     */
    public Map<WellBigInteger, BigDecimal> plate(PlateBigInteger plate) {
     ...
     * @return                      map of wells and results   
     */
    public Map<WellBigInteger, BigDecimal> plate(PlateBigInteger plate, int begin, int length) {
     ...
     */
    public BigDecimal platesAggregated(PlateBigInteger plate) {
     ...
     */
    public Map<PlateBigInteger, BigDecimal> platesAggregated(PlateBigInteger[] array) {
    ...
    public BigDecimal platesAggregated(
            PlateBigInteger plate, int begin, int length) {
    ...
    public Map<PlateBigInteger, BigDecimal> platesAggregated(
            Collection<PlateBigInteger> collection, int begin, int length) {
     ...
     */
    public Map<PlateBigInteger, BigDecimal> platesAggregated(
            PlateBigInteger[] array, int begin, int length) {
     ...
     * @return                        map of wells and results
     */
    public Map<WellBigInteger, BigDecimal> set(WellSetBigInteger set) {
     ...
     * @return                        map of wells and results
     */
    public Map<WellBigInteger, BigDecimal> set(WellSetBigInteger set, int begin, int length) {
     ...
     * @return                        the aggregated result
     */
    public BigDecimal setsAggregated(WellSetBigInteger set) {
     ...
     * @return                          map of well sets and aggregated results
     */
    public Map<WellSetBigInteger, BigDecimal> setsAggregated(WellSetBigInteger[] array) {
    ...
    public BigDecimal setsAggregated(
            WellSetBigInteger set, int begin, int length) {
    ...
    public Map<WellSetBigInteger, BigDecimal> setsAggregated(
            Collection<WellSetBigInteger> collection, int begin, int length) {
     ...
     */
    public Map<WellSetBigInteger, BigDecimal> setsAggregated(
            WellSetBigInteger[] array, int begin, int length) {
     ...
     * @return                     the result
     */
    public BigDecimal well(WellBigInteger well) {
     ...
     * @return                     the result
     */
    public BigDecimal well(WellBigInteger well, int begin, int length) {
        Preconditions.checkNotNull(well, "The well cannot be null.");
