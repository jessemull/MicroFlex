...
public abstract class DescriptiveStatisticBigIntegerWeightsContext extends DescriptiveStatisticBigIntegerContext {
     ...
     */
    public Map<WellBigInteger, BigDecimal> plate(PlateBigInteger plate, double[] weights, MathContext mc) {
     ...
     * @return                      map of wells and results
     */
    public Map<WellBigInteger, BigDecimal> plate(PlateBigInteger plate, double[] weights, int begin, int length, MathContext mc) {
     ...
     */
    public BigDecimal platesAggregated(PlateBigInteger plate, double[] weights, MathContext mc) {
     ...
     * @return                      the aggregated result
     */
    public BigDecimal platesAggregated(PlateBigInteger plate, double[] weights, int begin, int length, MathContext mc) {
     ...
     * @return                        map of wells and results
     */
    public Map<WellBigInteger, BigDecimal> set(WellSetBigInteger set, double[] weights, MathContext mc) {
     ...
     * @return                        map of wells and results
     */
    public Map<WellBigInteger, BigDecimal> set(WellSetBigInteger set, double[] weights, int begin, int length, MathContext mc) {
     ...
     */
    public BigDecimal setsAggregated(WellSetBigInteger set, double[] weights, MathContext mc) {
     ...
     * @return                        the aggregated result
     */
    public BigDecimal setsAggregated(WellSetBigInteger set, double[] weights, int begin, int length, MathContext mc) {
     ...
     * @return                     the result
     */
    public BigDecimal well(WellBigInteger well, double[] weights, MathContext mc) {
     ...
     * @return                     the result
     */
    public BigDecimal well(WellBigInteger well, double[] weights, int begin, int length, MathContext mc) {
