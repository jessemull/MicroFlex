...
public class WellSetPOJOBigInteger {
    ...
    private List<SimpleWellPOJOBigInteger> wells = 
    		new ArrayList<SimpleWellPOJOBigInteger>();    // List of set wells
     ...
     */
    public WellSetPOJOBigInteger(WellSetBigInteger set) {
     ...
     * @param    List<SimpleWellPOJOBigInteger>    the list of set wells
     */
