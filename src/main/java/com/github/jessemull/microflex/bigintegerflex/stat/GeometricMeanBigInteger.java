...
/**
 * This class calculates the geometric mean of BigInteger plate stacks, plates, 
 ...
 */
public class GeometricMeanBigInteger extends DescriptiveStatisticBigIntegerWeightsContext{
	...
	public BigDecimal calculate(List<BigDecimal> list, MathContext mc) {
	    ...
	    BigDecimal result = new BigDecimal(resultString, mc);
